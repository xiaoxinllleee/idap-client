...
export default {
  install(Vue)  {
    ...
    Vue.prototype.checkProvince = function(card,vcity){
    ...
    Vue.prototype.checkBirthday = function(card){
      var len = card.length;
    ...
    Vue.prototype.verifyBirthday = function(year,month,day,birthday){
      var now = new Date();
    ...
    Vue.prototype.checkParity = function(card){
      //15位转18位
    ...
    Vue.prototype.changeFivteenToEighteen = function(card){
      if(card.length == '15')
      {
        var arrInt = new Array(7, 9, 10, 5, 8, 4, 2, 1, 6, 3, 7, 9, 10, 5, 8, 4, 2);
        var arrCh = new Array('1', '0', 'X', '9', '8', '7', '6', '5', '4', '3', '2');
