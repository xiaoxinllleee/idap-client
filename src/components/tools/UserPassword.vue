    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="新密码">
          <a-input-password type="password" placeholder="请输入新密码" v-decorator="[ 'password', validatorRules.password]" />
        </a-form-item>
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="确认新密码">
          <a-input-password type="password" @blur="handleConfirmBlur" placeholder="请确认新密码" v-decorator="[ 'confirmpassword', validatorRules.confirmpassword]"/>
        </a-form-item>
...
<script>
  ...
  export default {
    name: "UserPassword",
    props:["validatePassWordValue","validatePasswordMessage"],
    data () {
      return {
        title:"修改密码",
        modalWidth:800,
