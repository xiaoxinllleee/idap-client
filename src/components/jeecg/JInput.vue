...
<script>
  const JINPUT_QUERY_LIKE = 'like';//右模糊
  const JINPUT_QUERY_LIKE_MORE = 'likemore';//全模糊
  const JINPUT_QUERY_NE = 'ne';//不等于
  ...
  export default {
    ...
    props:{
      ...
      type:{
        type:String,
        required:false,
        default:JINPUT_QUERY_LIKE_MORE
      },
      placeholder:{
        type:String,
        required:false,
