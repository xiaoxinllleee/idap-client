    ...
    methods:{
      initFileList(fileList){
        ...
        fileList.forEach(item =>{
          console.log("==========================")
          console.log(item)
          if (item.fwlj == undefined){
            item.fwlj = this.bizPath+item.name
          }
          let url = getFileAccessHttpUrl(item.fwlj,this.urlView,"http");
          previewFileList.push({
            uid: uidGenerator(),
            zlbh: item.zlbh,
            name: getFileName(item.fwlj),
            status: 'done',
            url: url,
            response:{
              status:"history",
          ...
          if(info.file.response.success){
            ...
            fileList = fileList.map((file) => {
              if (file.response) {
                ...
                file.fwlj = file.response.message;
                file['zllx'] = this.imageType;
              }
              return file;
            });
          }
