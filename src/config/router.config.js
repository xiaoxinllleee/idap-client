...
export const constantRouterMap = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'bigc',
        name: 'bigc',
        component: () => import(/* webpackChunkName: "user" */ '@/views/bigscreen/BigScreen095')
      },
      {
        path: 'dkywxx',
        name: 'dkywxx',
        component: () => import(/* webpackChunkName: "user" */ '@/views/bigscreen/modules/Dkywxx')
      },
      {
        path: 'wgxx',
        name: 'wgxx',
        component: () => import(/* webpackChunkName: "user" */ '@/views/bigscreen/modules/wgxx')
      },
      {
        path: 'wgxz',
        name: 'wgxz',
        component: () => import(/* webpackChunkName: "user" */ '@/views/bigscreen/modules/wgxz')
      },
      {
        path: 'gzjd',
        name: 'gzjd',
        component: () => import(/* webpackChunkName: "user" */ '@/views/bigscreen/modules/gzjd')
      }
    ]
  },
