...
<script>
  import EjyxdyglModal from './EjyxdyglModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/api/yxdygl/ejyxdygl/list",
          delete: "/ejyxdygl/ejyxdygl/delete",
          deleteBatch: "/ejyxdygl/ejyxdygl/deleteBatch",
          exportXlsUrl: "ejyxdygl/ejyxdygl/exportXls",
          importExcelUrl: "ejyxdygl/ejyxdygl/importExcel",
       },
    }
  },
  computed: {
