      ...
      <a-form :form="form">
        ...
        <a-form-item
          ...
          <a-select placeholder="请选择单元性质" style="width: 360px" @change="handleChange"  v-decorator="['dyxz', {}]">
            <a-select-option value="xzc">行政村</a-select-option>
            <a-select-option value="sq">社区</a-select-option>
            <a-select-option value="jd">街道</a-select-option>
            <a-select-option value="sq">商圈</a-select-option>
            <a-select-option value="yq">园区</a-select-option>
          </a-select>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/ejyxdygl/ejyxdygl/add",
          edit: "/ejyxdygl/ejyxdygl/edit",
        },
      }
    },
    created () {
