    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="入岗日期">
          <a-date-picker v-decorator="[ 'rgrq', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="离岗日期">
          <a-date-picker v-decorator="[ 'lgrq', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="是否参与考核（1：是 2：否）">
          <a-input placeholder="请输入是否参与考核（1：是 2：否）" v-decorator="['sfcykh', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="是否临退休（1：是 2：否）">
          <a-input placeholder="请输入是否临退休（1：是 2：否）" v-decorator="['sfltx', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/yggwxxytj/hrBasStaffpostM/add",
          edit: "/yggwxxytj/hrBasStaffpostM/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'zzbz','gwbz','yggh','rglx','khjlbz','gyh','sfcykh','sfltx','lrbz','lrr'))
		  //时间格式化
