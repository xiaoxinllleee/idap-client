<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        ...
        <template v-if="toggleSearchStatus">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="考核ID">
              <a-input placeholder="请输入考核ID" v-model="queryParam.zbid"></a-input>
            </a-form-item>
          </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('客户经理等级评定明细')" v-has="'KhjldjpdMx:exp'">导出</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'KhjldjpdMx:edit'">编辑</a>
    ...
    <!-- 表单区域 -->
    <khjldjpdMx-modal ref="modalForm" @ok="modalFormOk"></khjldjpdMx-modal>
  </a-card>
</template>

<script>
  import KhjldjpdMxModal from './KhjldjpdMxModal'
  ...
  export default {
    ...
    components: {
      KhjldjpdMxModal,JTreeSelect
    },
    data () {
      return {
        description: '客户经理等级评定明细管理页面',
        dateValue: '',
        pdzqD: null,
        pdzqM: null,
        pdzqQ: null,
		...
		url: {
          list: "/khjldjpdMx/khjldjpdMx/list",
          delete: "/khjldjpdMx/khjldjpdMx/delete",
          deleteBatch: "/khjldjpdMx/khjldjpdMx/deleteBatch",
          exportXlsUrl: "khjldjpdMx/khjldjpdMx/exportXls",
          importExcelUrl: "khjldjpdMx/khjldjpdMx/importExcel",
       },
    }
  },
  computed: {
