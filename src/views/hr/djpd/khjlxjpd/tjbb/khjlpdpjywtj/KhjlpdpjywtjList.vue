<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('客户经理评定平均业务统计')" v-has="'Khjlpdpjywtj:exp'">导出</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'Khjlpdpjywtj:edit'">编辑</a>
    ...
    <!-- 表单区域 -->
    <khjlpdpjywtj-modal ref="modalForm" @ok="modalFormOk"></khjlpdpjywtj-modal>
  </a-card>
</template>

<script>
  import KhjlpdpjywtjModal from './modules/KhjlpdpjywtjModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import {filterObj} from "@/utils/util";
  import JTreeSelect from '@comp/jeecg/JTreeSelect'

  export default {
    name: "KhjlpdpjywtjList",
    mixins:[JeecgListMixin],
    components: {
      KhjlpdpjywtjModal,JTreeSelect
    },
    data () {
      return {
        description: '客户经理评定平均业务统计管理页面',
        dateValue: '',
        pdzqD: null,
        pdzqM: null,
        pdzqQ: null,
		...
		url: {
          list: "/khjlpdpjywtj/khjlpdpjywtj/list",
          delete: "/khjlpdpjywtj/khjlpdpjywtj/delete",
          deleteBatch: "/khjlpdpjywtj/khjlpdpjywtj/deleteBatch",
          exportXlsUrl: "khjlpdpjywtj/khjlpdpjywtj/exportXls",
          importExcelUrl: "khjlpdpjywtj/khjlpdpjywtj/importExcel",
       },
    }
  },
  computed: {
    ...
    methods: {
      ...
      // 下拉选择Func
      selectValue(value){
        console.log('KhjlpdpjywtjList => selectValue(value)')
      ...
      // 查询条件[pdrq]格式化Func
      getQueryParams() {
        console.log('KhjlpdpjywtjList => getQueryParams()')
