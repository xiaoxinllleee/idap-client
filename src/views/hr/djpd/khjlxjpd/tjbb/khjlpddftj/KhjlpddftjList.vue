<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('客户经理评定得分统计')" v-has="'Khjlpddftj:exp'">导出</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'Khjlpddftj:edit'">编辑</a>
    ...
    <!-- 表单区域 -->
    <khjlpddftj-modal ref="modalForm" @ok="modalFormOk"></khjlpddftj-modal>
  </a-card>
</template>

<script>
  import KhjlpddftjModal from './modules/KhjlpddftjModal'
  ...
  export default {
    ...
    components: {
      KhjlpddftjModal,JTreeSelect
    },
    data () {
      return {
        description: '客户经理评定得分统计管理页面',
        dateValue: '',
        pdzqD: null,
        pdzqM: null,
        pdzqQ: null,
		...
		url: {
          list: "/khjlpddftj/khjlpddftj/list",
          delete: "/khjlpddftj/khjlpddftj/delete",
          deleteBatch: "/khjlpddftj/khjlpddftj/deleteBatch",
          exportXlsUrl: "khjlpddftj/khjlpddftj/exportXls",
          importExcelUrl: "khjlpddftj/khjlpddftj/importExcel",
       },
    }
  },
  computed: {
