<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('客户经理评定星级统计')" v-has="'Khjlpdxjtj:exp'">导出</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'Khjlpdxjtj:edit'">编辑</a>
    ...
    <!-- 表单区域 -->
    <khjlpdxjtj-modal ref="modalForm" @ok="modalFormOk"></khjlpdxjtj-modal>
  </a-card>
</template>

<script>
  import KhjlpdxjtjModal from './modules/KhjlpdxjtjModal'
  ...
  export default {
    ...
    components: {
      KhjlpdxjtjModal,JTreeSelect
    },
    data () {
      return {
        description: '客户经理评定星级统计管理页面',
        dateValue: '',
        pdzqD: null,
        pdzqM: null,
        pdzqQ: null,
		...
		url: {
          list: "/khjlpdxjtj/khjlpdxjtj/list",
          delete: "/khjlpdxjtj/khjlpdxjtj/delete",
          deleteBatch: "/khjlpdxjtj/khjlpdxjtj/deleteBatch",
          exportXlsUrl: "khjlpdxjtj/khjlpdxjtj/exportXls",
          importExcelUrl: "khjlpdxjtj/khjlpdxjtj/importExcel",
       },
    }
  },
  computed: {
    ...
    methods: {
      ...
      // 下拉选择Func
      selectValue(value){
        console.log('KhjlpdxjtjList => selectValue(value)')
      ...
      // 查询条件[pdrq]格式化Func
      getQueryParams() {
        console.log('KhjlpdxjtjList => getQueryParams()')
