<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="指标标识">
              <a-input placeholder="请输入指标标识" v-model="queryParam.sjxid"></a-input>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="指标名称">
              <a-input placeholder="请输入指标名称" v-model="queryParam.sjxmc"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="调整类型">
              <a-select placeholder="全部" v-model="queryParam.tzlx">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" type="primary" icon="plus" v-has="'Zbsjtz:add'">新增</a-button>
      <a-button icon="download" @click="handleExportXls('指标数据调整')" v-has="'Zbsjtz:exp'">导出</a-button>
      <a-button icon="import" @click="excelImport" v-has="'Zbsjtz:imp'">导入</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'Zbsjtz:edit'">编辑</a>
    ...
    <!-- 表单区域 -->
    <zbsjtz-modal ref="modalForm" @ok="modalFormOk"></zbsjtz-modal>
  </a-card>
</template>

<script>
  import ZbsjtzModal from './modules/ZbsjtzModal'
  ...
  export default {
    ...
    components: {
      ZbsjtzModal,JTreeSelect,ExcelImport
    },
    data () {
      return {
        description: '指标数据调整管理页面',
        dateValue: '',
        pdzqD: null,
        pdzqM: null,
        pdzqQ: null,
		...
		url: {
          list: "/zbsjtz/zbsjtz/list",
          delete: "/zbsjtz/zbsjtz/delete",
          deleteBatch: "/zbsjtz/zbsjtz/deleteBatch",
          exportXlsUrl: "zbsjtz/zbsjtz/exportXls",
          importExcelUrl: "zbsjtz/zbsjtz/importExcel",
          exportTemplateUrl: "/zbsjtz/zbsjtz/exportTemplateXls",
       },
        exportTemplateName:'指标数据调整管理导入模板'
    }
  },
  computed: {
    ...
    methods: {
      handleDelete: function (record) {
        ...
        var that = this;
        deleteAction(that.url.delete, {pdzq: record.pdzq,pdrq: record.pdrq,zzbz: record.zzbz,yggh: record.yggh,gwbz: record.gwbz,sjxid: record.sjxid}).then((res) => {
          if (res.success) {
