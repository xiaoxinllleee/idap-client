    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="客户经理名称">
          <a-input placeholder="请输入客户经理名称" v-decorator="['yggh_dictText', {}]" :disabled="true" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="评价结果">
          <!--<a-input placeholder="请输入评价结果" v-decorator="['pjjg', {}]" />-->
          <j-dict-select-tag placeholder="请选择评定周期" v-decorator="['pjjg', {}]" :triggerChange="true" dictCode="pjjg"/>
        </a-form-item>
        <!--<a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/zhzhpj/zhzhpj/add",
          edit: "/zhzhpj/zhzhpj/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'zzbz','gwbz','yggh','yggh_dictText','khjlbz','pjjg'))
		  //时间格式化
