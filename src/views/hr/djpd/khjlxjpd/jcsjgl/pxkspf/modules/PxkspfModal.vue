    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="客户经理名称">
          <a-input placeholder="请输入客户经理名称" v-decorator="['yggh_dictText', validatorRules.yggh ]" :disabled="true"/>
        </a-form-item>
        <!--<a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="考试时间">
          <a-date-picker v-decorator="[ 'kssj', validatorRules.kssj ]" style="width: 100%" :disabled="true" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="考试类型">
          <j-dict-select-tag placeholder="请输入考试类型" v-decorator="['kslx', {}]" :triggerChange="true" dictCode="kslx"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'ksmc','ksms','ksdf','kslx','zzbz','gwbz','yggh','yggh_dictText','khjlbz'))
		  //时间格式化
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            let httpurl = '';
            let method = '';
            if(!this.model.yggh && !this.model.zzbz && !this.model.gwbz && !this.model.kssj){
