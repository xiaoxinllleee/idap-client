<template>
  <a-card :bordered="false">
        ...
        <template v-if="toggleSearchStatus">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="存款类型">
              <a-select placeholder="全部" v-model="queryParam.cklx">
                <a-select-option value="对私定期">
                  对私定期
                </a-select-option>
                <a-select-option value="对私活期">
                  对私活期
                </a-select-option>
                <a-select-option value="对公定期">
                  对公定期
                </a-select-option>
                <a-select-option value="对公活期">
                  对公活期
                </a-select-option>
                <a-select-option value="一本通">
                  一本通
                </a-select-option>
              </a-select>
            </a-form-item>
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="最早开户日">
              <a-range-picker @change="onChangezzkhr" v-model="queryParam.zzkhr"></a-range-picker>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      <a-button icon="download" @click="handleExportXls('支行存款客户分类汇总表')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <zhckkhflhzb-modal ref="modalForm" @ok="modalFormOk"></zhckkhflhzb-modal>
  </a-card>
</template>

<script>
  import ZhckkhflhzbModal from './modules/ZhckkhflhzbModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import JTreeSelect from '@/components/jeecg/JTreeSelect'
  import {filterObj} from "@/utils/util";

  export default {
    name: "ZhckkhflhzbList",
    mixins:[JeecgListMixin],
    components: {
      ZhckkhflhzbModal,JTreeSelect
    },
    data () {
      return {
        description: '支行存款客户分类汇总表管理页面',
        defaultMonthOpera: '',
        monthFormat: 'YYYY-MM',
        // 表头
        columns: [
		...
		url: {
          list: "/zhckkhflhzb/zhckkhflhzb/list",
          delete: "/zhckkhflhzb/zhckkhflhzb/delete",
          deleteBatch: "/zhckkhflhzb/zhckkhflhzb/deleteBatch",
          exportXlsUrl: "zhckkhflhzb/zhckkhflhzb/exportXls",
          importExcelUrl: "zhckkhflhzb/zhckkhflhzb/importExcel",
       },
    }
  },
  computed: {
