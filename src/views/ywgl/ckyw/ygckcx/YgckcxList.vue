<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" @click="handleExportXls('员工存款查询')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <ygckcx-modal ref="modalForm" @ok="modalFormOk"></ygckcx-modal>
  </a-card>
</template>

<script>
  import YgckcxModal from './modules/YgckcxModal'
  ...
  export default {
    ...
    components: {
      YgckcxModal,JTreeSelect
    },
    data () {
      return {
        description: '员工存款查询管理页面',
        defaultMonthOpera: '',
        monthFormat: 'YYYY-MM',
        // 表头
        columns: [
		...
		url: {
          list: "/ygckcx/ygckcx/list",
          delete: "/ygckcx/ygckcx/delete",
          deleteBatch: "/ygckcx/ygckcx/deleteBatch",
          exportXlsUrl: "ygckcx/ygckcx/exportXls",
          importExcelUrl: "ygckcx/ygckcx/importExcel",
          init: "/ygckcx/ygckcx/init",
       },
    }
  },
  computed: {
