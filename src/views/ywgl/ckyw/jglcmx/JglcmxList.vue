<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <jglcmx-modal ref="modalForm" @ok="modalFormOk"></jglcmx-modal>
  </a-card>
</template>

<script>
  import JglcmxModal from './modules/JglcmxModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/jglcmx/jglcmx/list",
          delete: "/jglcmx/jglcmx/delete",
          deleteBatch: "/jglcmx/jglcmx/deleteBatch",
          exportXlsUrl: "jglcmx/jglcmx/exportXls",
          importExcelUrl: "jglcmx/jglcmx/importExcel",
          init: "/jglcmx/jglcmx/init",
       },
    }
  },
  computed: {
    ...
    methods: {
      ...
      init() {
        ...
        let params = {
          tjyf: moment(this.queryParam.tjyf).format("YYYY-MM"),
        }
        this.loading = true
