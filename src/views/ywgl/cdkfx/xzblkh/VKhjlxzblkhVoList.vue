...
<!--                    </a-col>-->
    ...
    <div class="table-operator">
        <a-button :loading="exportLoading" icon="download" @click="handleExportXls('新增不良考核')" v-has="'xzblkk:exportXls'">导出</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'xzblkk:edit'">编辑</a>
        ...
        <!--  <a-dropdown>
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                ...
                <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)" v-has="'xzblkk:delete'">
                  <a>删除</a>
                </a-popconfirm>
        </span>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/xzblkh/vKhjlxzblkhVo/list",
          delete: "/xzblkh/vKhjlxzblkhVo/delete",
          deleteBatch: "/xzblkh/vKhjlxzblkhVo/deleteBatch",
          exportXlsUrl: "xzblkh/vKhjlxzblkhVo/exportXls",
          importExcelUrl: "xzblkh/vKhjlxzblkhVo/importExcel",
       },
    }
  },
  computed: {
