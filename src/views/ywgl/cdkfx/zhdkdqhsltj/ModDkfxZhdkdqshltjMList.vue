...
<!--          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <!--    </div>-->
    <div class="table-operator">
      <a-button style="margin-left: 7px" icon="download" :loading="exportLoading"  @click="handleExportXls('支行贷款到期收回率统计')" v-has="'zhdkdqshltj:exportXls'">导出</a-button>
    </div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'zhdkdqshltj:edit'">编辑</a>
         ...
         <!-- <a-dropdown>
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                ...
                <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)" v-has="'zhdkdqshltj:delete'">
                  <a>删除</a>
                </a-popconfirm>
...
<script>
  import ModDkfxZhdkdqshltjMModal from './modules/ModDkfxZhdkdqshltjMModal'
  ...
  export default {
    name: "ModDkfxZhdkdqshltjMList",
    mixins:[JeecgListMixin],
    components: {
      ModDkfxZhdkdqshltjMModal,JTreeSelect
    },
    data () {
      return {
        description: '支行贷款到期收回率管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        defaultMonthOpera: '',
        // 表头
		...
		url: {
          list: "/zhdkdqhsltj/modDkfxZhdkdqshltjM/list",
          delete: "/zhdkdqhsltj/modDkfxZhdkdqshltjM/delete",
          deleteBatch: "/zhdkdqhsltj/modDkfxZhdkdqshltjM/deleteBatch",
          exportXlsUrl: "zhdkdqhsltj/modDkfxZhdkdqshltjM/exportXls",
          importExcelUrl: "zhdkdqhsltj/modDkfxZhdkdqshltjM/importExcel",
       },
    }
  },
  computed: {
