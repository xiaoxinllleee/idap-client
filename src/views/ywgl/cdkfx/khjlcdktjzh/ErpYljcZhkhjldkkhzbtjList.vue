<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('客户经理存贷款统计(支行)')" v-has="'khjlzbtjzh:exportXls'">导出</a-button>
      <a-button @click="count" icon="area-chart" v-has="'khjlzbtjzh:init'">提取</a-button>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'khjlzbtjzh:edit'">编辑</a>
         ...
         <!-- <a-dropdown>
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                ...
                <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)" v-has="'khjlzbtjzh:delete'">
                  <a>删除</a>
                </a-popconfirm>
    ...
    <!-- 表单区域 -->
    <erp-yljc-zhkhjldkkhzbtj-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>

</template>

<script>
  import ErpYljcZhkhjldkkhzbtjModal from './modules/ErpYljcZhkhjldkkhzbtjModal'
  ...
  export default {
    name: "ErpYljcZhkhjldkkhzbtjList",
    mixins:[JeecgListMixin],
    components: {
      ErpYljcZhkhjldkkhzbtjModal,JTreeSelect
    },
    data () {
      return {
        monthFormat: 'YYYY-MM',
        description: '客户经理指标统计(支行)管理页面',
        // 表头
        columns: [
          {
            title: '#',
		...
		url: {
          list: "/khjlcdktjzh/erpYljcZhkhjldkkhzbtj/list",
          delete: "/khjlcdktjzh/erpYljcZhkhjldkkhzbtj/delete",
          deleteBatch: "/khjlcdktjzh/erpYljcZhkhjldkkhzbtj/deleteBatch",
          exportXlsUrl: "khjlcdktjzh/erpYljcZhkhjldkkhzbtj/exportXls",
          importExcelUrl: "khjlcdktjzh/erpYljcZhkhjldkkhzbtj/importExcel",
          count: "/khjlcdktjzh/erpYljcZhkhjldkkhzbtj/count",
       },
    }
  },
