    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="员工机构代码">
          <a-input placeholder="请输入员工机构代码" v-decorator="['jgdm', validatorRules.jgdm ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="业务机构代码">
          <a-input placeholder="请输入业务机构代码" v-decorator="['ywjgdm', validatorRules.ywjgdm ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="本月收回利息">
          <a-input placeholder="请输入本月收回利息" v-decorator="['byshlx', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="权限内贷款户数">
          <a-input placeholder="请输入权限内贷款户数" v-decorator="['qxndkhs', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="权限外贷款户数">
          <a-input placeholder="请输入权限外贷款户数" v-decorator="['qxwdkhs', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="权限内贷款笔数">
          <a-input placeholder="请输入权限内贷款笔数" v-decorator="['qxndkbs', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="权限外贷款笔数">
          <a-input placeholder="请输入权限外贷款笔数" v-decorator="['qxwdkbs', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="dkdyrp">
          <a-input placeholder="请输入dkdyrp" v-decorator="['dkdyrp', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="结息账号存款日平余额">
          <a-input placeholder="请输入结息账号存款日平余额" v-decorator="['jxckrpye', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="结息账号存款年日平余额">
          <a-input placeholder="请输入结息账号存款年日平余额" v-decorator="['jxcknrpye', {}]" />
        </a-form-item>
...
<script>
  ...
  export default {
    name: "ErpYljcZhkhjldkkhzbtjModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        validatorRules:{
        jgdm:{rules: [{ required: true, message: '请输入员工机构代码!' }]},
        tjyf:{rules: [{ required: true, message: '请输入统计月份!' }]},
        yggh:{rules: [{ required: true, message: '请输入员工工号!' }]},
        ywjgdm:{rules: [{ required: true, message: '请输入业务机构代码!' }]},
        },
        url: {
          add: "/khjlcdktjzh/erpYljcZhkhjldkkhzbtj/add",
          edit: "/khjlcdktjzh/erpYljcZhkhjldkkhzbtj/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'jgdm','custid','yggh','ygxm','ywjgdm','ckrpye','cknrpye','dkrpye','byshlx','qxndkhs','qxwdkhs','qxndkbs','qxwdkbs','dkdyrp','lrbz','lrczy','dkye','ckye','jxckrpye','jxcknrpye'))
		  //时间格式化
