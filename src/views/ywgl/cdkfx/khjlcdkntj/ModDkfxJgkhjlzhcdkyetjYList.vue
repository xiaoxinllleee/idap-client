<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <modDkfxJgkhjlzhcdkyetjY-modal ref="modalForm" @ok="modalFormOk"></modDkfxJgkhjlzhcdkyetjY-modal>
  </a-card>
</template>

<script>
  import ModDkfxJgkhjlzhcdkyetjYModal from './modules/ModDkfxJgkhjlzhcdkyetjYModal'
  ...
  export default {
    name: "ModDkfxJgkhjlzhcdkyetjYList",
    mixins:[JeecgListMixin],
    components: {
      ModDkfxJgkhjlzhcdkyetjYModal,JTreeSelect
    },
    data () {
      return {
        ...
        url: {
          list: "/khjlcdkntj/modDkfxJgkhjlzhcdkyetjY/list",
          delete: "/khjlcdkntj/modDkfxJgkhjlzhcdkyetjY/delete",
          deleteBatch: "/khjlcdkntj/modDkfxJgkhjlzhcdkyetjY/deleteBatch",
          exportXlsUrl: "/khjlcdkntj/modDkfxJgkhjlzhcdkyetjY/exportXls",
          importExcelUrl: "/khjlcdkntj/modDkfxJgkhjlzhcdkyetjY/importExcel",
        },
      }
    },
  computed: {
