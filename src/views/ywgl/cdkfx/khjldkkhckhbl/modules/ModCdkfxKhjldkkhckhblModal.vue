...
<script>
  ...
  export default {
    name: "ModCdkfxKhjldkkhckhblModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/khjldkkhckhbl/modCdkfxKhjldkkhckhbl/add",
          edit: "/khjldkkhckhbl/modCdkfxKhjldkkhckhbl/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'ckye','dkye','ckyehbl','jgdm','khjl','yggh','dknrp','cknrp','ckhbl','lrbz','lrr'))
		  //时间格式化
