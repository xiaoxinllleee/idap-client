<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <!--          <a-col :xl="6" :lg="7" :md="8" :sm="24">-->
          <!--            <a-form-item label="本期新增不良余额">-->
          <!--              <a-input placeholder="请输入本期新增不良余额" v-model="queryParam.bqxzbl"></a-input>-->
          <!--            </a-form-item>-->
          <!--          </a-col>-->
          <!--          <a-col :xl="6" :lg="7" :md="8" :sm="24">-->
          <!--            <a-form-item label="表外不良">-->
          <!--              <a-input placeholder="请输入表外不良" v-model="queryParam.bwbl"></a-input>-->
          <!--            </a-form-item>-->
          <!--          </a-col>-->
          <!--          <a-col :xl="6" :lg="7" :md="8" :sm="24">-->
          <!--            <a-form-item label="表内不良">-->
          <!--              <a-input placeholder="请输入表内不良" v-model="queryParam.bnbl"></a-input>-->
          <!--            </a-form-item>-->
          <!--          </a-col>-->
          <!--          </template>-->
    ...
    <div class="table-operator">
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('支行新增不良贷款汇总')" v-has="'zhxzbldkhz:exportXls'">导出</a-button>
      <a-button @click="count" icon="area-chart" v-has="'zhxzbldkhz:init'">提取</a-button>
    ...
    <div>
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'zhxzbldkhz:edit'">编辑</a>
         ...
         <!-- <a-dropdown>
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                ...
                <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)" v-has="'zhxzbldkhz:delete'">
                  <a>删除</a>
                </a-popconfirm>
...
export default {
  ...
  data () {
    return {
      ...
      url: {
        list: "/zhxzbldkhz/erpJxkhZhxzbldkhz/list",
        delete: "/zhxzbldkhz/erpJxkhZhxzbldkhz/delete",
        deleteBatch: "/zhxzbldkhz/erpJxkhZhxzbldkhz/deleteBatch",
        exportXlsUrl: "zhxzbldkhz/erpJxkhZhxzbldkhz/exportXls",
        importExcelUrl: "zhxzbldkhz/erpJxkhZhxzbldkhz/importExcel",
        count: "zhxzbldkhz/erpJxkhZhxzbldkhz/count",
      },
    }
  },
  computed: {
