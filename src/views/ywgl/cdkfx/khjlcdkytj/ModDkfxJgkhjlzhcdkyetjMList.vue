<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('客户经理存贷款月统计')" v-has="'cdkytj:exportXls'">导出</a-button>
...
<!--      </a-upload>-->
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'cdkytj:edit'">编辑</a>
        ...
        <!--  <a-dropdown>
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                ...
                <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)" v-has="'cdkytj:delete'">
                  <a>删除</a>
                </a-popconfirm>
        </span>
    ...
    <!-- 表单区域 -->
    <modDkfxJgkhjlzhcdkyetjM-modal ref="modalForm" @ok="modalFormOk"></modDkfxJgkhjlzhcdkyetjM-modal>
  </a-card>
</template>

<script>
  import ModDkfxJgkhjlzhcdkyetjMModal from './modules/ModDkfxJgkhjlzhcdkyetjMModal'
  ...
  export default {
    name: "ModDkfxJgkhjlzhcdkyetjMList",
    mixins:[JeecgListMixin],
    components: {
      ModDkfxJgkhjlzhcdkyetjMModal,JTreeSelect
    },
    data () {
      return {
        description: '客户经理存贷款月统计管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        defaultMonthOpera: '',
        // 表头
		...
		url: {
          list: "/khjlcdkytj/modDkfxJgkhjlzhcdkyetjM/list",
          delete: "/khjlcdkytj/modDkfxJgkhjlzhcdkyetjM/delete",
          deleteBatch: "/khjlcdkytj/modDkfxJgkhjlzhcdkyetjM/deleteBatch",
          exportXlsUrl: "khjlcdkytj/modDkfxJgkhjlzhcdkyetjM/exportXls",
          importExcelUrl: "khjlcdkytj/modDkfxJgkhjlzhcdkyetjM/importExcel",
       },
    }
  },
  computed: {
