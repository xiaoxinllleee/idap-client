    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="贷款当月日平">
          <a-input placeholder="请输入贷款当月日平" v-decorator="['dkdyrp', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
...
<script>
  ...
  export default {
    name: "ModDkfxJgkhjlzhcdkyetjMModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/khjlcdkytj/modDkfxJgkhjlzhcdkyetjM/add",
          edit: "/khjlcdkytj/modDkfxJgkhjlzhcdkyetjM/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'tjts','ckyezh','ckrpye','dkyezh','dkrpye','lrbz','lrczy','dkdyrp','yggh','jgdm','custid'))
		  //时间格式化
