<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <vModDkfxKhjldkdqshlkhMV-modal ref="modalForm" @ok="modalFormOk"></vModDkfxKhjldkdqshlkhMV-modal>
  </a-card>
</template>

<script>
  import VModDkfxKhjldkdqshlkhMVModal from './modules/VModDkfxKhjldkdqshlkhMVModal'
  ...
  export default {
    name: "VModDkfxKhjldkdqshlkhMVList",
    mixins:[JeecgListMixin],
    components: {
      VModDkfxKhjldkdqshlkhMVModal,JTreeSelect
    },
    data () {
      return {
        monthFormat: 'YYYY-MM',
		...
		url: {
          list: "/dqhslkh/vModDkfxKhjldkdqshlkhMV/list",
          delete: "/dqhslkh/vModDkfxKhjldkdqshlkhMV/delete",
          deleteBatch: "/dqhslkh/vModDkfxKhjldkdqshlkhMV/deleteBatch",
          exportXlsUrl: "dqhslkh/vModDkfxKhjldkdqshlkhMV/exportXls",
          importExcelUrl: "dqhslkh/vModDkfxKhjldkdqshlkhMV/importExcel",
       },
    }
  },
  computed: {
