<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button  :loading="exportLoading" icon="download" @click="handleExportXls('客户经理贷款发放收回统计')" v-has="'khjldkffshltj:exportXls'">导出</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'khjldkffshltj:edit'">编辑</a>
        ...
        <!--  <a-dropdown>
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                ...
                <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)" v-has="'khjldkffshltj:delete'">
                  <a>删除</a>
                </a-popconfirm>
    ...
    <!-- 表单区域 -->
    <modDkfxJgkhjldkshqkMVo-modal ref="modalForm" @ok="modalFormOk"></modDkfxJgkhjldkshqkMVo-modal>
  </a-card>
</template>

<script>
  import ModDkfxJgkhjldkshqkMVoModal from './modules/ModDkfxJgkhjldkshqkMVoModal'
  ...
  export default {
    name: "ModDkfxJgkhjldkshqkMVoList",
    mixins:[JeecgListMixin],
    components: {
      ModDkfxJgkhjldkshqkMVoModal,JTreeSelect
    },
    data () {
      return {
		...
		url: {
          list: "/khjldkffshltj/modDkfxJgkhjldkshqkMVo/list",
          delete: "/khjldkffshltj/modDkfxJgkhjldkshqkMVo/delete",
          deleteBatch: "/khjldkffshltj/modDkfxJgkhjldkshqkMVo/deleteBatch",
          exportXlsUrl: "khjldkffshltj/modDkfxJgkhjldkshqkMVo/exportXls",
          importExcelUrl: "khjldkffshltj/modDkfxJgkhjldkshqkMVo/importExcel",
       },
    }
  },
  computed: {
