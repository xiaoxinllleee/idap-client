<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('客户经理贷款五级分类')" v-has="'wjfl:exportXls'">导出</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'wjfl:edit'">编辑</a>
          ...
          <!--<a-dropdown>
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                ...
                <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)" v-has="'wjfl:delete'">
                  <a>删除</a>
                </a-popconfirm>
        </span>
...
<script>
  ...
  export default {
    name: "ModDkfxJgkhjldkwjfltjMVoList",
    ...
    data () {
      return {
		...
		url: {
          list: "/khjldkwjfl/modDkfxJgkhjldkwjfltjMVo/list",
          delete: "/khjldkwjfl/modDkfxJgkhjldkwjfltjMVo/delete",
          deleteBatch: "/khjldkwjfl/modDkfxJgkhjldkwjfltjMVo/deleteBatch",
          exportXlsUrl: "khjldkwjfl/modDkfxJgkhjldkwjfltjMVo/exportXls",
          importExcelUrl: "khjldkwjfl/modDkfxJgkhjldkwjfltjMVo/importExcel",
       },
    }
  },
  computed: {
