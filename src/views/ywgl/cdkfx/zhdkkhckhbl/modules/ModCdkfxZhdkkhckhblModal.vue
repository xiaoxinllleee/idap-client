  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/zhdkkhckhbl/modCdkfxZhdkkhckhbl/add",
          edit: "/zhdkkhckhbl/modCdkfxZhdkkhckhbl/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'ckye','dkye','ckyehbl','jgdm','dknrp','cknrp','ckhbl','lrbz','lrr'))
		  //时间格式化
