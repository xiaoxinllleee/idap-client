<template>
  <a-card :bordered="false">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="客户经理名称">
                <a-input placeholder="请输入客户经理名称" v-model="queryParam.khjlmc"></a-input>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('账户日评报表')" v-has="'zhrpbb:exportXls'">导出</a-button>
    ...
    <!-- 表单区域 -->
    <zhrpbb-modal ref="modalForm" @ok="modalFormOk"></zhrpbb-modal>
  </a-card>
</template>

<script>
  import ZhrpbbModal from './modules/ZhrpbbModal'
  ...
  export default {
    ...
    components: {
      ZhrpbbModal,JTreeSelect
    },
    data () {
      return {
        description: '账户日评报表管理页面',
        queryParam: {pdlx: 'MM'},
        dateValue: '',
        pdlxYY: null,
        pdlxM: null,
		...
		url: {
          list: "/zhrpbb/zhrpbb/list",
          delete: "/zhrpbb/zhrpbb/delete",
          deleteBatch: "/zhrpbb/zhrpbb/deleteBatch",
          exportXlsUrl: "zhrpbb/zhrpbb/exportXls",
          importExcelUrl: "zhrpbb/zhrpbb/importExcel",
       },
    }
  },
  computed: {
