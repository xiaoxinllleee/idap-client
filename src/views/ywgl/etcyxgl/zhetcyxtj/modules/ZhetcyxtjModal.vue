  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/zhetcyxtj/zhetcyxtj/add",
          edit: "/zhetcyxtj/zhetcyxtj/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'jgdm','etczhs','etckhs','etcxhs','etcjzs','lrbz','lrczy','etcqchs','etcqmhs'))
		  //时间格式化
