<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="数据月份">
              <a-month-picker placeholder="请选择数据月份" v-model="queryParam.tjyf" style="width: 100%;"
    ...
    <div class="table-operator">
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('员工etc业务营销统计')" v-has="'ygetcywyxtj:exportXls'">导出</a-button>
      <a-button icon="area-chart" @click="init" v-has="'ygetcywyxtj:init'">提取</a-button>
    ...
    <!-- 表单区域 -->
    <ygetcywyxtj-modal ref="modalForm" @ok="modalFormOk"></ygetcywyxtj-modal>
  </a-card>
</template>

<script>
  import YgetcywyxtjModal from './modules/YgetcywyxtjModal'
  ...
  export default {
    name: "YgetcywyxtjList",
    mixins:[JeecgListMixin],
    components: {
      YgetcywyxtjModal,JTreeSelect
    },
    data () {
      return {
        description: '员工etc业务营销统计管理页面',
        defaultMonthOpera: '',
        monthFormat: 'YYYY-MM',
        // 表头
        columns: [
		...
		url: {
          list: "/ygetcywyxtj/ygetcywyxtj/list",
          delete: "/ygetcywyxtj/ygetcywyxtj/delete",
          deleteBatch: "/ygetcywyxtj/ygetcywyxtj/deleteBatch",
          exportXlsUrl: "ygetcywyxtj/ygetcywyxtj/exportXls",
          importExcelUrl: "ygetcywyxtj/ygetcywyxtj/importExcel",
          init: "/ygetcywyxtj/ygetcywyxtj/init",
       },
    }
  },
  computed: {
