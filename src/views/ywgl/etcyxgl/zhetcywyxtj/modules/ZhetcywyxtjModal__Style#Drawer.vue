  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/zhetcywyxtj/zhetcywyxtj/add",
          edit: "/zhetcywyxtj/zhetcywyxtj/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'jgdm','ncsl','ncxs','ncxx','qmsl','qmxs','qmxx','bnjz','xsjz','xxjz','lrbz','lrczy','pxxh'))
		  //时间格式化
