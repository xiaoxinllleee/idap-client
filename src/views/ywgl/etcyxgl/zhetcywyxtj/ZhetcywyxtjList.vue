<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('支行etc业务营销统计')" v-has="'zhetcywyxtj:exportXls'">导出</a-button>
      <a-button icon="area-chart" @click="init" v-has="'zhetcywyxtj:init'">提取</a-button>
    ...
    <!-- 表单区域 -->
    <zhetcywyxtj-modal ref="modalForm" @ok="modalFormOk"></zhetcywyxtj-modal>
  </a-card>
</template>

<script>
  import ZhetcywyxtjModal from './modules/ZhetcywyxtjModal'
  ...
  export default {
    name: "ZhetcywyxtjList",
    mixins:[JeecgListMixin],
    components: {
      ZhetcywyxtjModal,JTreeSelect
    },
    data () {
      return {
        description: '支行etc业务营销统计管理页面',
        defaultMonthOpera: '',
        monthFormat: 'YYYY-MM',
        // 表头
        columns: [
		...
		url: {
          list: "/zhetcywyxtj/zhetcywyxtj/list",
          delete: "/zhetcywyxtj/zhetcywyxtj/delete",
          deleteBatch: "/zhetcywyxtj/zhetcywyxtj/deleteBatch",
          exportXlsUrl: "zhetcywyxtj/zhetcywyxtj/exportXls",
          importExcelUrl: "zhetcywyxtj/zhetcywyxtj/importExcel",
          init: "/zhetcywyxtj/zhetcywyxtj/init",
       },
    }
  },
  computed: {
