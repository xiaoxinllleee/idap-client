<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('员工etc营销统计')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <ygetcyxtj-modal ref="modalForm" @ok="modalFormOk"></ygetcyxtj-modal>
  </a-card>
</template>

<script>
  import YgetcyxtjModal from './modules/YgetcyxtjModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/ygetcyxtj/ygetcyxtj/list",
          delete: "/ygetcyxtj/ygetcyxtj/delete",
          deleteBatch: "/ygetcyxtj/ygetcyxtj/deleteBatch",
          exportXlsUrl: "ygetcyxtj/ygetcyxtj/exportXls",
          importExcelUrl: "ygetcyxtj/ygetcyxtj/importExcel",
          init: "/ygetcyxtj/ygetcyxtj/init",
       },
    }
  },
  computed: {
