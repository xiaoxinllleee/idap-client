  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/ygetcyxtj/ygetcyxtj/add",
          edit: "/ygetcyxtj/ygetcyxtj/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'jgdm','yggh','ygxm','etczhs','etckhs','etcxhs','etcjzs','lrbz','lrczy'))
		  //时间格式化
