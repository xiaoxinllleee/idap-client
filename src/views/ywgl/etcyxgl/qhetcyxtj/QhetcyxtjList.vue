<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" @click="handleExportXls('全行etc营销统计')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <qhetcyxtj-modal ref="modalForm" @ok="modalFormOk"></qhetcyxtj-modal>
  </a-card>
</template>

<script>
  import QhetcyxtjModal from './modules/QhetcyxtjModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/qhetcyxtj/qhetcyxtj/list",
          delete: "/qhetcyxtj/qhetcyxtj/delete",
          deleteBatch: "/qhetcyxtj/qhetcyxtj/deleteBatch",
          exportXlsUrl: "qhetcyxtj/qhetcyxtj/exportXls",
          importExcelUrl: "qhetcyxtj/qhetcyxtj/importExcel",
          init: "/qhetcyxtj/qhetcyxtj/init",
       },
    }
  },
  computed: {
