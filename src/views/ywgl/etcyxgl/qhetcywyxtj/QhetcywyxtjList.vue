<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('全行etc业务营销统计')" v-has="'qhetcywyxtj:exportXls'">导出</a-button>
      <a-button icon="area-chart" @click="init" v-has="'qhetcywyxtj:init'">提取</a-button>
    ...
    <!-- 表单区域 -->
    <qhetcywyxtj-modal ref="modalForm" @ok="modalFormOk"></qhetcywyxtj-modal>
  </a-card>
</template>

<script>
  import QhetcywyxtjModal from './modules/QhetcywyxtjModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/qhetcywyxtj/qhetcywyxtj/list",
          delete: "/qhetcywyxtj/qhetcywyxtj/delete",
          deleteBatch: "/qhetcywyxtj/qhetcywyxtj/deleteBatch",
          exportXlsUrl: "qhetcywyxtj/qhetcywyxtj/exportXls",
          importExcelUrl: "qhetcywyxtj/qhetcywyxtj/importExcel",
          init: "/qhetcywyxtj/qhetcywyxtj/init",
       },
    }
  },
  computed: {
