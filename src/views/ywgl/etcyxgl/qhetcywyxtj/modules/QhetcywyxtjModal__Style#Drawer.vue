  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/qhetcywyxtj/qhetcywyxtj/add",
          edit: "/qhetcywyxtj/qhetcywyxtj/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'ncsl','ncxs','ncxx','qmsl','qmxs','qmxx','bnjz','xsjz','xxjz','lrbz','lrczy'))
		  //时间格式化
