    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="户名">
          <a-input placeholder="请输入户名" v-decorator="['khxm', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="存量月日平">
          <a-input placeholder="请输入存量月日平" v-decorator="['clyrp', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="存量年日平">
          <a-input placeholder="请输入存量年日平" v-decorator="['clnrp', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="联系电话">
          <a-input placeholder="请输入联系电话" v-decorator="['dhhm', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/ygglckkhmx/ckjkptKhfzYgglkhmx/add",
          edit: "/ygglckkhmx/ckjkptKhfzYgglkhmx/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'zzbz','yggh','khxm','zjhm','ckye','ckyrpye','cknrpye','zshckye','zshckyrpye','zhscknrpye','lrr','lrbz','gwbz','clye','clyrp','clnrp','dhhm'))
		  //时间格式化
