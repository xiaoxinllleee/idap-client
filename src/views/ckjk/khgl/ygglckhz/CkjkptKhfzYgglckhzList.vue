<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="所属组织">
              <j-tree-select placeholder="全部" v-model="queryParam.zzbz"
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="本月年日平">
              <a-input placeholder="" v-model="queryParam.cknrpye_begin" style="width: 40%; text-align: center"/>
              <a-input placeholder="~"
                       style="width: 20%; border-left: 0; pointer-events: none; backgroundColor: #fff; text-align: center"
                       disabled/>
              <a-input placeholder="" v-model="queryParam.cknrpye_end" style="width: 40%; text-align: center; border-left: 0"/>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="本月余额">
              <a-input placeholder="" v-model="queryParam.ckye_begin" style="width: 40%;"/>
              <a-input placeholder="~"
                       style="width: 20%; border-left: 0; pointer-events: none; backgroundColor: #fff; text-align: center"
                       disabled/>
    ...
    <!--  <a-button type="primary" @click="searchQuery" icon="search">查询</a-button>
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('员工关联存款汇总')" v-has="'ygglckhz:exportXls'">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleView(record)" v-has="'ygglckhz:handle'">查看</a>
          <a-divider type="vertical"/>
          <a @click="handleViewBalance(record)" v-has="'ygglckhz:handleBalance'">查看近十日余额</a>
        </span>
    ...
    <!-- 表单区域 -->
    <ckjkptKhfzYgglckhz-modal ref="modalForm" @ok="modalFormOk"></ckjkptKhfzYgglckhz-modal>
...
<script>
  import CkjkptKhfzYgglckhzModal from './modules/CkjkptKhfzYgglckhzModal'
  ...
  export default {
    name: "CkjkptKhfzYgglckhzList",
    mixins: [JeecgListMixin],
    components: {
      CkjkptKhfzYgglckhzModal,
      JTreeSelect,
      jsrckyeqs,
      ygckkhfx
    },
    data() {
      return {
        ...
        url: {
          list: "/ygglckhz/ckjkptKhfzYgglckhz/list",
          jsryefxlist: "/yglcckhz/ckjkptKhfzYgglckhzqsfx/queryList",
          ygkhfxlist: "/ygglckhz/ckjkptKhfzYgglckhz/queryList",
          delete: "/ygglckhz/ckjkptKhfzYgglckhz/delete",
          deleteBatch: "/ygglckhz/ckjkptKhfzYgglckhz/deleteBatch",
          exportXlsUrl: "ygglckhz/ckjkptKhfzYgglckhz/exportXls",
          importExcelUrl: "ygglckhz/ckjkptKhfzYgglckhz/importExcel",
        },
      }
    },
    computed: {
    ...
    methods: {
      ...
      handleView: function (record) {
        ...
        putAction(this.url.ygkhfxlist, {zzbz:record.zzbz,gwbz:record.gwbz,yggh:record.yggh }).then((res) => {
          if (res.success) {
      ...
      handleViewBalance: function (record) {
        putAction(this.url.jsryefxlist, {zzbz:record.zzbz,gwbz:record.gwbz,yggh:record.yggh }).then((res) => {
          if (res.success) {
