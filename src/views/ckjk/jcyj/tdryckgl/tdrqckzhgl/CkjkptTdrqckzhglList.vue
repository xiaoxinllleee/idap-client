<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button @click="handleAdd" type="primary" icon="plus" v-has="'tdrqckzhgl:add'">添加</a-button>
      <a-button  icon="download" :loading="exportLoading" @click="handleExportXls('特定人群存款账号管理')" v-has="'tdrqckzhgl:exp'">导出</a-button>
      <a-button icon="import" @click="excelImport" v-has="'tdrqckzhgl:imp'">导入</a-button>
    </div>
      ...
      <a-table ref="table"
        ...
        <span slot="action" slot-scope="text, record">
          <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record)">
            <a v-has="'tdrqckzhgl:delete'">删除</a>
          </a-popconfirm>
        </span>
      </a-table>
    </div>
    ...
    <!-- 表单区域 -->
    <ckjkptTdrqckzhgl-modal ref="modalForm" @ok="modalFormOk"></ckjkptTdrqckzhgl-modal>
    <excel-import ref="excelImportModal" @ok="importComplete"></excel-import>
  </a-card>
</template>

<script>
  import CkjkptTdrqckzhglModal from './modules/CkjkptTdrqckzhglModal'
  ...
  export default {
    name: "CkjkptTdrqckzhglList",
    mixins: [JeecgListMixin],
    components: {
      JInput,
      CkjkptTdrqckzhglModal,
      JTreeSelect,
      ExcelImport,
    },
    data() {
      return {
        description: '特定人群存款账户管理页面',
        exportTemplateName: '特定人群存款账户管理导入模板',
        // 表头
        columns: [
          {
            title: '机构代码',
        ...
        url: {
          list: "/CkjkptTdrqckzhgl/ckjkptTdrqckzhgl/list",
          delete: "/CkjkptTdrqckzhgl/ckjkptTdrqckzhgl/delete",
          deleteBatch: "/CkjkptTdrqckzhgl/ckjkptTdrqckzhgl/deleteBatch",
          exportXlsUrl: "CkjkptTdrqckzhgl/ckjkptTdrqckzhgl/exportXls",
          importExcelUrl: "CkjkptTdrqckzhgl/ckjkptTdrqckzhgl/importExcel",
          exportTemplateUrl: "CkjkptTdrqckzhgl/ckjkptTdrqckzhgl/exportTemplateXls",
        },
      }
    },
    computed: {
