      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline">
          <a-row :gutter="24">
            ...
            <a-col :span="6"><a-form-item label="客户姓名">
            ...
            <a-col :span="6"><a-form-item label="存款账号">
              <a-input placeholder="请输入存款账号" v-model="queryParam.subAcctNo"></a-input>
            </a-form-item></a-col>
            <a-col :span="6">
  ...
  export default {
    ...
    methods: {
      ...
      handleOk() {
        ...
        console.info('确认客户信息:',this.selectionRows)
      ...
      onSelectChange(selectedRowKeys, selectedRows) {
        if (selectedRowKeys.length == 1) {
          ...
          console.info('已选择的客户:',this.selectionRows)
        } else {
          alert("只能选择一条客户信息")
          this.selectedRows = [];
          this.selectedRowKeys = [];
