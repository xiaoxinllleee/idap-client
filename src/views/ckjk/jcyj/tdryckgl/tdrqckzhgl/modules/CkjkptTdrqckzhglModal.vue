...
<script>
  import FindAndBringBack from "../modules/FindAndBringBack";
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/CkjkptTdrqckzhgl/ckjkptTdrqckzhgl/add",
          edit: "/CkjkptTdrqckzhgl/ckjkptTdrqckzhgl/edit",
        },
      }
    },
    created () {
