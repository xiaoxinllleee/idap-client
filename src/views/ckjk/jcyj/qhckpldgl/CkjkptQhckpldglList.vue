<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('全行存款偏离度管理')" v-has="'qhckpldgl:exportXls'">导出</a-button>
    </div>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/CkjkptQhckpldgl/ckjkptQhckpldgl/list",
          delete: "/CkjkptQhckpldgl/ckjkptQhckpldgl/delete",
          deleteBatch: "/CkjkptQhckpldgl/ckjkptQhckpldgl/deleteBatch",
          exportXlsUrl: "CkjkptQhckpldgl/ckjkptQhckpldgl/exportXls",
          importExcelUrl: "CkjkptQhckpldgl/ckjkptQhckpldgl/importExcel",
        },
      }
    },
    computed: {
