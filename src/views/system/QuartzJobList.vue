<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="10">
            <a-form-item label="任务类名">
              <j-input placeholder="请输入任务类名" v-model="queryParam.jobClassName" type="likemore"/>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="10">
      ...
      <a-table ref="table"
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
                <a-menu-item><a @click="selectLog(record)">查看日志</a></a-menu-item>
    ...
    <LogDetailModal ref='logDetail'></LogDetailModal>
  </a-card>
...
<script>
  ...
  import LogDetailModal from './modules/LogDeatilModal'
  export default {
    name: "QuartzJobList",
    ...
    methods: {
      selectLog(record)
      {
        this.$refs.logDetail.initLogInfo(record);

      },

      //筛选需要重写handleTableChange
      handleTableChange(pagination, filters, sorter) {
        console.log('hanldetablechange', filters, this.filters)
        //分页、排序、筛选变化时触发
        //TODO 筛选
