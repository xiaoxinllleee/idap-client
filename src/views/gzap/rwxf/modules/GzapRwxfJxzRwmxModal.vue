        ...
        <a-row>
          <a-col :span="12" :gutter="8">
            <a-form-item
              ...
              label="开始时间">
              <a-date-picker placeholder="请输入开始时间" style="width:100%" v-decorator="[ 'kssj', {}]"/>
            </a-form-item>
          </a-col>
          ...
          <a-col :span="12" :gutter="8">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="结束时间">
              <a-date-picker  placeholder="请输入结束时间" style="width:100%"  v-decorator="[ 'jssj', {}]"/>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row>
          ...
          <a-col :span="12" :gutter="8">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="重要级别">
              <j-dict-select-tag :triggerChange="true" v-decorator="['zyjb', {}]" placeholder="请选择重要级别" dictCode="gzap_zyjb"/>
        ...
        <a-tab-pane tab="任务对象管理" :key="refKeys[0]" :forceRender="true">
          <j-editable-table
            ...
            <template v-slot:rwdx="props"  >
              <j-select-user-by-dep v-model="props.text" :selectId="props.rowId" ref="jselect" @change="GetValue" />
            </template>
          </j-editable-table>
        </a-tab-pane>
      </a-tabs>
...
<script>
  ...
  export default {
    components: {ARow,JSelectUserByDep,JDictSelectTag},
    name: 'GzapRwxfJxzRwmxModal',
