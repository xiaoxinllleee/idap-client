<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('浏阳大屏指标数据项')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <lydpZbsjx-modal ref="modalForm" @ok="modalFormOk"></lydpZbsjx-modal>
  </a-card>
</template>

<script>
  import LydpZbsjxModal from './modules/LydpZbsjxModal'
  ...
  export default {
    ...
    components: {
      LydpZbsjxModal,ExcelImport
    },
    data () {
      return {
        description: '浏阳大屏指标数据项管理页面',
        // 表头
        columns: [
          {
            title: '#',
		...
		url: {
          list: "/lydpZbsjx/lydpZbsjx/list",
          delete: "/lydpZbsjx/lydpZbsjx/delete",
          deleteBatch: "/lydpZbsjx/lydpZbsjx/deleteBatch",
          exportXlsUrl: "lydpZbsjx/lydpZbsjx/exportXls",
          importExcelUrl: "lydpZbsjx/lydpZbsjx/importExcel",
          exportTemplateUrl: "/lydpZbsjx/lydpZbsjx/exportTemplateXls",
       },
        exportTemplateName: '指标数据项导入模板'
    }
  },
  computed: {
