<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('浏阳大屏指标结果表')">导出</a-button>
...
<!--      <a-dropdown v-if="selectedRowKeys.length > 0">
    ...
    <!-- 表单区域 -->
    <lydpZbjg-modal ref="modalForm" @ok="modalFormOk"></lydpZbjg-modal>
  </a-card>
</template>

<script>
  import LydpZbjgModal from './modules/LydpZbjgModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/lydpZbjg/lydpZbjg/list",
          delete: "/lydpZbjg/lydpZbjg/delete",
          deleteBatch: "/lydpZbjg/lydpZbjg/deleteBatch",
          exportXlsUrl: "lydpZbjg/lydpZbjg/exportXls",
          importExcelUrl: "lydpZbjg/lydpZbjg/importExcel",
          init:"/lydpZbjg/lydpZbjg/init"
       },
    }
  },
  computed: {
