    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="指标类型">
          <j-dict-select-tag  placeholder="请输入指标类型"  v-decorator="['zblx', {}]" :triggerChange="true" dict-code="zblx" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="是否启用">
          <j-dict-select-tag placeholder="请输入是否启用" v-decorator="['sfqy', {}]" :triggerChange="true" dict-code="sfbz"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/lydpQyzbsjx/lydpQyzbsjx/add",
          edit: "/lydpQyzbsjx/lydpQyzbsjx/edit",
        },
      }
    },
    created () {
