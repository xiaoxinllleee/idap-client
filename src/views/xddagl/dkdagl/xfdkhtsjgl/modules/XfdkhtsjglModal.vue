        ...
        <a-row class="form-row" :gutter="24">
          <a-col :span="8">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="客户类型">
              <j-dict-select-tag placeholder="请输入客户类型" v-decorator="['khlx', {}]" dictCode="xdda_khlx" :disabled="this.disabled"/>
            </a-form-item>
          </a-col>
          <a-col :span="8">
            <a-form-item
        ...
        <a-row class="form-row" :gutter="24">
          <a-col :span="8">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="贷款品种">
              <j-dict-select-tag placeholder="请输入贷款品种" v-decorator="['dkpz', {}]" dictCode="dkzl" />
            </a-form-item>
          </a-col>
          <a-col :span="8">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="贷款品种(补充)">
              <j-dict-select-tag placeholder="请输入贷款品种(补充)" v-decorator="['dkpzbc', {}]" dictCode="dkzlbc"/>
            </a-form-item>
          </a-col>
          <a-col :span="8">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="担保方式">
              <j-dict-select-tag placeholder="请输入担保方式" v-decorator="['dbfs', {}]" dictCode="gljydbfs" :disabled="this.disabled"/>
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <a-row class="form-row" :gutter="24">
          ...
          <a-col :span="8">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="是否用信">
              <j-dict-select-tag placeholder="请输入是否用信" v-decorator="['sfsx', {}]" dictCode="yxzt" :disabled="this.disabled"/>
            </a-form-item>
          </a-col>
          <a-col :span="8">
            <a-form-item
        ...
        <a-row class="form-row" :gutter="24">
          <a-col :span="8">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="是否上传档案">
              <j-dict-select-tag placeholder="请输入是否上传档案" v-decorator="['sfscda', {}]" dictCode="sfbs" :disabled="this.disabled"/>
            </a-form-item>
          </a-col>
        </a-row>
          </a-tab-pane>
              ...
              <a-row>
                <a-col :span="8">
                  <a-form-item
                    ...
                    :wrapperCol="wrapperCol"
                    label="资料类型">
                    <j-dict-select-tag placeholder="请选择资料类型" v-model="zllx" @input="zllxChange" dictCode="xfdkhtsjgl_fjlx" />
                  </a-form-item>
                </a-col>
                <a-col :span="8">
                  <a-form-item
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/xfdkhtsjgl/xfdkhtsjgl/add",
          edit: "/xfdkhtsjgl/xfdkhtsjgl/edit",
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'jgdm','zjhm','khmc','khlx','lxdh','lxdz','hth','ywbh','qyqx','qyje','dkje','dkye','sfsx','dkzrr','lrr','dkpz','dabh','sfscda','dkpzbc','dbfs'))
		  //时间格式化
