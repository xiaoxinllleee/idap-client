<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :md="6" :sm="8">
              <a-form-item label="是否上传档案">
                <a-select placeholder="全部 " v-model="queryParam.sfscda">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd"  icon="plus">新增</a-button>
     ...
     <!-- <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
      ...
      <a-button icon="area-chart" @click="transfer">移交</a-button>
...
<!--        </span>-->
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-divider type="vertical" />
           <a @click="handleView(record)" v-has="'dkhtsjglbc:view'">查看</a>
          <a-divider type="vertical" />
    ...
    <!-- 表单区域 -->
    <dkdahtsjglbc-modal ref="modalForm" @ok="modalFormOk"></dkdahtsjglbc-modal>
    <dkdahtsjglbcyj-modal ref="dkdahtsjglbcyjModal" @close="transferClose"></dkdahtsjglbcyj-modal>
    <excel-import ref="excelImportModal" @ok="importComplete" />
    <dkdahtsjglbc-scrwm-modal ref="dkdahtsjglbcScrwmModal" />
  </a-card>
</template>

<script>
  import DkdahtsjglbcModal from './modules/DkdahtsjglbcModal'
  import DkdahtsjglbcyjModal from '@views/xddagl/dkdagl/dkdahtsjglbc/modules/DkdahtsjglbcyjModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import JTreeSelect from '@/components/jeecg/JTreeSelect'
  import JEllipsis from '@/components/jeecg/JEllipsis'
  import ExcelImport from '@/components/common/ExcelImport'
  import DkdahtsjglbcScrwmModal from '@views/xddagl/dkdagl/dkdahtsjglbc/modules/DkdahtsjglbcScrwmModal'
  import { putAction } from '@api/manage'
  export default {
    name: "DkdahtsjglbcList",
    mixins:[JeecgListMixin],
    components: {
      DkdahtsjglbcModal,JTreeSelect,JEllipsis,ExcelImport,DkdahtsjglbcScrwmModal,DkdahtsjglbcyjModal
    },
    data () {
      return {
		...
		url: {
          list: "/dkdahtsjglbc/dkdahtsjglbc/list",
          delete: "/dkdahtsjglbc/dkdahtsjglbc/delete",
          deleteBatch: "/dkdahtsjglbc/dkdahtsjglbc/deleteBatch",
          exportXlsUrl: "dkdahtsjglbc/dkdahtsjglbc/exportXls",
          importExcelUrl: "dkdahtsjglbc/dkdahtsjglbc/importExcel",
          exportTemplateUrl: "/dkdahtsjglbc/dkdahtsjglbc/exportTemplateXls",
          scewmpd:"/dkdahtsjglbc/dkdahtsjglbc/scewmpd"
       },
  ...
  computed: {
    ...
    methods: {
      transfer(){
        ...
        this.$refs.dkdahtsjglbcyjModal.transferinit(this.queryParam.dkzrr)
      },
      transferClose() {
        console.log('账号转移已关闭！')
      },
      scewm(record){
        if(record.dabh!=null && record.dabh!=undefined){
          this.$refs.dkdahtsjglbcScrwmModal.init(record)
        }else {
          this.$message.warning("请先上传档案编号！")
        }
      },
      ...
      handleView: function(record) {
        console.log('Dkdahtsjglbc => handleView: function (record)')
        this.$refs.modalForm.edit(record);
