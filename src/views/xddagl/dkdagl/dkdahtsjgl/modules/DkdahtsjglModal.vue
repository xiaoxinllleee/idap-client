            ...
            <a-row class="form-row" :gutter="24">
              <a-col :lg="8">
                <a-form-item
                  ...
                  :wrapperCol="wrapperCol"
                  label="客户类型">
                  <j-dict-select-tag placeholder="请输入客户类型" v-decorator="['khlx', {}]" dictCode="xdda_khlx"
                                     :disabled="true"/>
                </a-form-item>
              </a-col>
              <a-col :lg="8">
            ...
            <a-row class="form-row" :gutter="24">
              <a-col :lg="8">
                <a-form-item
                  ...
                  :wrapperCol="wrapperCol"
                  label="签约日期">
                  <a-date-picker v-decorator="[ 'qyrq', {}]" style="width: 100%" :disabled="true"/>
                </a-form-item>
              </a-col>
              <a-col :lg="8">
                <a-form-item
              ...
              <a-col :lg="8">
                <a-form-item
                  ...
                  :wrapperCol="wrapperCol"
                  label="业务编号">
                  <a-input placeholder="请输入业务编号" v-decorator="['ywbh', {}]" :disabled="true"/>
                </a-form-item>
              </a-col>
            </a-row>
            <a-row class="form-row" :gutter="24">
              <a-col :lg="8">
                <a-form-item
                  ...
                  :wrapperCol="wrapperCol"
                  label="放款日期">
                  <a-date-picker v-decorator="[ 'fkrq', {}]" style="width: 100%" :disabled="true"/>
                </a-form-item>
              </a-col>
              <a-col :lg="8">
                <a-form-item
              ...
              <a-col :lg="8">
                <a-form-item
                  ...
                  :wrapperCol="wrapperCol"
                  label="签约期限">
                  <a-input placeholder="请输入签约期限" v-decorator="['qyqx', {}]" :disabled="true"/>
                </a-form-item>
              </a-col>
            </a-row>
            <a-row class="form-row" :gutter="24">
              <a-col :lg="8">
                <a-form-item
                  ...
                  :wrapperCol="wrapperCol"
                  label="签约金额">
                  <a-input placeholder="请输入签约金额" v-decorator="['qyje', {}]" :disabled="true"/>
                </a-form-item>
              </a-col>
              <a-col :lg="8">
                <a-form-item
                  ...
                  :wrapperCol="wrapperCol"
                  label="数据日期">
                  <a-date-picker v-decorator="[ 'sjrq', {}]" style="width: 100%" :disabled="true"/>
                </a-form-item>
              </a-col>
              <a-col :lg="8">
                <a-form-item
            ...
            <a-row class="form-row" :gutter="24">
              ...
              <a-col :lg="8">
                <a-form-item
                  ...
                  :wrapperCol="wrapperCol"
                  label="最早贷款日期">
                  <a-date-picker v-decorator="[ 'zzdkrq', {}]" style="width: 100%" :disabled="true"/>
                </a-form-item>
              </a-col>
              <a-col :lg="8">
                <a-form-item
                  ...
                  :wrapperCol="wrapperCol"
                  label="最早到期日期">
                  <a-date-picker v-decorator="[ 'zzdqrq', {}]" style="width: 100%" :disabled="true"/>
                </a-form-item>
              </a-col>
            </a-row>
            <a-row class="form-row" :gutter="24">
              ...
              <a-col :lg="8">
                <a-form-item
                  ...
                  :wrapperCol="wrapperCol"
                  label="担保方式">
                  <j-dict-select-tag placeholder="请选择担保方式" v-decorator="['dbfs', {}]" dictCode="dbfs" :disabled="true"/>
                </a-form-item>
              </a-col>
            </a-row>
            <a-row class="form-row" :gutter="24">
              ...
              <a-col :lg="8">
                <a-form-item
                  ...
                  :wrapperCol="wrapperCol"
                  label="是否用信">
                  <j-dict-select-tag placeholder="请输入是否用信" v-decorator="['sfsx', {}]" dictCode="yxzt" :disabled="true"/>
                </a-form-item>
              </a-col>
              <a-col :lg="8">
                <a-form-item
                  ...
                  :wrapperCol="wrapperCol"
                  label="档案编号">
                  <a-input placeholder="请输入档案编号" v-decorator="['dabh', {}]" :disabled="true"/>
                </a-form-item>
              </a-col>
            </a-row>
            <a-row class="form-row" :gutter="24">
              <a-col :lg="8">
                <a-form-item
                  ...
                  :wrapperCol="wrapperCol"
                  label="是否上传档案">
                  <a-input placeholder="请输入是否上传档案" v-decorator="['sfscda', {}]" :disabled="true"/>
                </a-form-item>
              </a-col>
            </a-row>
          </a-tab-pane>
                ...
                <a-col :span="12">
                  <a-form-item
                    ...
                    <j-dict-select-tag placeholder="请选择资料类型" v-model="zllx" @input="zllxChange"
                                       dictCode="xfdkhtsjgl_fjlx" style="width: 70%"/>
                  </a-form-item>
                </a-col>
                <a-col :span="12">
                  <a-form-item
...
<script>
  ...
  export default {
    name: "DkdahtsjglModal",
    components: {
      JTreeSelect, JiamiModal, TiquModal
    },
    data() {
      return {
        hth: '',
        ...
        url: {
          add: "/dkdahtsjgl/dkdahtsjgl/add",
          edit: "/dkdahtsjgl/dkdahtsjgl/edit",
    ...
    methods: {
      ...
      edit(record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model, 'dkpzbc', 'dbfs', 'sfscda', 'dabh', 'jgdm', 'zjhm', 'khmc', 'khlx', 'lxdh', 'lxdz',
            'hth', 'ywbh', 'qyqx', 'qyje', 'dkje', 'dkye', 'sfsx', 'dkzrr', 'dkpz'))
          //时间格式化
