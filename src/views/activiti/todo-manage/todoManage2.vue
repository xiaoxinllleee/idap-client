...
<template>
  <div class="search">
    ...
    <yjgs-ckkhdfpxxb-modal  ref="YjgsCkkhdfpxxbModal" />
    <yjgs-ckzhdfpxx-modal ref="YjgsCkzhdfpxxModal"/>

    <component :is="hrefComponent" :modalCreated="componentCreate" :modalParam="modalParam" @modalClose="modalClose" ref="detailModal"/>
...
import YjgsCkkhdfpxxbModal from '@views/yjgs/ckkhdfpxx/modules/YjgsCkkhdfpxxbModal'
import YjgsCkzhdfpxxModal from  '@views/yjgs/ckzhdfpxx/modules/YjgsCkzhdfpxxModal'
...
export default {
  name: "todo-manage",
  components: {
    historicDetail,GrkhpjsxModal,GrdkglModal,YjgsCkzhdfpxxModal,YjgsCkkhdfpxxbModal,
    etcyxxxProcess: ()=> import('@views/ywgl/etcyxgl/etcyxxxgl/modules/EtcyxxxglTransferDetail'),
    loanApproval: ()=> import('@views/xdgl/dksp/dkspkhzc/modules/DkspKhzcModal'),
    creditApproval: ()=> import('@views/xdgl/dksp/dkspsxsp/modules/DkspSxspModal'),
  },
  data() {
    return {
      pjsxpddj: [
...
/*        {
  ...
  methods: {
    ...
    detail(v) {
      ...
      }else if(v.procDefId.split(":")[0]=='ckkhdfpxx'){
        console.log('ckkhdfpxx=======================')
        let params = Object.assign({})
        params.id =v.tableId;
        console.log("id"+v.tableId)
        this.$refs.YjgsCkkhdfpxxbModal.edit(v);
        this.$refs.YjgsCkkhdfpxxbModal.title = "详情";
        this.$refs.YjgsCkkhdfpxxbModal.disableSubmit = true;
    ...
    passTask(v) {
      ...
      /*}else if (v.procDefId.split(":")[0]=='ckkhdfpxx'  || v.procDefId.split(":")[0]=='ckzhdfpxx' ){
        this.form.key =
        this.form.sfty = 2;
        this.modalTaskVisible = true;*/
      }else{
