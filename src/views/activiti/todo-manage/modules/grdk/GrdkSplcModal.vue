      ...
      <a-form  :form="form">
        <a-tabs  v-model="activeTab">
          ...
          <a-tab-pane tab="评定信息" key="10" :forceRender="true" ref="pdxxgzxy">
              ...
              <a-card title="评定及意见" style="height: 600px" :bordered="true">
                ...
                <a-row justify="start" align="middle">
                  <a-col :xs="{ span: 5, offset: 1 }" :lg="{ span: 6, offset: 2 }">
                    <a-form-item  label="">
                      <font bold color="red"> <strong>评定等级：</strong></font>
                      <Select v-model="spform.pddj" style="width: 30%" >
                        <Option v-for="(item, i) in grdkpddj" :key="i" :value="item.key">{{item.name}}</Option>
                      </Select>
                    </a-form-item>
                  </a-col>
                  <a-col :xs="{ span: 11, offset: 1 }" :lg="{ span: 6, offset: 2 }">
                    <a-form-item >
                      <font bold color="red"><strong>审批额度：</strong></font>
                      <a-input-number  v-model="spform.jysxed"  size="small"  style="border:hidden;width: 100px;border-bottom: 1px solid #ddd;"  /> 万元
                    </a-form-item>
                  </a-col>
                </a-row>
                <a-row type="flex" justify="start" align="middle">
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            if(this.spform.jysxed==null){
              this.$message.warning('请填写审批额度');
              return;
            }
            if(this.spform.pddj==null){
              this.$message.warning('请填写评定等级');
              return;
            }
            if(this.spform.comment==null||this.spform.comment==""){
            ...
            if(this.spform.jysxed>this.model.sxje){
