<template>
  <div class="clearfix">
    ...
    <div>
      <a-divider orientation="left" style="color: #1890FF;">身份信息--配偶身份证正反面</a-divider>
      <a-upload
        :disabled ="showupload"
        :action="uploadAction"
        list-type="picture-card"
    ...
    <div>
      <a-divider orientation="left" style="color: #1890FF;">身份信息--结婚证户口本</a-divider>
      <a-upload
        :disabled ="showupload"
        :action="uploadAction"
        list-type="picture-card"
    ...
    <div>
      <a-divider orientation="left" style="color: #1890FF;">身份信息--人像照片</a-divider>
      <a-upload
        :disabled ="showupload"
        :action="uploadAction"
        list-type="picture-card"
    ...
    <div>
      <a-divider orientation="left" style="color: #1890FF;">资产信息--房屋拍照</a-divider>
      <a-upload
        :disabled ="showupload"
        :action="uploadAction"
        list-type="picture-card"
    ...
    <div>
      <a-divider orientation="left" style="color: #1890FF;">资产信息--权证拍照</a-divider>
      <a-upload
        :disabled ="showupload"
        :action="uploadAction"
        list-type="picture-card"
    ...
    <div>
      <a-divider orientation="left" style="color: #1890FF;">资产信息--汽车</a-divider>
      <a-upload
        :disabled ="showupload"
        :action="uploadAction"
        list-type="picture-card"
    ...
    <div>
      <a-divider orientation="left" style="color: #1890FF;">资产信息--其他资产</a-divider>
      <a-upload
        :disabled ="showupload"
        :action="uploadAction"
        list-type="picture-card"
    ...
    <div>
      <a-divider orientation="left" style="color: #1890FF;">经营项目--经营场所、场地(果园、鱼塘等)</a-divider>
      <a-upload
        :disabled ="showupload"
        :action="uploadAction"
        list-type="picture-card"
  ...
  export default {
    ...
    methods: {
      ...
      showImg(value){
        ...
        /*this.brsfzfileList = this.initFileList(value.brsfzArray);
        this.posfzfileList =this.initFileList(value.posfzArray);
        this.jhzfileList  =this.initFileList(value.jhzArray);
        this.rxzpfileList =this.initFileList(value.rxzpArray);
        this.fwpzfileList =this.initFileList(value.fwpzArray);
        this.qzpzfileList =this.initFileList(value.qzpzArray);
        this.qczpfileList =this.initFileList(value.qczpArray);
        this.qtzcfileList =this.initFileList(value.qtzcArray);
        this.jycsfileList =this.initFileList(value.jycsArray);
        this.cjzpzfileList =this.initFileList(value.cjzpzArray);*/
