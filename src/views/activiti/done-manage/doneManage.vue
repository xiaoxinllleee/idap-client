...
<template>
  <div class="search">
    ...
    <dkspSxsp-modal   ref="dkspSxspModalForm" />
    ...
    <Card v-show="!showHistory">
      ...
      <Row class="operation">
        <Button @click="handleExportXls('我的已办')" icon="md-download" :loading="exportLoading">导出</Button>
...
import GrdkglModal from '@views/xdgl/grdkgl/modules/GrdkSpJgModal'
import DkspKhzcModal from '@views/xdgl/dksp/xdspydagl/modules/XdspydaglModal'
import DkspSxspModal from '@views/xdgl/dksp/xdspydagl/modules/XdspydaglModal'
import store from '@/store/'

export default {
  name: "done-manage",
  components: {
    historicDetail,GrkhpjsxModal,GrdkglModal,DkspKhzcModal,DkspSxspModal,
  ...
  methods: {
    ...
    handleExportXls(fileName){
      ...
      downFile('/actTask/exportDoneList',this.searchForm).then((data)=>{
        if (!data) {
