              ...
              <a-row class="form-row" :gutter="16">
                ...
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="企业名称">
                    <a-input placeholder="请输入企业名称" v-model="dqUser.qymc" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                ...
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="企业注册等级类型">
                    <a-input placeholder="请输入企业注册等级类型" v-model="dqUser.qyzcdjlx_dictText" />
                  </a-form-item>
                </a-col>

                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="企业类型">
                    <a-input placeholder="请输入企业类型" v-model="dqUser.qylx_dictText" />
                  </a-form-item>
                </a-col>

                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="注册时间">
                    <a-input placeholder="请输入注册时间" v-model="dqUser.zcsj" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="注册到期日">
                    <a-input placeholder="请输入注册到期日" v-model="dqUser.zcdqr" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                ...
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="实收资本">
                    <a-input placeholder="请输入实收资本" v-model="dqUser.sszb" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                ...
                <a-col :span="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="基本账户是否在我行">
                    <j-dict-radio-tag v-model="dqUser.jbzhsfzwh" dictCode="sfbz"></j-dict-radio-tag>
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="企业联系电话">
                    <a-input placeholder="请输入企业联系电话" v-model="dqUser.qylxdh" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                ...
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="法人联系电话">
                    <a-input placeholder="请输入法人联系电话" v-model="dqUser.frlxdh" />
                  </a-form-item>
                </a-col>
                <a-col :span="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="是否存续">
                    <j-dict-radio-tag v-model="dqUser.sfcx" dictCode="sfbz"></j-dict-radio-tag>
                  </a-form-item>
                </a-col>

                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="经验场地所有权">
                    <a-input placeholder="请输入经验场地所有权" v-model="dqUser.jycdsyq" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="经营场地面积">
                    <a-input placeholder="请输入经营场地面积" v-model="dqUser.jycdmj" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="主营业务/产品">
                    <a-input placeholder="请输入主营业务/产品" v-model="dqUser.zyywcp" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="企业人数">
                    <a-input placeholder="请输入企业人数" v-model="dqUser.qyrs" />
                  </a-form-item>
                </a-col>

                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="企业资产">
                    <a-input placeholder="请输入企业资产" v-model="dqUser.qyzc" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="企业负债">
                    <a-input placeholder="请输入企业负债" v-model="dqUser.qyfz" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="企业经营收入">
                    <a-input placeholder="请输入企业经营收入" v-model="dqUser.qyjysr" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="企业经营利润">
                    <a-input placeholder="请输入企业经营利润" v-model="dqUser.qyjylr" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="营业期限">
                    <a-input placeholder="请输入营业期限" v-model="dqUser.yyqx" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="登记机关">
                    <a-input placeholder="请输入登记机关" v-model="dqUser.djjg" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="邮政编码">
                    <a-input placeholder="请输入邮政编码" v-model="dqUser.yzbm" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="注册号">
                    <a-input placeholder="请输入注册号" v-model="dqUser.zch" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="核准日期">
                    <a-input placeholder="请输入核准日期" v-model="dqUser.hzrq" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="登记类别">
                    <a-input placeholder="请输入登记类别" v-model="dqUser.djlb" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="监管单位">
                    <a-input placeholder="请输入监管单位" v-model="dqUser.jgdw" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="行业代码">
                    <a-input placeholder="请输入行业代码" v-model="dqUser.hydm" />
                  </a-form-item>
                </a-col>
                <a-col :lg="8">
                  ...
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="客户潜在业务">
                    <a-checkbox-group :value="khqzywList" style="width: 100%;margin-top: 10px;">
                      <a-row>
                        ...
                        <a-col :span="3">
                          <a-checkbox value="5">ETC</a-checkbox>
                        </a-col>
                        <a-col :span="3">
                ...
                <a-col :lg="12">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="注册地址">
                    <a-input placeholder="请输入注册地址" v-model="dqUser.zcdz" />
                  </a-form-item>
                </a-col>
                <a-col :lg="12">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="企业现地址">
                    <a-input placeholder="请输入企业现地址" v-model="dqUser.qyxdz" />
                  </a-form-item>
                </a-col>
...
export default {
  ...
  methods: {
    ...
    querygxrxx (val) {
      getAction('/qyxx/qyxxgl/querygxrxx', { id: val }).then(res => {
        if (res.success) {
    ...
    queryDgywxx (val) {
      getAction('/qyxx/qyxxgl/queryDgywxx', { id: val }).then(res => {
        if (res.success) {
    ...
    queryPjsxxxByQyid (val) {
      getAction('/qyxx/qyxxgl/queryPjsxxxByQyid', { qyid: val }).then(res => {
    ...
    queryFcxxByQyid (val) {
      getAction('/qyxx/qyxxgl/queryFcxxByQyid', { qyid: val }).then(res => {
        if (res.success) {
    ...
    queryFjxxByQyid (val) {
      getAction('/qyxx/qyxxgl/queryFjxxByQyid', { qyid: val }).then(res => {
        if (res.success) {
    ...
    edit (record) {
      ...
      this.queryPjsxxxByQyid(record.id)
      this.queryFcxxByQyid(record.id)
      this.queryFjxxByQyid(record.id)
      this.visible = true
    },
    close () {
      this.$emit('close')
