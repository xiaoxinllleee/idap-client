      ...
      <Row type="flex" style="height: 400px" >
        ...
        <Col :md="8" :lg="8" :xl="18" style="margin-left:10px;">
          <a-card :bordered="false">
            ...
            <div v-show="rwlx==3" class="table-page-search-wrapper">
              <a-form layout="inline" @keyup.enter.native="searchQuery">
                <a-row :gutter="24">
                  <a-col :xl="6" :lg="7" :md="8" :sm="24">
                    <a-form-item label="归属网格">
  ...
  data () {
    return {
      ...
      url: {
        ...
        listZrww:"/rwmxsj/taskRwmxZzrw/list",
  ...
  methods: {
    ...
    edit (record) {
      ...
      if(record.rwlx==1){
        ...
        this.queryParam.rwid=record.id;
        this.rwlx=3;
        this.url.list=this.url.listZrww;
