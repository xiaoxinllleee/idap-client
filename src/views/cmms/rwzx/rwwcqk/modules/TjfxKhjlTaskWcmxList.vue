        ...
        <a-row :gutter='24'>
          ...
          <a-col :xl='6' :lg='7' :md='8' :sm='24'>
            <a-form-item label='员工姓名'>
              <a-input v-model='queryParam.ygxm' placeholder='请输入员工姓名（支持模糊查询）' />
            </a-form-item>
          </a-col>
          <a-col :xl='6' :lg='7' :md='8' :sm='24'>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/tjfx/taskWcmx/list',
        exportXlsUrl: '/tjfx/taskWcmx/exportXls',
        initData: '/tjfx/taskWcmx/initData'
      },
      maxDate: ''
    }
  },
  ...
  methods: {
    getMaxDate() {
      getAction('/tjfx/taskWcmx/getMaxDate', null).then(res => {
        if (res.success) {
