        ...
        <a-row :gutter='24'>
          ...
          <a-col :xl='6' :lg='7' :md='8' :sm='24'>
            <a-form-item label='任务名称'>
              <a-input v-model='queryParam.ygxm' placeholder='请输入任务名称（支持模糊查询）' />
            </a-form-item>
          </a-col>
          <a-col :xl='6' :lg='7' :md='8' :sm='24'>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/rwwcmxzh/tjfxTaskWcmxZhLs/list',
        exportXlsUrl: '/rwwcmxzh/tjfxTaskWcmxZhLs/exportXls',
      },
      maxDate: ''
    }
  },
  ...
  methods: {
    getMaxDate() {
      getAction('/rwwcmxzh/tjfxTaskWcmxZhLs/getMaxDate', null).then(res => {
        if (res.success) {
