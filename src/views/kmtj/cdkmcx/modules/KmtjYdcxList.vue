<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('月度查询')">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/ydcx/kmtjYdcx/list",
          delete: "/ydcx/kmtjYdcx/delete",
          deleteBatch: "/ydcx/kmtjYdcx/deleteBatch",
          exportXlsUrl: "ydcx/kmtjYdcx/exportXls",
          importExcelUrl: "ydcx/kmtjYdcx/importExcel",
          init: "/ydcx/kmtjYdcx/init",
       },
    }
  },
  computed: {
