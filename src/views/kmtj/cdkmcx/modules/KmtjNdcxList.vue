<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('年度查询')">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/ndcx/kmtjNdcx/list",
          delete: "/ndcx/kmtjNdcx/delete",
          deleteBatch: "/ndcx/kmtjNdcx/deleteBatch",
          exportXlsUrl: "ndcx/kmtjNdcx/exportXls",
          importExcelUrl: "ndcx/kmtjNdcx/importExcel",
          init: "/ndcx/kmtjNdcx/init",
       },
    }
  },
  computed: {
