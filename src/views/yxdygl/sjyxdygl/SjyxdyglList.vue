<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="所属一级营销单元">
              <j-dict-select-tag placeholder="请选择所属一级营销单元" v-model="this.yjyxdybh" dict-code="YXDYGL_YJYXDYGL,DYMC,DYBH"
                                 @change="handleChangeByYjdy"
                                 :trigger-change="true" :show-search="true"></j-dict-select-tag>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="所属二级营销单元">
              <j-dict-select-tag placeholder="请选择所属二级营销单元" v-model="this.ejyxdybh" @change="handleChangeByEjdy"
                                 :dict-code="dictCode" :trigger-change="true" :show-search="true"></j-dict-select-tag>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="单元名称">
                <j-input placeholder="请输入单元名称" v-model="queryParam.dymc" type="liekmore"></j-input>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" :loading="exportLoading" icon="download" @click="handleExportXls('三级营销单元管理')">导出
      </a-button>
    ...
    <div>
      ...
      <a-table ref="table"
        ...
        <span slot="ejyxdymc" slot-scope="text, record">
          <j-ellipsis :value="text" :length="8" />
        </span>
    ...
    <!-- 表单区域 -->
    <sjyxdygl-modal ref="modalForm" @ok="modalFormOk"></sjyxdygl-modal>
    <excel-import ref="excelImportModal" @ok="importComplete"></excel-import>
  </a-card>
</template>

<script>
  import SjyxdyglModal from './modules/SjyxdyglModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: '/yxdygl/sjyxdygl/list',
          delete: '/yxdygl/sjyxdygl/delete',
          deleteBatch: '/yxdygl/sjyxdygl/deleteBatch',
          exportXlsUrl: 'yxdygl/sjyxdygl/exportXls',
          importExcelUrl: 'yxdygl/sjyxdygl/importExcel',
          tmplateExportUrl: '/yxdygl/sjyxdygl/exportTemplateXls'
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      handleAdd: function () {
        ...
        this.$refs.modalForm.disabled_ejyxdy = true
      ...
      handleImport: function () {
        ...
        params.exportTemplateName = '三级营销单元导入模板'
