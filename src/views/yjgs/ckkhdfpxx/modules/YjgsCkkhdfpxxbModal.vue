        ...
        <a-row class="form-row" :gutter="24">
          <a-col :span="12" :gutter="12">
            <a-form-item
              ...
              label="认领人工号">
              <a-input placeholder="认领人工号" v-model="this.model.ghr" />
            </a-form-item>
          </a-col>
          <a-col :span="12" :gutter="12">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="认领人姓名">
              <a-input placeholder="认领人姓名" v-model="this.model.ghr_dictText" />
            </a-form-item>
          </a-col>
        </a-row>
        <a-row class="form-row" :gutter="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/performance/ckkhspxx/list",
        },
        // 表头
        columns: [
          {
    ...
    methods: {
      ...
      edit () {
        ...
        getAction('/performance/ckkhspxx/list', params).then((res) => {
          if (res.success) {
