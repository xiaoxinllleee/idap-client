    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="wjid">
          <a-input placeholder="请输入wjid" v-decorator="['wjid', validatorRules.wjid ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="khlx">
          <a-input placeholder="请输入khlx" v-decorator="['khlx', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="lxdh">
          <a-input placeholder="请输入lxdh" v-decorator="['lxdh', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="lxdz">
          <a-input placeholder="请输入lxdz" v-decorator="['lxdz', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'wjid','hth','dkzl','fjlx','wjlj','fwlj','wjdx','lrbz','lrr','fjlx1','fwlj1','wjlj1','jgdm','zjhm','khmc','khlx','ywbh','lxdh','lxdz','dkpz','dkzrr'))
		  //时间格式化
