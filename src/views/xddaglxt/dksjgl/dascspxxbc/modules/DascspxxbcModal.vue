    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="贷款责任人">
          <a-input placeholder="请输入贷款责任人" v-decorator="['dkzrr_dictText', {}]" :disabled="true"/>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/dascspxxbc/dascspxxbc/add",
          edit: "/dascspxxbc/dascspxxbc/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'jgdm','khmc','zjhm','hth','htje','dkzrr_dictText',))
		  //时间格式化
