        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="科目号">
              <j-input placeholder="请输入科目号" v-model="queryParam.kmh"></j-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="币种">
              <j-input placeholder="请输入币种" v-model="queryParam.bz"></j-input>
            </a-form-item>
          </a-col>
...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('湖南省农村信用社损益表')">导出</a-button>
      <a-button type="primary" icon="import" @click="excelImport" v-has="'syb:import'">导入</a-button>
...
<!--      </div>-->
      ...
      <a-table bordered
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'syb:edit'">编辑</a>
          <a-divider type="vertical" v-has="'syb:edit'"/>
          <a-dropdown v-has="'syb:delete'">
    ...
    <!-- 表单区域 -->
    <syb-modal ref="modalForm" @ok="modalFormOk"></syb-modal>
    <excel-import ref="excelImportModal" @ok="importComplete"/>
  </a-card>
</template>

<script>
  import SybModal from './modules/SybModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tjbb/tjfz/sgtzdr/syb/list",
          delete: "/tjbb/tjfz/sgtzdr/syb/delete",
          deleteBatch: "/tjbb/tjfz/sgtzdr/syb/deleteBatch",
          exportXlsUrl: "tjbb/tjfz/sgtzdr/syb/exportXls",
          importExcelUrl: "tjbb/tjfz/sgtzdr/syb/importExcel",
          exportTemplateUrl: "tjbb/tjfz/sgtzdr/syb/exportTemplateXls",
        },
        exportTemplateName: '湖南省农村信用社损益表导入模板',
      }
    },
    created() {
      this.getCurrentDate()
