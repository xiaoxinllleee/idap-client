<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="数据日期">
              <a-date-picker placeholder="请选择数据日期" v-model="queryParam.dataDate" @change="dateChange()" style="width: 100%;" :disabled-date="disabledDate" :format="dateFormat"></a-date-picker>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('到期收回率')">导出</a-button>
      <a-button type="primary" icon="import" @click="excelImport" v-has="'dqshl:import'">导入</a-button>
    ...
    <div>
      ...
      <a-table bordered
        ...
        <span slot="action" slot-scope="text, record">
            <a @click="handleEdit(record)" v-has="'dqshl:edit'">编辑</a>
          <a-divider type="vertical" v-has="'dqshl:edit'"/>
          <a-dropdown v-has="'dqshl:delete'">
    ...
    <!-- 表单区域 -->
    <dqshl-modal ref="modalForm" @ok="modalFormOk"></dqshl-modal>
    <excel-import ref="excelImportModal" @ok="importComplete"/>
  </a-card>
</template>

<script>
  import DqshlModal from './modules/DqshlModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tjbb/tjfz/sgtzdr/dqshl/list",
          delete: "/tjbb/tjfz/sgtzdr/dqshl/delete",
          deleteBatch: "/tjbb/tjfz/sgtzdr/dqshl/deleteBatch",
          exportXlsUrl: "tjbb/tjfz/sgtzdr/dqshl/exportXls",
          importExcelUrl: "tjbb/tjfz/sgtzdr/dqshl/importExcel",
          exportTemplateUrl: "tjbb/tjfz/sgtzdr/dqshl/exportTemplateXls",
        },
        exportTemplateName: '到期收回率导入模板',
      }
    },
    created() {
      this.getCurrentDate()
