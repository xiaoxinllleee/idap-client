...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('各项贷款本期借方发生额')">导出</a-button>
      <a-button type="primary" icon="import" @click="excelImport" v-has="'gxdkbqjffse:import'">导入</a-button>
...
<!--      </div>-->
      ...
      <a-table bordered
        ...
        <span slot="action" slot-scope="text, record">
          <!--<a @click="handleEdit(record)" v-has="'gxdkbqjffse:edit'">编辑</a>
          <a-divider type="vertical" v-has="'gxdkbqjffse:edit'"/>-->
          <a-dropdown v-has="'gxdkbqjffse:delete'">
    ...
    <!-- 表单区域 -->
    <gxdkBqJffse-modal ref="modalForm" @ok="modalFormOk"></gxdkBqJffse-modal>
    <excel-import ref="excelImportModal" @ok="importComplete"/>
  </a-card>
</template>

<script>
  import GxdkBqJffseModal from './modules/GxdkBqJffseModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tjbb/tjfz/sgtzdr/gxdkBqJffse/list",
          delete: "/tjbb/tjfz/sgtzdr/gxdkBqJffse/delete",
          deleteBatch: "/tjbb/tjfz/sgtzdr/gxdkBqJffse/deleteBatch",
          exportXlsUrl: "tjbb/tjfz/sgtzdr/gxdkBqJffse/exportXls",
          importExcelUrl: "tjbb/tjfz/sgtzdr/gxdkBqJffse/importExcel",
          exportTemplateUrl: "tjbb/tjfz/sgtzdr/gxdkBqJffse/exportTemplateXls",
        },
        exportTemplateName: '各项贷款本期借方发生额导入模板',
      }
    },
    created() {
      //this.getCurrentDate()
