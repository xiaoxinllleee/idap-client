    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="本期：1132应收贷款利息">
          <a-input placeholder="请输入本期：1132应收贷款利息" v-decorator="['bqYsdklx', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="上期：1132应收贷款利息">
          <a-input placeholder="请输入上期：1132应收贷款利息" v-decorator="['sqYsdklx', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="本期：6011利息收入">
          <a-input placeholder="请输入本期：6011利息收入" v-decorator="['bqLxsr', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="上期：6011利息收入">
          <a-input placeholder="请输入上期：6011利息收入" v-decorator="['sqLxsr', {}]" />
        </a-form-item>
        <!--<a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjbb/tjfz/sgtzdr/dklxsr/add",
          edit: "/tjbb/tjfz/sgtzdr/dklxsr/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'jgbm','bqYsdklx','sqYsdklx','bqLxsr','sqLxsr'))
		      //时间格式化
