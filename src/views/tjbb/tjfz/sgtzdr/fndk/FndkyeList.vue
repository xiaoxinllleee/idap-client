...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('非农贷款余额')">导出</a-button>
      <a-button type="primary" icon="import" @click="excelImport" v-has="'fndkye:import'">导入</a-button>
...
<!--      </div>-->
      ...
      <a-table bordered
        ...
        <span slot="action" slot-scope="text, record">
          <!--<a @click="handleEdit(record)" v-has="'fndkye:edit'">编辑</a>-->
          <!--<a-divider type="vertical" v-has="'fndkye:edit'"/>-->
          <a-dropdown v-has="'fndkye:delete'">
    ...
    <!-- 表单区域 -->
    <!--<fndkye-modal ref="modalForm" @ok="modalFormOk"></fndkye-modal>-->
    <excel-import ref="excelImportModal" @ok="importComplete"/>
  </a-card>
</template>

<script>
  import FndkyeModal from './modules/FndkyeModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tjbb/tjfz/sgtzdr/fndkye/list",
          delete: "/tjbb/tjfz/sgtzdr/fndkye/delete",
          deleteBatch: "/tjbb/tjfz/sgtzdr/fndkye/deleteBatch",
          exportXlsUrl: "tjbb/tjfz/sgtzdr/fndkye/exportXls",
          importExcelUrl: "tjbb/tjfz/sgtzdr/fndkye/importExcel",
          exportTemplateUrl: "tjbb/tjfz/sgtzdr/fndkye/exportTemplateXls",
        },
        exportTemplateName: '非农贷款余额导入模板',
      }
    },
    created() {
      this.getCurrentYear()
