    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="本期：非农贷款期末余额">
          <a-input placeholder="请输入本期：非农贷款期末余额" v-decorator="['bqFndkQmye', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="上期：非农贷款期末余额">
          <a-input placeholder="请输入上期：非农贷款期末余额" v-decorator="['sqFndkQmye', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="上上期：非农贷款期末余额">
          <a-input placeholder="请输入上上期：非农贷款期末余额" v-decorator="['ssqFndkQmye', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="本期：各项贷款余额">
          <a-input placeholder="请输入本期：各项贷款余额" v-decorator="['bqGxdkye', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="上期：各项贷款余额">
          <a-input placeholder="请输入上期：各项贷款余额" v-decorator="['sqGxdkye', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="上上期：各项贷款余额">
          <a-input placeholder="请输入上上期：各项贷款余额" v-decorator="['ssqGxdkye', {}]" />
        </a-form-item>
<!--        <a-form-item-->
<!--          :labelCol="labelCol"-->
<!--          :wrapperCol="wrapperCol"-->
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjbb/tjfz/sgtzdr/fndkye/add",
          edit: "/tjbb/tjfz/sgtzdr/fndkye/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'jgbm','bqFndkQmye','sqFndkQmye','ssqFndkQmye','bqGxdkye','sqGxdkye','ssqGxdkye'))
		      //时间格式化
