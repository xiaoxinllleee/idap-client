<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('定期汇总日平查询')" v-has="'dqhzrpcx:exportXls'">导出</a-button>
      <a-button @click="init" icon="area-chart" v-has="'dqhzrpcx:init'">提取</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="dz" slot-scope="text"><j-ellipsis :value="text" :length="8"></j-ellipsis></span>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/dqhzrpcx/dqhzrpcx/list",
          delete: "/dqhzrpcx/dqhzrpcx/delete",
          deleteBatch: "/dqhzrpcx/dqhzrpcx/deleteBatch",
          exportXlsUrl: "dqhzrpcx/dqhzrpcx/exportXls",
          importExcelUrl: "dqhzrpcx/dqhzrpcx/importExcel",
          init: "/dqhzrpcx/dqhzrpcx/init",
        },
      }
    },
    computed: {
