<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="外汇账户">
              <a-input placeholder="请输入外汇账户" v-model="queryParam.whzh"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('外汇账户存款信息')" v-has="'whzhckxx:exportXls'">导出</a-button>
      <a-button @click="init" icon="area-chart" v-has="'whzhckxx:init'">提取</a-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/whzhckxx/whzhckxx/list",
          delete: "/whzhckxx/whzhckxx/delete",
          deleteBatch: "/whzhckxx/whzhckxx/deleteBatch",
          exportXlsUrl: "whzhckxx/whzhckxx/exportXls",
          importExcelUrl: "whzhckxx/whzhckxx/importExcel",
          init: "/whzhckxx/whzhckxx/init",
        },
      }
    },
    computed: {
