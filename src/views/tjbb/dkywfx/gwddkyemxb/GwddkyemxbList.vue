<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="数据截止日期">
              <a-date-picker placeholder="请选择数据截止日期" v-model="queryParam.dataDate" :disabled-date="disabledDate" :format="dateFormat" style="width: 100%;"></a-date-picker>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      <a-button @click="handleStatistics" type="primary" icon="plus" :loading="btnLoading" v-has="'gwddkyemx:statistics'">{{btnName}}</a-button>
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('各网点贷款余额明细表')">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tjbb/dkywfx/gwddkyemxb/list",
          // delete: "/tjbb/dkywfx/gwddkyemxb/delete",
          // deleteBatch: "/tjbb/dkywfx/gwddkyemxb/deleteBatch",
          exportXlsUrl: "tjbb/dkywfx/gwddkyemxb/exportXls",
          // importExcelUrl: "tjbb/dkywfx/gwddkyemxb/importExcel",
          statistics: "/tjbb/dkywfx/gwddkyemxb/statistics",
        },
      }
    },
    created() {
