<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleStatistics" type="primary" icon="plus" :loading="btnLoading" v-has="'bldkrwwcqktj:statistics'">{{btnName}}</a-button>
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('不良贷款任务完成情况统计表')">导出</a-button>
...
<script>
  ...
  export default {
    name: "BldkwwcqktjbList",
    mixins:[JeecgListMixin],
    components: {JEllipsis, JTreeSelect},
    data () {
      return {
        description: '不良贷款任务完成情况统计表管理页面',
        btnName: '数据统计',
        btnLoading: false,
        ...
        url: {
          list: "/tjbb/dkywfx/bldkwwcqktjb/list",
          // delete: "/tjbb/dkywfx/bldkwwcqktjb/delete",
          // deleteBatch: "/tjbb/dkywfx/bldkwwcqktjb/deleteBatch",
          exportXlsUrl: "tjbb/dkywfx/bldkwwcqktjb/exportXls",
          // importExcelUrl: "tjbb/dkywfx/bldkwwcqktjb/importExcel",
          statistics: "/tjbb/dkywfx/bldkwwcqktjb/statistics",
        },
      }
    },
    created() {
