<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('支行贷款户数')" v-has="'zhdkhs:exportElx'">
        导出
      </a-button>
      <a-button @click="init" icon="area-chart" v-has="'zhdkhs:init'">提取</a-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/zhdkhs/zhdkhs/list",
          delete: "/zhdkhs/zhdkhs/delete",
          deleteBatch: "/zhdkhs/zhdkhs/deleteBatch",
          exportXlsUrl: "zhdkhs/zhdkhs/exportXls",
          importExcelUrl: "zhdkhs/zhdkhs/importExcel",
          init: "/zhdkhs/zhdkhs/init",
        },
      }
    },
    computed: {
