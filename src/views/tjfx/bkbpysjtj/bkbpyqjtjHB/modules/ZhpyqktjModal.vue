<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('评议情况统计(支行)')">导出</a-button>
    </div>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/bkbpyqktj_zh/zhpyqktj/list",
          delete: "/bkbpyqktj_zh/zhpyqktj/delete",
          deleteBatch: "/bkbpyqktj_zh/zhpyqktj/deleteBatch",
          exportXlsUrl: "bkbpyqktj_zh/zhpyqktj/exportXls",
          importExcelUrl: "bkbpyqktj_zh/zhpyqktj/importExcel",
       },
    }
  },
  computed: {
