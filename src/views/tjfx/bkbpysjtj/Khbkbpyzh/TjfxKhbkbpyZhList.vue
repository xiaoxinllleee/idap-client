<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('客户背靠背评议支行')">导出</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="detail" slot-scope="sszh, record">
          <a @click="handleDetailToxzc(record, '/tjfx/bkbpysjtj/khbkbpyxzc/TjfxKhbkbpyXzcList')">{{sszh}}</a>
        </span>
    ...
    <!-- 表单区域 -->
    <tjfxKhbkbpyZh-modal ref="modalForm" @ok="modalFormOk"></tjfxKhbkbpyZh-modal>
  </a-card>
</template>

<script>
  import TjfxKhbkbpyZhModal from './modules/TjfxKhbkbpyZhModal'
  ...
  export default {
    name: "TjfxKhbkbpyZhList",
    mixins:[JeecgListMixin],
    components: {
      TjfxKhbkbpyZhModal,JTreeSelect
    },
    data () {
      return {
        description: '客户背靠背评议支行管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
		...
		url: {
          list: "/tjfx.bkbpysjtj.Khbkbpyzh/tjfxKhbkbpyZh/list",
          delete: "/tjfx.bkbpysjtj.Khbkbpyzh/tjfxKhbkbpyZh/delete",
          deleteBatch: "/tjfx.bkbpysjtj.Khbkbpyzh/tjfxKhbkbpyZh/deleteBatch",
          exportXlsUrl: "tjfx.bkbpysjtj.Khbkbpyzh/tjfxKhbkbpyZh/exportXls",
          importExcelUrl: "tjfx.bkbpysjtj.Khbkbpyzh/tjfxKhbkbpyZh/importExcel",
       },
    }
  },
  computed: {
