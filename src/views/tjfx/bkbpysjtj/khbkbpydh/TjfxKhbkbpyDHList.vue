<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('单户背靠背评议明细')">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="detail" slot-scope="xzz, record">
          <a @click="handlerDetailToDh(record, '/tjfx/bkbpysjtj/khbkbpygr/TjfxKhbkbpyGrList')">{{xzz}}</a>
        </span>
    ...
    <!-- 表单区域 -->
    <tjfxKhbkbpyDH-modal ref="modalForm" @ok="modalFormOk"></tjfxKhbkbpyDH-modal>
  </a-card>
</template>

<script>
  import TjfxKhbkbpyDHModal from './modules/TjfxKhbkbpyDHModal'
  ...
  export default {
    name: 'TjfxKhbkbpyDHList',
    mixins: [JeecgListMixin],
    components: {
      TjfxKhbkbpyDHModal, JTreeSelect
    },
    data() {
      return {
        sfktsjyxdy: 1,
        description: '单户背靠背评议明细管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        url: {
          list: '/TjfxKhbkbpyDh/tjfxKhbkbpyDH/list',
          delete: '/TjfxKhbkbpyDh/tjfxKhbkbpyDH/delete',
          deleteBatch: '/TjfxKhbkbpyDh/tjfxKhbkbpyDH/deleteBatch',
          exportXlsUrl: 'TjfxKhbkbpyDh/tjfxKhbkbpyDH/exportXls',
          importExcelUrl: 'TjfxKhbkbpyDh/tjfxKhbkbpyDH/importExcel'
        }
      }
    },
    computed: {
