<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('整组背靠背评议明细')">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="detail" slot-scope="xzc, record">
          <a @click="handlerDetailToDh(record, '/tjfx/bkbpysjtj/khbkbpydh/TjfxKhbkbpyDhList')">{{xzc}}</a>
        </span>
      </a-table>
    </div>
    <!-- table区域-end -->
    ...
    <!-- 表单区域 -->
    <tjfxKhbkbpyXzz-modal ref="modalForm" @ok="modalFormOk"></tjfxKhbkbpyXzz-modal>
  </a-card>
</template>

<script>
  import TjfxKhbkbpyXzzModal from './modules/TjfxKhbkbpyXzzModal'
  ...
  export default {
    name: 'TjfxKhbkbpyXzzList',
    mixins: [JeecgListMixin],
    components: {
      TjfxKhbkbpyXzzModal, JTreeSelect
    },
    data() {
      return {
        description: '整组背靠背评议明细管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        url: {
          list: '/TjfxKhbkbpyXzz/tjfxKhbkbpyXzz/list',
          delete: '/TjfxKhbkbpyXzz/tjfxKhbkbpyXzz/delete',
          deleteBatch: '/TjfxKhbkbpyXzz/tjfxKhbkbpyXzz/deleteBatch',
          exportXlsUrl: 'TjfxKhbkbpyXzz/tjfxKhbkbpyXzz/exportXls',
          importExcelUrl: 'TjfxKhbkbpyXzz/tjfxKhbkbpyXzz/importExcel'
        }
      }
    },
    computed: {
