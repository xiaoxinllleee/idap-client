<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('客户经理背靠背评议明细')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <tjfxKhbkbpyZkhjl-modal ref="modalForm" @ok="modalFormOk"></tjfxKhbkbpyZkhjl-modal>
  </a-card>
</template>

<script>
  import TjfxKhbkbpyZkhjlModal from './modules/TjfxKhbkbpyZkhjlModal'
  ...
  export default {
    name: "TjfxKhbkbpyZkhjlList",
    mixins:[JeecgListMixin],
    components: {
      TjfxKhbkbpyZkhjlModal,JTreeSelect,JInput
    },
    data () {
      return {
        description: '客户经理背靠背评议明细管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
		...
		url: {
          list: "/TjfxKhbkbpyZkhjl/tjfxKhbkbpyZkhjl/list",
          delete: "/TjfxKhbkbpyZkhjl/tjfxKhbkbpyZkhjl/delete",
          deleteBatch: "/TjfxKhbkbpyZkhjl/tjfxKhbkbpyZkhjl/deleteBatch",
          exportXlsUrl: "TjfxKhbkbpyZkhjl/tjfxKhbkbpyZkhjl/exportXls",
          importExcelUrl: "TjfxKhbkbpyZkhjl/tjfxKhbkbpyZkhjl/importExcel",
       },
    }
  },
    created(){
