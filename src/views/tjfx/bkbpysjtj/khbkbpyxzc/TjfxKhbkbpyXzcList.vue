<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('整村背靠背评议明细')">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="detail" slot-scope="xzc, record">
          <a @click="handlerDetailToDh(record, '/tjfx/bkbpysjtj/khbkbpyxzz/TjfxKhbkbpyXzzList')">{{xzc}}</a>
        </span>
      </a-table>
    </div>
    <!-- table区域-end -->
    ...
    <!-- 表单区域 -->
    <tjfxKhbkbpyXzc-modal ref="modalForm" @ok="modalFormOk"></tjfxKhbkbpyXzc-modal>
  </a-card>
</template>

<script>
  import TjfxKhbkbpyXzcModal from './modules/TjfxKhbkbpyXzcModal'
  ...
  export default {
    name: "TjfxKhbkbpyXzcList",
    mixins:[JeecgListMixin],
    components: {
      TjfxKhbkbpyXzcModal,JTreeSelect
    },
    data () {
      return {
        description: '整村背靠背评议明细管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
		...
		url: {
          list: "/TjfxKhbkbpyXzc/tjfxKhbkbpyXzc/list",
          delete: "/TjfxKhbkbpyXzc/tjfxKhbkbpyXzc/delete",
          deleteBatch: "/TjfxKhbkbpyXzc/tjfxKhbkbpyXzc/deleteBatch",
          exportXlsUrl: "TjfxKhbkbpyXzc/tjfxKhbkbpyXzc/exportXls",
          importExcelUrl: "TjfxKhbkbpyXzc/tjfxKhbkbpyXzc/importExcel",
       },
    }
  },
  computed: {
