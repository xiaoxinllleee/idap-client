<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('背靠背评议统计')" v-has="'BkbpytjZhModal:exp'">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/wgtjfx/bkbpytjZh/list",
          delete: "/wgtjfx/bkbpytjZh/delete",
          deleteBatch: "/wgtjfx/bkbpytjZh/deleteBatch",
          exportXlsUrl: "/wgtjfx/bkbpytjZh/exportXls",
          importExcelUrl: "/wgtjfx/bkbpytjZh/importExcel",
        },
      }
    },
    computed: {
    ...
    methods: {
      ypy(record,lx){
        ...
        console.log(record)
        console.log(lx)
        this.$refs.bkbpymxModal.init(record,lx,2);
      },
    }
  }
</script>
