<template>
  <a-card class="card" :bordered="false">
      ...
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8"><a-form-item label="客户经理">
            <j-input placeholder="请选择客户经理" v-model="queryParam.khjl"/>
          </a-form-item></a-col>
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" @click="handleExportXls('客户等级分层统计：客户经理')" icon="download" style="margin-left: 8px;">导出</a-button>
...
<script>
  ...
  export default {
    name: "KhjbfctjKhjlModal",
    mixins:[JeecgListMixin],
    components: { JTreeSelect, moment, JInput, },
    data () {
      return {
        description: '客户级别分层统计(客户经理)',
        queryParam: {tjwd: 'MM'},
        tjwdM: null,
        tjwdQ: null,
        tjwdY: null,
        ...
        url: {
          list: "/khfctj/khfctjKhjl/list",
          exportXlsUrl: "/khfctj/khfctjKhjl/exportXls",
          extract: "/khfctj/khfctjKhjl/extract",
        },
      }
    },
    computed: {
