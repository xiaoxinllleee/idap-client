<template>
  <a-card :bordered='false'>
    ...
    <div class='table-operator'>
      <a-button icon='download' :loading='exportLoading' @click="handleExportXls('支行汇总统计数据')">
        导出
      </a-button>
    </div>
...
export default {
  name: 'VTjfxHztjZhList',
  mixins: [JeecgListMixin],
  components: { JTreeSelect },
  data() {
    return {
      description: '支行汇总统计数据管理页面',
      // 表头
      columns: [
        {
          title: '排名',
      ...
      url: {
        list: '/sjhztj/zhhztj/vTjfxHztjZh/list',
        exportXlsUrl: 'sjhztj/zhhztj/vTjfxHztjZh/exportXls'
      },
      isorter: {
        column: '',
        order: ''
