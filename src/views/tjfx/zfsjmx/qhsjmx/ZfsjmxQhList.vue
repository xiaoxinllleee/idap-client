<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('全行走访数据明细统计')">导出</a-button>
    ...
    <div>
      ...
      <a-table ref="table"
        ...
        <span slot="detail" slot-scope="text, record">
          <a @click="handleDetailToZh(record, '/tjfx/zfsjmx/zhsjmx/ZfsjmxZhList')">支行详情</a>
        </span>
    ...
    <!-- 表单区域 -->
    <zfsjmxQh-modal ref="modalForm" @ok="modalFormOk"></zfsjmxQh-modal>
  </a-card>
</template>

<script>
  import ZfsjmxQhModal from './modules/ZfsjmxQhModal'
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          init: '/tjfx.zfsjmx/qhsjmx/init',
          list: '/tjfx.zfsjmx/qhsjmx/list',
          delete: '/tjfx.zfsjmx/qhsjmx/delete',
          deleteBatch: '/tjfx.zfsjmx/qhsjmx/deleteBatch',
          exportXlsUrl: 'tjfx.zfsjmx/qhsjmx/exportXls',
          importExcelUrl: 'tjfx.zfsjmx/qhsjmx/importExcel'
        }
      }
    },
    computed: {
