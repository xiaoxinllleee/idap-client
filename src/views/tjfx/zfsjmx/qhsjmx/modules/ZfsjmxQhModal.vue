    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="全行总人数">
          <a-input placeholder="请输入全行总人数" v-decorator="['zrs', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjfx.zfsjmx.qhsjmx/zfsjmxQh/add",
          edit: "/tjfx.zfsjmx.qhsjmx/zfsjmxQh/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'yzfrs','zrs','zffgl'))
		  //时间格式化
