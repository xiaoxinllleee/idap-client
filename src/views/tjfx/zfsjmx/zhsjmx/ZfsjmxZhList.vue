...
<!--            <a-col :md="6" :sm="8"><a-form-item label="已走访人数">-->
<!--              <a-input placeholder="请输入已走访人数" v-model="queryParam.yzfrs"></a-input>-->
<!--            </a-form-item></a-col>-->
<!--            <a-col :md="6" :sm="8"><a-form-item label="总人数">-->
<!--              <a-input placeholder="请输入总人数" v-model="queryParam.zrs"></a-input>-->
<!--            </a-form-item></a-col>-->
<!--            <a-col :md="6" :sm="8"><a-form-item label="走访覆盖率">-->
<!--              <a-input placeholder="请输入走访覆盖率" v-model="queryParam.zffgl"></a-input>-->
<!--            </a-form-item></a-col>-->
<!--          </template>-->
...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('支行走访数据明细统计')">导出</a-button>
...
<!--          </a-dropdown>-->
<!--        </span>-->
        <span slot="detail" slot-scope="sszh, record">
          <a @click="handleDetailToXzc(record, '/tjfx/zfsjmx/xzcsjmx/ZfsjmxXzcList')">{{sszh}}</a>
        </span>
      </a-table>
    </div>
    <!-- table区域-end -->
    ...
    <!-- 表单区域 -->
    <zfsjmxZh-modal ref="modalForm" @ok="modalFormOk"></zfsjmxZh-modal>
  </a-card>
</template>

<script>
  import ZfsjmxZhModal from './modules/ZfsjmxZhModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tjfx.zfsjmx/zhsjmx/list",
          delete: "/tjfx.zfsjmx/zhsjmx/delete",
          deleteBatch: "/tjfx.zfsjmx/zhsjmx/deleteBatch",
          exportXlsUrl: "tjfx.zfsjmx/zhsjmx/exportXls",
          importExcelUrl: "tjfx.zfsjmx/zhsjmx/importExcel",
        },
      }
    },
    computed: {
