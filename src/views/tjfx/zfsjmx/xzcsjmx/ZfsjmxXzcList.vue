...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('行政村走访数据明细统计')">导出</a-button>
...
<!--        </span>-->
    ...
    <!-- 表单区域 -->
    <zfsjmxXzc-modal ref="modalForm" @ok="modalFormOk"></zfsjmxXzc-modal>
  </a-card>
</template>

<script>
  import ZfsjmxXzcModal from './modules/ZfsjmxXzcModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tjfx.zfsjmx/xzcsjmx/list",
          delete: "/tjfx.zfsjmx/xzcsjmx/delete",
          deleteBatch: "/tjfx.zfsjmx/xzcsjmx/deleteBatch",
          exportXlsUrl: "tjfx.zfsjmx/xzcsjmx/exportXls",
          importExcelUrl: "tjfx.zfsjmx/xzcsjmx/importExcel",
        },
      }
    },
    computed: {
    ...
    methods: {
      ...
      handlerDetailToXzz: function(record, path) {
        this.$router.push({
          path: path,
          query: { tjyf: record.tjyf, sszh: record.sszh,xzc: record.xzc },
        })
      },
