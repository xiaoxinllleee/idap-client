  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjfx.zfsjmx.grsjmx/zfsjmxGr/add",
          edit: "/tjfx.zfsjmx.grsjmx/zfsjmxGr/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sszh','xzc','xzz','zkhjl','hhbm','sfhz','khlx','khmc','zjhm','sfyxzf'))
		  //时间格式化
