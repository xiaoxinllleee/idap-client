...
-->
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="xzc" slot-scope="xzc ,record" >
          <a @click="handlesszhEdit1(record,'/tjfx/xdgtzyb/xdgtzyb2/xczxdgtzy2/Xzcxdgtzy2List')">{{xzc}}</a>
        </span>
    ...
    <!-- 表单区域 -->
    <zhxtgtzyb2-modal ref="modalForm" @ok="modalFormOk"></zhxtgtzyb2-modal>
  </a-card>
</template>

<script>
  import Zhxtgtzyb2Modal from './modules/Zhxtgtzyb2Modal'
  ...
  export default {
    ...
    components: {
      Zhxtgtzyb2Modal,JTreeSelect
    },
    data () {
      return {
        description: '支行行动挂图作业表2管理页面',
        // 表头
		...
		url: {
          list: "/tjfx.xdgtzyb.zhxtgtzyb2/zhxtgtzyb2/list",
          delete: "/tjfx.xdgtzyb.zhxtgtzyb2/zhxtgtzyb2/delete",
          deleteBatch: "/tjfx.xdgtzyb.zhxtgtzyb2/zhxtgtzyb2/deleteBatch",
          exportXlsUrl: "tjfx.xdgtzyb.zhxtgtzyb2/zhxtgtzyb2/exportXls",
          importExcelUrl: "tjfx.xdgtzyb.zhxtgtzyb2/zhxtgtzyb2/importExcel",
       },
    }
  },
  computed: {
    ...
    methods: {
      ...
      handlesszhEdit1: function(record,path) {
        console.log(path);
