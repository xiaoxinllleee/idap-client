<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('全行行行动挂图作业表2')">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="detail" slot-scope="text, record">
          <a @click="handleSszhEdit(record, '/tjfx/xdgtzyb/xdgtzyb2/qhxdgtzyb2/Qhxdgtzyb2List')">详情</a>
        </span>
    ...
    <!-- 表单区域 -->
    <qhzyb2-modal ref="modalForm" @ok="modalFormOk"></qhzyb2-modal>
  </a-card>
</template>

<script>
  import Qhzyb2Modal from './modules/Qhzyb2Modal'
    ...
    data () {
      return {
        ...
        url: {
          ...
          list: "/tjfx.xdgtzyb.qhzyb2/qhzyb2/list",
          delete: "/tjfx.xdgtzyb.qhzyb2/qhzyb2/delete",
          deleteBatch: "/tjfx.xdgtzyb.qhzyb2/qhzyb2/deleteBatch",
          exportXlsUrl: "tjfx.xdgtzyb.qhzyb2/qhzyb2/exportXls",
          importExcelUrl: "tjfx.xdgtzyb.qhzyb2/qhzyb2/importExcel",
        },
      }
    },
    computed: {
