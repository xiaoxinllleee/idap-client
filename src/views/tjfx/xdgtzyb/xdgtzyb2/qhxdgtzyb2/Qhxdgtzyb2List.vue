...
-->
      <a-button type="primary" icon="download" @click="handleExportXls('支行行动挂图作业表2')">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="sszh" slot-scope="sszh ,record" >
          <a @click="handlesszhEdit(record,'/tjfx/xdgtzyb/xdgtzyb2/zhxdgtzyb2/Zhxtgtzyb2List')">{{sszh}}</a>
        </span>
    ...
    <!-- 表单区域 -->
    <qhxdgtzyb2-modal ref="modalForm" @ok="modalFormOk"></qhxdgtzyb2-modal>
  </a-card>
</template>

<script>
  import Qhxdgtzyb2Modal from './modules/Qhxdgtzyb2Modal'
  ...
  export default {
    ...
    components: {
      Qhxdgtzyb2Modal,JTreeSelect
    },
    data () {
      return {
        description: '全行行动挂图作业表2管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        url: {
          list: "/tjfx.xdgtzyb.qhxtgtzyb2/qhxdgtzyb2/list",
          delete: "/tjfx.xdgtzyb.qhxtgtzyb2/qhxdgtzyb2/delete",
          deleteBatch: "/tjfx.xdgtzyb.qhxtgtzyb2/qhxdgtzyb2/deleteBatch",
          exportXlsUrl: "tjfx.xdgtzyb.qhxtgtzyb2/qhxdgtzyb2/exportXls",
          importExcelUrl: "tjfx.xdgtzyb.qhxtgtzyb2/qhxdgtzyb2/importExcel",
          init:"/tjfx.xdgtzyb.qhxtgtzyb2/qhxdgtzyb2/extract",
