    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="组">
              <a-input placeholder="请输入组名称" v-model="queryParam.xzz"></a-input>
            </a-form-item>
          </a-col>
          </template>
          <a-col :md="6" :sm="8" >
...
-->
      <a-button type="primary" icon="download" @click="handleExportXls('组行动挂图作业表2')">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
       ...
       <span slot="hhbm" slot-scope="hhbm ,record" >
          <a @click="handlesszhEdit(record,'/tjfx/xdgtzyb/xdgtzyb2/grxdgtzyb2/Grxdgtzyb2List')">{{hhbm}}</a>
        </span>
    ...
    <!-- 表单区域 -->
    <dhxdgtzyb2-modal ref="modalForm" @ok="modalFormOk"></dhxdgtzyb2-modal>
  </a-card>
</template>

<script>
  import Dhxdgtzyb2Modal from './modules/Dhxdgtzyb2Modal'
  ...
  export default {
    ...
    components: {
      Dhxdgtzyb2Modal,JTreeSelect
    },
    data () {
      return {
        description: '户行动挂图作业表2管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        url: {
          list: "/tjfx.xdgtzyb.dhxdgtzyb2/dhxdgtzyb2/list",
          delete: "/tjfx.xdgtzyb.dhxdgtzyb2/dhxdgtzyb2/delete",
          deleteBatch: "/tjfx.xdgtzyb.dhxdgtzyb2/dhxdgtzyb2/deleteBatch",
          exportXlsUrl: "tjfx.xdgtzyb.dhxdgtzyb2/dhxdgtzyb2/exportXls",
          importExcelUrl: "tjfx.xdgtzyb.dhxdgtzyb2/dhxdgtzyb2/importExcel",
        },
      }
    },
    computed: {
    ...
    methods: {
      ...
      handlesszhEdit: function(record,path) {
        ...
        this.$router.push({path: path, query: {sszh: record.sszh,tjyf:record.tjyf,xzc:record.xzc,xzz:record.xzz,hhbm:record.hhbm}})
      },
    }
  }
</script>
