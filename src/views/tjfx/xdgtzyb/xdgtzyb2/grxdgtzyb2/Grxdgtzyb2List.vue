...
-->
      <a-button type="primary" icon="download" @click="handleExportXls('行动挂图作业表明细2')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <grxdgtzyb2-modal ref="modalForm" @ok="modalFormOk"></grxdgtzyb2-modal>
  </a-card>
</template>

<script>
  import Grxdgtzyb2Modal from './modules/Grxdgtzyb2Modal'
  ...
  export default {
    ...
    components: {
      Grxdgtzyb2Modal,JTreeSelect
    },
    data () {
      return {
        description: '个人行动挂图作业表2管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        url: {
          list: "/tjfx.xdgtzyb.grxdgtzyb2/grxdgtzyb2/list",
          delete: "/tjfx.xdgtzyb.grxdgtzyb2/grxdgtzyb2/delete",
          deleteBatch: "/tjfx.xdgtzyb.grxdgtzyb2/grxdgtzyb2/deleteBatch",
          exportXlsUrl: "tjfx.xdgtzyb.grxdgtzyb2/grxdgtzyb2/exportXls",
          importExcelUrl: "tjfx.xdgtzyb.grxdgtzyb2/grxdgtzyb2/importExcel",
        },
      }
    },
    computed: {
    ...
    methods: {
      ...
      getQueryParams(){
        ...
        let hhbhvalue=this.$route.query.hhbm;
