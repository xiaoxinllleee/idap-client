...
<!--              <j-dict-select-tag placeholder="请输入行政组" v-model="queryParam.xzz" dict-code="V_CZXXGL_ORGANIZE,ORGANIZE,QYBM"/>-->
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('组建档数据明细')">导出</a-button>
...
<span slot="xzc" slot-scope="xzc ,record" >
          <a @click="handlesszhEdit(record,'/tjfx/jdsjmx/tjfx_khjdltj_dh/Tjfx_khjdltj_dhList')">{{xzc}}</a>
        </span>
...
<script>
  import Tjfx_khjdltj_zModal from './modules/Tjfx_khjdltj_zModal'
  ...
  export default {
    name: "Tjfx_khjdltj_zList",
    mixins:[JeecgListMixin],
    components: {
      Tjfx_khjdltj_zModal,JTreeSelect,JInput
    },
    data () {
      return {
        description: '1管理页面',
		...
		url: {
          list: "/tjfx_khjdltj_z/tjfx_khjdltj_z/list",
          delete: "/tjfx_khjdltj_z/tjfx_khjdltj_z/delete",
          deleteBatch: "/tjfx_khjdltj_z/tjfx_khjdltj_z/deleteBatch",
          exportXlsUrl: "tjfx_khjdltj_z/tjfx_khjdltj_z/exportXls",
          importExcelUrl: "tjfx_khjdltj_z/tjfx_khjdltj_z/importExcel",
       },
    }
  },
  computed: {
