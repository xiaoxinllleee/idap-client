    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="建档人数">
          <a-input placeholder="请输入建档人数" v-decorator="['jdrs', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="整组人数">
          <a-input placeholder="请输入整组人数" v-decorator="['zzrs', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="建档覆盖率">
          <a-input placeholder="请输入建档覆盖率" v-decorator="['jdfgl', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjfx_khjdltj_z/tjfx_khjdltj_z/add",
          edit: "/tjfx_khjdltj_z/tjfx_khjdltj_z/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sszh','xzc','xzz','zkhjl','jdrs','zzrs','jdfgl'))
		  //时间格式化
