...
<span slot="xzc" slot-scope="xzc ,record" >
          <a @click="handlesszhEdit(record,'/tjfx/jdsjmx/tjfx_khjdltj_gr/Tjfx_khjdltj_grList')">{{xzc}}</a>
        </span>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/tjfx_khjdltj_dh/tjfx_khjdltj_dh/list",
          delete: "/tjfx_khjdltj_dh/tjfx_khjdltj_dh/delete",
          deleteBatch: "/tjfx_khjdltj_dh/tjfx_khjdltj_dh/deleteBatch",
          exportXlsUrl: "tjfx_khjdltj_dh/tjfx_khjdltj_dh/exportXls",
          importExcelUrl: "tjfx_khjdltj_dh/tjfx_khjdltj_dh/importExcel",
       },
    }
  },
  computed: {
    ...
    methods: {
      ...
      handlesszhEdit: function(record,path) {
        ...
        this.$router.push({  beginDay: this.beginDay, endDay: this.endDay,path: path, query: {sszh: record.sszh,tjyf:record.tjyf,xzc:record.xzc,xzz:record.xzz}})
      },
      getCurrentMonth() {
