<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('支行建档数据明细')">导出</a-button>
...
<span slot="xzc" slot-scope="xzc ,record" >
          <a @click="handlesszhEdit(record,'/tjfx/jdsjmx/tjfx_khjdltj_cmx/Tjfx_khjdltj_cmxList')">{{xzc}}</a>
        </span>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/tjfx_khjdltj_zhmx/tjfx_khjdltj_zhmx/list",
          delete: "/tjfx_khjdltj_zhmx/tjfx_khjdltj_zhmx/delete",
          deleteBatch: "/tjfx_khjdltj_zhmx/tjfx_khjdltj_zhmx/deleteBatch",
          exportXlsUrl: "tjfx_khjdltj_zhmx/tjfx_khjdltj_zhmx/exportXls",
          importExcelUrl: "tjfx_khjdltj_zhmx/tjfx_khjdltj_zhmx/importExcel",
       },
    }
  },
  computed: {
