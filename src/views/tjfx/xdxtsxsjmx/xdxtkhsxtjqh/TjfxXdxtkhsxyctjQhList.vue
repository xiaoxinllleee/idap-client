<template>
  <a-card :bordered="false">
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="detail" slot-scope="text, record">
          <a @click="handleDetailToZh(record, '/tjfx/xdxtsxsjmx/xdxtkhsxtjzhmx/TjfxXdxtkhsxyctjZhmxList')">支行详情</a>
        </span>
    ...
    <!-- 表单区域 -->
    <tjfxXdxtkhsxyctjQh-modal ref="modalForm" @ok="modalFormOk"></tjfxXdxtkhsxyctjQh-modal>
  </a-card>
</template>

<script>
  import TjfxXdxtkhsxyctjQhModal from './modules/TjfxXdxtkhsxyctjQhModal'
  ...
  export default {
    name: "TjfxXdxtkhsxyctjQhList",
    mixins:[JeecgListMixin],
    components: {
      TjfxXdxtkhsxyctjQhModal
    },
    data () {
      return {
        description: '全行授信用信统计管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
		...
		url: {
          list: "/tjfx/tjfxXdxtkhsxyctjQh/list",
          delete: "/tjfx/tjfxXdxtkhsxyctjQh/delete",
          deleteBatch: "/tjfx/tjfxXdxtkhsxyctjQh/deleteBatch",
          exportXlsUrl: "tjfx/tjfxXdxtkhsxyctjQh/exportXls",
          importExcelUrl: "tjfx/tjfxXdxtkhsxyctjQh/importExcel",
          init:"/tjfx/tjfxXdxtkhsxyctjQh/extract",
       },
    }
  },
  computed: {
