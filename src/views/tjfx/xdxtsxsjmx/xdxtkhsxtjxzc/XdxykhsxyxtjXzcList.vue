<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('行政村授信用信统计')">导出</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <!--<span slot="detail" slot-scope="xzc, record">
          <a @click="handlerDetailToXzz(record, '/tjfx/zfsjmx/xzzsjmx/ZfsjmxXzzList')">{{xzc}}</a>
        </span>-->
    ...
    <!-- 表单区域 -->
    <xdxykhsxyxtjXzc-modal ref="modalForm" @ok="modalFormOk"></xdxykhsxyxtjXzc-modal>
  </a-card>
</template>

<script>
  import XdxykhsxyxtjXzcModal from './modules/XdxykhsxyxtjXzcModal'
  ...
  export default {
    name: 'XdxykhsxyxtjXzcList',
    mixins: [JeecgListMixin],
    components: {
      XdxykhsxyxtjXzcModal, JTreeSelect, JInput
    },
    data() {
      return {
        isorter: {
        ...
        url: {
          list: '/tjfx.xdxtsxsjmx.xdxtkhsxtjxzc/xdxykhsxyxtjXzc/list',
          delete: '/tjfx.xdxtsxsjmx.xdxtkhsxtjxzc/xdxykhsxyxtjXzc/delete',
          deleteBatch: '/tjfx.xdxtsxsjmx.xdxtkhsxtjxzc/xdxykhsxyxtjXzc/deleteBatch',
          exportXlsUrl: 'tjfx.xdxtsxsjmx.xdxtkhsxtjxzc/xdxykhsxyxtjXzc/exportXls',
          importExcelUrl: 'tjfx.xdxtsxsjmx.xdxtkhsxtjxzc/xdxykhsxyxtjXzc/importExcel'
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      handlerDetailToXzz: function(record, path) {
        this.$router.push({
          path: path,
          query: { tjyf: record.tjyf, sszh: record.sszh, szc: record.xzc }
        })
      }
    }
  }
