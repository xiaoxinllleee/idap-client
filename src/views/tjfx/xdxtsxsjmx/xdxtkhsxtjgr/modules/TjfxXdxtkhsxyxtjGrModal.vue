    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="合同可用金">
          <a-input placeholder="请输入合同可用金" v-decorator="['htkyje', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjfx.xdxtsxsjmx.xdxtkhsxtjgr/tjfxXdxtkhsxyxtjGr/add",
          edit: "/tjfx.xdxtsxsjmx.xdxtkhsxtjgr/tjfxXdxtkhsxyxtjGr/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sszh','xzc','xzz','zkhjl','hhbm','khmc','zjhm','sfhz','khlx','sxed','yxed','htkyje'))
		  //时间格式化
