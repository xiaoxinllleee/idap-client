<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('支行授信用信统计')">导出</a-button>
    </div>
      ...
      <a-table
       ...
       <!-- <span slot="action" slot-scope="text, record">
        ...
        <span slot="detail" slot-scope="sszh, record">
          <a @click="handleDetailToXzc(record, '/tjfx/xdxtsxsjmx/xdxtkhsxtjxzc/XdxykhsxyxtjXzcList')">{{sszh}}</a>
        </span>
    ...
    <!-- 表单区域 -->
    <tjfxXdxtkhsxyctjZhmx-modal ref="modalForm" @ok="modalFormOk"></tjfxXdxtkhsxyctjZhmx-modal>
  </a-card>
</template>

<script>
  import TjfxXdxtkhsxyctjZhmxModal from './modules/TjfxXdxtkhsxyctjZhmxModal'
  ...
  export default {
    name: "TjfxXdxtkhsxyctjZhmxList",
    mixins:[JeecgListMixin],
    components: {
      TjfxXdxtkhsxyctjZhmxModal,JTreeSelect
    },
    data () {
      return {
        isorter: {
		...
		url: {
          list: "/tjfx/tjfxXdxtkhsxyctjZhmx/list",
          delete: "/tjfx/tjfxXdxtkhsxyctjZhmx/delete",
          deleteBatch: "/tjfx/tjfxXdxtkhsxyctjZhmx/deleteBatch",
          exportXlsUrl: "/tjfx/tjfxXdxtkhsxyctjZhmx/exportXls",
          importExcelUrl: "/tjfx/tjfxXdxtkhsxyctjZhmx/importExcel",
       },
    }
  },
  computed: {
