...
<script>
  ...
  export default {
    name: "TjfxXdxtkhsxyctjZhmxModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/tjfx.xdxtsxsjmx.xdxtkhsxtjzhmx/tjfxXdxtkhsxyctjZhmx/add",
          edit: "/tjfx.xdxtsxsjmx.xdxtkhsxtjzhmx/tjfxXdxtkhsxyctjZhmx/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sszh','sxed','yxed','yxhs','zhs','htkyje','sxhs'))
		  //时间格式化
