  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tjfx.xdgtzytjbb.nshbe/tjfxNshbe/hsmx",
          exportXlsUrl: "/tjfx.xdgtzytjbb.nshbe/tjfxNshbe/exporthsmxXls",
        },
      }
    },
    created () {
    ...
    methods: {
      edit (record,sjlx,zdmc1) {
        this.sjlx = sjlx;
        this.zdmc1 = zdmc1;
        this.visible = true;
        if (record.gpldgh) {
          this.model = Object.assign({}, record);
          var parm ={"tjyf":record.tjyf,"xzc":record.jgdm,"zkhjl":record.gpldgh,"sjlx":sjlx,"zdmc1":zdmc1}
      ...
      handleExportXls(fileName){
        ...
        var dcsj ={"tjyf":this.model.tjyf,"xzc":this.model.jgdm,"zkhjl":this.model.gpldgh,"sjlx":this.sjlx,"zdmc1":this.zdmc1}
        console.log(dcsj)
