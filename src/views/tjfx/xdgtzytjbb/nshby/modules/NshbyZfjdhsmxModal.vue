  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tjfx.xdgtzytjbb.nshby/tjfxNshby/zfjdmx",
          exportXlsUrl:"/tjfx.xdgtzytjbb.nshby/tjfxNshby/exportTemplatezfjdmxXls"
        },
      }
    },
    created () {
    ...
    methods: {
      edit (record,khlx,sjlx) {
        ...
        console.log("参数"+record)
          ...
          var parm ={"ksrq":record.ksrq,"jsrq":record.jsrq,"xzc":record.jgdm,"zkhjl":record.gpld,"khlx":khlx,"sjlx":sjlx}
      ...
      handleExportXls(fileName){
        ...
        var dcsj ={"ksrq":this.model.ksrq,"jsrq":this.model.jsrq,"xzc":this.model.jgdm,"zkhjl":this.model.gpld,"khlx":this.khlx,"sjlx":this.sjlx}
