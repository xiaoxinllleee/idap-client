  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tjfx.xdgtzytjbb.nshby/tjfxNshby/pjsxjdyxje",
          exportXlsUrl:"/tjfx.xdgtzytjbb.nshby/tjfxNshby/exportTemplatepjsxyxjemxXls"
        },
      }
    },
    created () {
    ...
    methods: {
      edit (record,sjlx) {
        ...
        if (record.gpld) {
          ...
          var parm ={"ksrq":record.ksrq,"jsrq":record.jsrq,"xzc":record.jgdm,"zkhjl":record.gpld,"sjlx":sjlx}
      ...
      handleExportXls(fileName){
        ...
        var dcsj ={"ksrq":this.model.ksrq,"jsrq":this.model.jsrq,"xzc":this.model.jgdm,"zkhjl":this.model.gpld,"sjlx":this.sjlx}
