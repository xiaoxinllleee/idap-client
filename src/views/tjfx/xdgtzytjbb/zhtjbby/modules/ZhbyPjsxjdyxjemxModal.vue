  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tjfx.xdgtzytjbb.zhtjbby/tjfxZhby/pjsxjdyxje",
          exportXlsUrl:"/tjfx.xdgtzytjbb.zhtjbby/tjfxZhby/exportTemplatepjsxyxjemxXls"
        },
      }
    },
    created () {
    ...
    methods: {
      edit (record,sjlx) {
        ...
        if (record.zrre) {
          ...
          var parm ={"ksrq":record.ksrq,"jsrq":record.jsrq,"xzc":record.xzc,"zkhjl":record.zrre,"sjlx":sjlx}
      ...
      handleExportXls(fileName){
        ...
        var dcsj ={"ksrq":this.model.ksrq,"jsrq":this.model.jsrq,"xzc":this.model.xzc,"zkhjl":this.model.zrre,"sjlx":this.sjlx}
