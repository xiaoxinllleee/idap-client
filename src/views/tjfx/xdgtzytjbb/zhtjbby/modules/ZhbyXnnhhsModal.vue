  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tjfx.xdgtzytjbb.zhtjbby/tjfxZhby/xnhsmx",
          exportXlsUrl: "/tjfx.xdgtzytjbb.zhtjbby/tjfxZhby/exportTemplatemxXls",
        },
      }
    },
    created () {
    ...
    methods: {
      edit (record,khlx) {
        ...
        if (record.zrre) {
          ...
          var parm ={"ksrq":record.ksrq,"jsrq":record.jsrq,"xzc":record.xzc,"zkhjl":record.zrre,"khlx":khlx,'zdmc':'zkhjl'}
      ...
      nshedit (record,khlx) {
        ...
        this.visible = true;
          this.model = Object.assign({}, record);
          var parm ={"ksrq":record.ksrq,"jsrq":record.jsrq,"xzc":record.xzc,"zkhjl":record.gpld,"khlx":khlx,'zdmc':'gpld'}
          putAction(this.url.list, parm).then((res) => {
            console.log("----------")
            console.log( res.result)
            this.dataSource = res.result;
      ...
      handleExportXls(fileName){
        ...
        var dcsj ={"ksrq":this.model.ksrq,"jsrq":this.model.jsrq,"xzc":this.model.xzc,"zkhjl":this.model.zrre,"khlx":this.khlx,"dcbs":'xnhs'}
        console.log(dcsj)
