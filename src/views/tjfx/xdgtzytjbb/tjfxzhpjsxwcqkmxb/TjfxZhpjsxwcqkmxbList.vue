<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('支行评级授信完成情况明细表')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <tjfxZhpjsxwcqkmxb-modal ref="modalForm" @ok="modalFormOk"></tjfxZhpjsxwcqkmxb-modal>
    <zhpjsx-sjzfhshs-modal ref="ZhpjsxSjzfhshsModal" @ok="modalFormOk"></zhpjsx-sjzfhshs-modal>
  </a-card>
</template>

<script>
  import TjfxZhpjsxwcqkmxbModal from './modules/TjfxZhpjsxwcqkmxbModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import JTreeSelect from '@/components/jeecg/JTreeSelect'
  import { getAction,putAction,httpAction,downFile } from '@/api/manage'
  import { filterObj } from '@/utils/util';
  import JInput from "../../../../components/jeecg/JInput.vue";
  import ZhpjsxSjzfhshsModal from './modules/ZhpjsxSjzfhshsModal'



  export default {
    name: "TjfxZhpjsxwcqkmxbList",
    mixins:[JeecgListMixin],
    components: {
      TjfxZhpjsxwcqkmxbModal,JTreeSelect,JInput,ZhpjsxSjzfhshsModal
    },
    data () {
      return {
        description: '支行评级授信完成情况明细表管理页面',
        // 表头
        columns: [
          {
            title: '开始日期',
		...
		url: {
          list: "/tjfx.xdgtzytjbb.tjfxzhpjsxwcqkmxb/tjfxZhpjsxwcqkmxb/list",
          delete: "/tjfx.xdgtzytjbb.tjfxzhpjsxwcqkmxb/tjfxZhpjsxwcqkmxb/delete",
          deleteBatch: "/tjfx.xdgtzytjbb.tjfxzhpjsxwcqkmxb/tjfxZhpjsxwcqkmxb/deleteBatch",
          exportXlsUrl: "tjfx.xdgtzytjbb.tjfxzhpjsxwcqkmxb/tjfxZhpjsxwcqkmxb/exportTemplateXls",
          importExcelUrl: "tjfx.xdgtzytjbb.tjfxzhpjsxwcqkmxb/tjfxZhpjsxwcqkmxb/importExcel",
          init:"/tjfx.xdgtzytjbb.tjfxzhpjsxwcqkmxb/tjfxZhpjsxwcqkmxb/extract",
    },
    }
  },
  computed: {
    ...
    methods: {
      ...
      handlesjzfhsmxEdit: function(record,title,zdmc,gnmc) {
        this.$refs.ZhpjsxSjzfhshsModal.edit(record,'zhpjsx',zdmc,gnmc);
