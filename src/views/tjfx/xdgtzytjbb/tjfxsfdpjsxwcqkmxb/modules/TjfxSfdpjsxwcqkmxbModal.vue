    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="农商行">
          <a-input placeholder="请输入农商行" v-decorator="['nsh', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="班子成员名称">
          <a-input placeholder="请输入班子成员名称" v-decorator="['bzcymc', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="全村（社区）户数">
          <a-input placeholder="请输入全村（社区）户数" v-decorator="['chs', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjfx.xdgtzytjbb.tjfxsfdpjsxwcqkmxb/tjfxSfdpjsxwcqkmxb/add",
          edit: "/tjfx.xdgtzytjbb.tjfxsfdpjsxwcqkmxb/tjfxSfdpjsxwcqkmxb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'nsh','bzcymc','jgdm','xzc','sjzfhs','chs','cjl','sjpjhs','pjl','sjsxhs','sxl','yxhs','yxl'))
		  //时间格式化
