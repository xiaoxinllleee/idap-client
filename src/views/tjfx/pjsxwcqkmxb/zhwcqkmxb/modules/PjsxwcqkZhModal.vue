    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="支行户数">
          <a-input placeholder="请输入支行户数" v-decorator="['zhhs', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjfx.pjsxwcqkmxb/zhwcqkmxb/add",
          edit: "/tjfx.pjsxwcqkmxb/zhwcqkmxb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sszh','sjzfhs','zhhs','cjl','sjpjhs','pjl','sjsxhs','sxl','yxhs','yxl'))
		  //时间格式化
