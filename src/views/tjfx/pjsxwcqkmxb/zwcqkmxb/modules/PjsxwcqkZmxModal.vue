    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="组户数">
          <a-input placeholder="请输入组户数" v-decorator="['zhs', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjfx.pjsxwcqkmxb/zwcqkmxb/add",
          edit: "/tjfx.pjsxwcqkmxb/zwcqkmxb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sszh','xzc','xzz','zkhjl','sjzfhs','zhs','cjl','sjpjhs','pjl','sjsxhs','sxl','yxhs','yxl'))
		  //时间格式化
