    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="是否已走访（0：否，1：是）">
          <a-input placeholder="请输入是否已走访（0：否，1：是）" v-decorator="['sfyzf', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="最终授信额度">
          <a-input placeholder="请输入最终授信额度" v-decorator="['zzsxed', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="系统测算评定等级">
          <a-input placeholder="请输入系统测算评定等级" v-decorator="['xtcspddj', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="是否已授信（0：否，1：是）">
          <a-input placeholder="请输入是否已授信（0：否，1：是）" v-decorator="['sfysx', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="是否已用信（0：否，1：是）">
          <a-input placeholder="请输入是否已用信（0：否，1：是）" v-decorator="['sfyyx', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="附件数量">
          <a-input placeholder="请输入附件数量" v-decorator="['fjsl', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjfx.pjsxwcqkmxb.grwcqkmxb/pjsxwcqkGr/add",
          edit: "/tjfx.pjsxwcqkmxb.grwcqkmxb/pjsxwcqkGr/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sszh','xzc','xzz','zkhjl','hhbm','khmc','zjhm','sfhz','sfyzf','zzsxed','xtcspddj','yxje','sfyjpj','sfysx','sfyyx','fjsl'))
		  //时间格式化
