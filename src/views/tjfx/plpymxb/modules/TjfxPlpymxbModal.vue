    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="评议时间">
          <a-date-picker v-decorator="[ 'pysj', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="评议得分">
          <a-input placeholder="请输入评议得分" v-decorator="['pddf', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="评议轮数">
          <a-input placeholder="请输入评议轮数" v-decorator="['pyls', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="录入员工">
          <a-input placeholder="请输入录入员工" v-decorator="['lryg', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjfx/tjfxPlpymxb/add",
          edit: "/tjfx/tjfxPlpymxb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sszh','czbm','hhbm','zjhm','khxm','pddf','pddj','jysxed','pyls','pyyxm','pyyzjhm','lryg'))
		  //时间格式化
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            //时间格式化
            formData.pysj = formData.pysj?formData.pysj.format():null;
