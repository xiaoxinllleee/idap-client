<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" @click="searchQuery" icon="search">查询</a-button>
      <a-button type="primary" @click="searchReset" icon="reload" style="margin-left: 8px">重置</a-button>
      <a-button type="primary" icon="download" @click="handleExportXls('支行金融普惠数据汇总')" style="margin-left: 8px">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/tjfx/jrphsjZh/list",
          delete: "/tjfx/jrphsjZh/delete",
          deleteBatch: "/tjfx/jrphsjZh/deleteBatch",
          exportXlsUrl: "/tjfx/jrphsjZh/exportTemplateXls",
          importExcelUrl: "/tjfx/jrphsjZh/importExcel",
       },
    }
  },
  computed: {
