    ...
    <div>
      ...
      <a-table
       ...
       <span slot="detail" slot-scope="text, record">
          <a @click="handleSszhEdit(record, '/tjfx/tjbb/wdkq/kqdkbb/zhkqdkbb/Tjfx_tjbb_zhkqdktjList')">详情</a>
        </span>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/tjfx_tjbb_qhkqdktj/tjfx_tjbb_qhkqdktj/list",
          delete: "/tjfx_tjbb_qhkqdktj/tjfx_tjbb_qhkqdktj/delete",
          deleteBatch: "/tjfx_tjbb_qhkqdktj/tjfx_tjbb_qhkqdktj/deleteBatch",
          exportXlsUrl: "tjfx_tjbb_qhkqdktj/tjfx_tjbb_qhkqdktj/exportXls",
          importExcelUrl: "tjfx_tjbb_qhkqdktj/tjfx_tjbb_qhkqdktj/importExcel",
       },
    }
  },
  computed: {
