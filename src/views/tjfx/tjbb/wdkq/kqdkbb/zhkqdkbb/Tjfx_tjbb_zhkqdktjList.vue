    ...
    <div>
      ...
      <a-table
        ...
        @change="handleTableChange">
          ...
          <a @click="handle1SszhEdit(record, '/tjfx/tjbb/wdkq/kqdkbb/khjlkqdkbb/Tjfx_tjbb_khjlkqdktjList')">{{sszh}}</a>
        </span>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/tjfx_tjbb_zhkqdktj/tjfx_tjbb_zhkqdktj/list",
          delete: "/tjfx_tjbb_zhkqdktj/tjfx_tjbb_zhkqdktj/delete",
          deleteBatch: "/tjfx_tjbb_zhkqdktj/tjfx_tjbb_zhkqdktj/deleteBatch",
          exportXlsUrl: "tjfx_tjbb_zhkqdktj/tjfx_tjbb_zhkqdktj/exportXls",
          importExcelUrl: "tjfx_tjbb_zhkqdktj/tjfx_tjbb_zhkqdktj/importExcel",
       },
    }
  },
  computed: {
    ...
    methods: {
      ...
      initData() {
        ...
        this.loading = true;
        putAction("/tjfx_tjbb_zhkqdktj/tjfx_tjbb_zhkqdktj/extract", 'TJYF='+ksrqstr,'put').then((res) => {
          if(res.success){
            this.loadData();
