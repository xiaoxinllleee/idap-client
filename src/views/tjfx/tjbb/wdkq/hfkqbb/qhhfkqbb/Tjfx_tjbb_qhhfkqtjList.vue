<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('全行客户经理回访考勤统计')">导出</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="detail" slot-scope="text, record">
          <a @click="handleSszhEdit(record, '/tjfx/tjbb/wdkq/hfkqbb/zhhfkqbb/Tjfx_tjbb_zhhfkqtjList')">详情</a>
        </span>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/tjfx_tjbb_qhhfkqtj/tjfx_tjbb_qhhfkqtj/list",
          delete: "/tjfx_tjbb_qhhfkqtj/tjfx_tjbb_qhhfkqtj/delete",
          deleteBatch: "/tjfx_tjbb_qhhfkqtj/tjfx_tjbb_qhhfkqtj/deleteBatch",
          exportXlsUrl: "tjfx_tjbb_qhhfkqtj/tjfx_tjbb_qhhfkqtj/exportXls",
          importExcelUrl: "tjfx_tjbb_qhhfkqtj/tjfx_tjbb_qhhfkqtj/importExcel",
       },
    }
  },
  computed: {
