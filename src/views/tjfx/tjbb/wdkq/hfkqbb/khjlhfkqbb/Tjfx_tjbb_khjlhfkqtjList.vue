    ...
    <div>
      ...
      <a-table
        ...
        @change="handleTableChange">
          ...
          <a @click="handle2SszhEdit(record, '/yxgl/khhhmx/YxglKhhfmxbList')">{{khjl}}</a>
        </span>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/tjfx_tjbb_khjlhfkqtj/tjfx_tjbb_khjlhfkqtj/list",
          delete: "/tjfx_tjbb_khjlhfkqtj/tjfx_tjbb_khjlhfkqtj/delete",
          deleteBatch: "/tjfx_tjbb_khjlhfkqtj/tjfx_tjbb_khjlhfkqtj/deleteBatch",
          exportXlsUrl: "tjfx_tjbb_khjlhfkqtj/tjfx_tjbb_khjlhfkqtj/exportXls",
          importExcelUrl: "tjfx_tjbb_khjlhfkqtj/tjfx_tjbb_khjlhfkqtj/importExcel",
       },
    }
  },
  computed: {
    ...
    methods: {
      ...
      initData() {
        ...
        this.loading = true;
        putAction("/tjfx_tjbb_khjlhfkqtj/tjfx_tjbb_khjlhfkqtj/extract", 'TJYF='+ksrqstr,'put').then((res) => {
          if(res.success){
            this.loadData();
      ...
      handle2SszhEdit: function(record,path) {
        this.$router.push({path: path, query: {zzbz: record.zzbz,tjrq: record.tjrq,khjlbh:record.khjlbh}})
      },
    }
  }
</script>
