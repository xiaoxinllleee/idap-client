<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('客户潜在业务报表(村社)')">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="xzc" slot-scope="xzc ,record" >
          <a @click="handlesszhEdit(record,'/tjfx/tjbb/khqzywbb/GrmxkhqzywbbList')">{{xzc}}</a>
        </span>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tjfx.tjbb.khqzywbb/xzckhqzywbb/list",
          delete: "/tjfx.tjbb.khqzywbb/xzckhqzywbb/delete",
          deleteBatch: "/tjfx.tjbb.khqzywbb/xzckhqzywbb/deleteBatch",
          exportXlsUrl: "tjfx.tjbb.khqzywbb/xzckhqzywbb/exportXls",
          importExcelUrl: "tjfx.tjbb.khqzywbb/xzckhqzywbb/importExcel",
        },
    }
  },
  computed: {
    ...
    methods: {
      ...
      handlesszhEdit: function(record,path) {
        ...
        this.$router.push({path: path, query: {sszh: record.sszh,tjrq:record.tjrq,xzc:record.xzc}})
      },
      searchReset() {
        this.flag = false;
