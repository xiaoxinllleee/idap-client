    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="客户经理">
          <a-input placeholder="请输入客户经理" v-decorator="['khjl', validatorRules.khjl ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjfx.tjbb.khqzywbb/khjlkhqzywbb/add",
          edit: "/tjfx.tjbb.khqzywbb/khjlkhqzywbb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sszh','khjl','qzzhs','qzdkhs','qzckhs','qzwsyhhs','qzsjyhhs','qzetchs','qzezfhs','qzejfhs','qzposhs','qzznzdhs','qzlchs','qzbxhs'))
		  //时间格式化
