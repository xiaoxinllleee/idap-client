<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('客户潜在业务报表(客户经理)')">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="khjl" slot-scope="khjl ,record" >
          <a @click="handlesszhEdit(record,'/tjfx/tjbb/khqzywbb/GrmxkhqzywbbList')">{{khjl}}</a>
        </span>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/tjfx.tjbb.khqzywbb/khjlkhqzywbb/list",
          delete: "/tjfx.tjbb.khqzywbb/khjlkhqzywbb/delete",
          deleteBatch: "/tjfx.tjbb.khqzywbb/khjlkhqzywbb/deleteBatch",
          exportXlsUrl: "tjfx.tjbb.khqzywbb/khjlkhqzywbb/exportXls",
          importExcelUrl: "tjfx.tjbb.khqzywbb/khjlkhqzywbb/importExcel",
       },
    }
  },
  computed: {
    ...
    methods: {
      ...
      handlesszhEdit: function(record,path) {
        ...
        this.$router.push({path: path, query: {sszh: record.sszh,tjrq:record.tjrq,khjl:record.khjl}})
      },
