    ...
    <div>
      ...
      <a-table
        ...
        <span slot="detail" slot-scope="text, record">
          <a @click="handleDetailToZh(record, '/tjfx/tjbb/shpjtj/sxyxmx_zh/Tjfx_shsxyxtj_zhmxList')">支行详情</a>
        </span>
      </a-table>
    </div>
    <!-- table区域-end -->
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          init: '/tjbb.shpjtj.sxyxmx_qh/tjfx_shsxyxtj_qh/init',
          list: "/tjbb.shpjtj.sxyxmx_qh/tjfx_shsxyxtj_qh/list",
          delete: "/tjbb.shpjtj.sxyxmx_qh/tjfx_shsxyxtj_qh/delete",
          deleteBatch: "/tjbb.shpjtj.sxyxmx_qh/tjfx_shsxyxtj_qh/deleteBatch",
          exportXlsUrl: "tjbb.shpjtj.sxyxmx_qh/tjfx_shsxyxtj_qh/exportXls",
          importExcelUrl: "tjbb.shpjtj.sxyxmx_qh/tjfx_shsxyxtj_qh/importExcel",
       },
    }
  },
  computed: {
