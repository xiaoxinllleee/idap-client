<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('客户经理授信用信统计')">导出</a-button>
    </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/tjbb.shpjtj.sxyxmx_khjl/tjfx_shsxyxtj_khjl/list',
          delete: '/tjbb.shpjtj.sxyxmx_khjl/tjfx_shsxyxtj_khjl/delete',
          deleteBatch: '/tjbb.shpjtj.sxyxmx_khjl/tjfx_shsxyxtj_khjl/deleteBatch',
          exportXlsUrl: 'tjbb.shpjtj.sxyxmx_khjl/tjfx_shsxyxtj_khjl/exportXls',
          importExcelUrl: 'tjbb.shpjtj.sxyxmx_khjl/tjfx_shsxyxtj_khjl/importExcel'
        }
      }
    },
    computed: {
