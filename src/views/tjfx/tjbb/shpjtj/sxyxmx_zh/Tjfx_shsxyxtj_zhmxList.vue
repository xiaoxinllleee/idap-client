  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/tjbb.shpjtj.sxyxmx_zh/tjfx_shsxyxtj_zhmx/list',
          delete: '/tjbb.shpjtj.sxyxmx_zh/tjfx_shsxyxtj_zhmx/delete',
          deleteBatch: '/tjbb.shpjtj.sxyxmx_zh/tjfx_shsxyxtj_zhmx/deleteBatch',
          exportXlsUrl: 'tjbb.shpjtj.sxyxmx_zh/tjfx_shsxyxtj_zhmx/exportXls',
          importExcelUrl: 'tjbb.shpjtj.sxyxmx_zh/tjfx_shsxyxtj_zhmx/importExcel'
        }
      }
    },
    computed: {
