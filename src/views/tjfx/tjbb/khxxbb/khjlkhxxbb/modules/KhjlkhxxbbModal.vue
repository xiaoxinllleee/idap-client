    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="村社数">
          <a-input placeholder="请输入村社数" v-decorator="['csl', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjfx.tjbb.khxxbb/khjlkhxxbb/add",
          edit: "/tjfx.tjbb.khxxbb/khjlkhxxbb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sszh','zkhjl','csl','zkhs','xxwskhs','xxcjkhs','ljsxkhs','bysxkhs','ljyxkhs','byyxkhs'))
		  //时间格式化
