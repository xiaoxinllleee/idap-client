<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('客户信息报表(客户经理)')">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        @change="handleTableChange">
         <span slot="zkhjl" slot-scope="zkhjl ,record" >
            <a @click="handlesszhEdit(record,'/tjfx/tjbb/khxxbb/grkhxxbb/GrkhxxbbList')">{{zkhjl}}</a>
         </span>
      </a-table>
    </div>
    <!-- table区域-end -->
    ...
    <!-- 表单区域 -->
    <khjlkhxxbb-modal ref="modalForm" @ok="modalFormOk"></khjlkhxxbb-modal>
  </a-card>
</template>

<script>
  import KhjlkhxxbbModal from './modules/KhjlkhxxbbModal';
  ...
  export default {
    ...
    components: {
      KhjlkhxxbbModal,JTreeSelect
    },
    data () {
      return {
        description: '客户信息报表(客户经理)管理页面',
        // 表头
		...
		url: {
          list: "/tjfx.tjbb.khxxbb/khjlkhxxbb/list",
          delete: "/tjfx.tjbb.khxxbb/khjlkhxxbb/delete",
          deleteBatch: "/tjfx.tjbb.khxxbb/khjlkhxxbb/deleteBatch",
          exportXlsUrl: "tjfx.tjbb.khxxbb/khjlkhxxbb/exportXls",
          importExcelUrl: "tjfx.tjbb.khxxbb/khjlkhxxbb/importExcel",
       },
    }
  },
  computed: {
    ...
    methods: {
      ...
      handlesszhEdit: function(record,path) {
        console.log(path);
        console.log(record.zkhjl);
        this.$router.push({path: path, query: {sszh: record.sszh,tjyf:record.tjyf,zkhjl:record.zkhjl}})
      },
