  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjfx.tjbb.khxxbb/zhkhxxbb/add",
          edit: "/tjfx.tjbb.khxxbb/zhkhxxbb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sszh','csl','zkhs','xxwskhs','xxcjkhs','ljsxkhs','bysxkhs','ljyxkhs','byyxkhs'))
		  //时间格式化
