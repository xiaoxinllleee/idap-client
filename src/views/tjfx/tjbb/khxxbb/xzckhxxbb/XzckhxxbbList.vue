<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        ...
        <a-col :md="6" :sm="8">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="村社">
              <a-input placeholder="请输入村社" v-model="queryParam.xzc"></a-input>
            </a-form-item>
          </a-col>
          </template>
          <a-col :md="6" :sm="8" >
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('客户信息报表(村社)')">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="xzc" slot-scope="xzc ,record" >
            <a @click="handlesszhEdit(record,'/tjfx/tjbb/khxxbb/grkhxxbb/GrkhxxbbList')">{{xzc}}</a>
         </span>
    ...
    <!-- 表单区域 -->
    <xzckhxxbb-modal ref="modalForm" @ok="modalFormOk"></xzckhxxbb-modal>
  </a-card>
</template>

<script>
  import XzckhxxbbModal from './modules/XzckhxxbbModal'
  ...
  export default {
    ...
    components: {
      XzckhxxbbModal,JTreeSelect
    },
    data () {
      return {
        description: '客户信息报表(村社)管理页面',
        // 表头
		...
		url: {
          list: "/tjfx.tjbb.khxxbb/xzckhxxbb/list",
          delete: "/tjfx.tjbb.khxxbb/xzckhxxbb/delete",
          deleteBatch: "/tjfx.tjbb.khxxbb/xzckhxxbb/deleteBatch",
          exportXlsUrl: "tjfx.tjbb.khxxbb/xzckhxxbb/exportXls",
          importExcelUrl: "tjfx.tjbb.khxxbb/xzckhxxbb/importExcel",
       },
    }
  },
  computed: {
