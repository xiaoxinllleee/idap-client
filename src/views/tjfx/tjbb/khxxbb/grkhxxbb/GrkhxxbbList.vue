<template>
  <a-card :bordered="false">
            ...
            <template v-if="toggleSearchStatus">
              <a-col :md="6" :sm="8">
                <a-form-item label="乡镇">
                  <a-input placeholder="请输人乡镇" v-model="queryParam.xz"></a-input>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="8">
                <a-form-item label="村">
                  <a-input placeholder="请输入村" v-model="queryParam.xzc"></a-input>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="8">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('客户信息报名(明细)')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <grkhxxbb-modal ref="modalForm" @ok="modalFormOk"></grkhxxbb-modal>
  </a-card>
</template>

<script>
  import GrkhxxbbModal from './modules/GrkhxxbbModal'
  ...
  export default {
    ...
    components: {
      GrkhxxbbModal,JTreeSelect
    },
    data () {
      return {
        description: '客户信息报名(明细)管理页面',
        // 表头
		...
		url: {
          list: "/tjfx.tjbb.khxxbb/grkhxxbb/list",
          delete: "/tjfx.tjbb.khxxbb/grkhxxbb/delete",
          deleteBatch: "/tjfx.tjbb.khxxbb/grkhxxbb/deleteBatch",
          exportXlsUrl: "tjfx.tjbb.khxxbb/grkhxxbb/exportXls",
          importExcelUrl: "tjfx.tjbb.khxxbb/grkhxxbb/importExcel",
       },
    }
  },
  computed: {
