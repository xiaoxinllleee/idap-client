<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('客户信息报表(全行)')">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
       ...
       <span slot="detail" slot-scope="text, record">
          <a @click="handleSszhEdit(record, '/tjfx/tjbb/khxxbb/zhkhxxbb/ZhkhxxbbList')">详情</a>
        </span>
    ...
    <!-- 表单区域 -->
    <qhkhxxbb-modal ref="modalForm" @ok="modalFormOk"></qhkhxxbb-modal>
  </a-card>
</template>

<script>
  import QhkhxxbbModal from './modules/QhkhxxbbModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/tjfx.tjbb.khxxbb/qhkhxxbb/list",
          delete: "/tjfx.tjbb.khxxbb/qhkhxxbb/delete",
          deleteBatch: "/tjfx.tjbb.khxxbb/qhkhxxbb/deleteBatch",
          exportXlsUrl: "tjfx.tjbb.khxxbb/qhkhxxbb/exportXls",
          importExcelUrl: "tjfx.tjbb.khxxbb/qhkhxxbb/importExcel",
          init:"/tjfx.tjbb.khxxbb/qhkhxxbb/extract",
