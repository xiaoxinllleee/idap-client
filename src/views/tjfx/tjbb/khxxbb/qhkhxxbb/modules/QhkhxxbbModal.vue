  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tjfx.tjbb.khxxbb/qhkhxxbb/add",
          edit: "/tjfx.tjbb.khxxbb/qhkhxxbb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'csl','zkhs','xxwskhs','xxcjkhs','ljsxkhs','bysxkhs','ljyxkhs','byyxkhs'))
		  //时间格式化
