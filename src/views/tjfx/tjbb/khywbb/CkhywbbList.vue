<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('客户业务报表(村社)')">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="xzc" slot-scope="xzc ,record" >
          <a @click="handlesszhEdit(record,'/tjfx/tjbb/khywbb/GrmxkhywbbList')">{{xzc}}</a>
        </span>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/tjfx.tjbb.khywbb/ckhywbb/list",
          delete: "/tjfx.tjbb.khywbb/ckhywbb/delete",
          deleteBatch: "/tjfx.tjbb.khywbb/ckhywbb/deleteBatch",
          exportXlsUrl: "tjfx.tjbb.khywbb/ckhywbb/exportXls",
          importExcelUrl: "tjfx.tjbb.khywbb/ckhywbb/importExcel",
       },
    }
  },
  computed: {
