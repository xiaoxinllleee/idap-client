<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('支行金融普惠数据')">导出</a-button>
    </div>
...
<script>
  ...
  export default {
    name: 'Tjfx_shjrphsj_zhList',
    mixins: [JeecgListMixin],
    components: {JTreeSelect},
    data() {
      return {
        description: '支行金融普惠数据管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        url: {
          list: '/tjbb.shjrphsjhz.jrphsj_zh/tjfx_shjrphsj_zh/list',
          delete: '/tjbb.shjrphsjhz.jrphsj_zh/tjfx_shjrphsj_zh/delete',
          deleteBatch: '/tjbb.shjrphsjhz.jrphsj_zh/tjfx_shjrphsj_zh/deleteBatch',
          exportXlsUrl: 'tjbb.shjrphsjhz.jrphsj_zh/tjfx_shjrphsj_zh/exportTemplateXls',
          importExcelUrl: 'tjbb.shjrphsjhz.jrphsj_zh/tjfx_shjrphsj_zh/importExcel'
        }
      }
    },
    computed: {
