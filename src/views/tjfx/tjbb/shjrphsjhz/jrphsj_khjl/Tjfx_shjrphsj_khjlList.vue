<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('客户经理金融普惠数据')">导出</a-button>
    </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/tjbb.shjrphsjhz.jrphsj_khjl/tjfx_shjrphsj_khjl/list',
          delete: '/tjbb.shjrphsjhz.jrphsj_khjl/tjfx_shjrphsj_khjl/delete',
          deleteBatch: '/tjbb.shjrphsjhz.jrphsj_khjl/tjfx_shjrphsj_khjl/deleteBatch',
          exportXlsUrl: 'tjbb.shjrphsjhz.jrphsj_khjl/tjfx_shjrphsj_khjl/exportXls',
          importExcelUrl: 'tjbb.shjrphsjhz.jrphsj_khjl/tjfx_shjrphsj_khjl/importExcel'
        }
      }
    },
    computed: {
