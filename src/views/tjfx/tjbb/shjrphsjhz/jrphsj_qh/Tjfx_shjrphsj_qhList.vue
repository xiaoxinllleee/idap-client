<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('全行金融普惠数据')">导出</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="detail" slot-scope="text, record">
          <a @click="handleDetailToZh(record, '/tjfx/tjbb/shjrphsjhz/jrphsj_zh/Tjfx_shjrphsj_zhList')">支行详情</a>
        </span>
      </a-table>
    </div>
    <!-- table区域-end -->
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          init: "/tjbb.shjrphsjhz.jrphsj_qh/tjfx_shjrphsj_qh/init",
          list: "/tjbb.shjrphsjhz.jrphsj_qh/tjfx_shjrphsj_qh/list",
          delete: "/tjbb.shjrphsjhz.jrphsj_qh/tjfx_shjrphsj_qh/delete",
          deleteBatch: "/tjbb.shjrphsjhz.jrphsj_qh/tjfx_shjrphsj_qh/deleteBatch",
          exportXlsUrl: "tjbb.shjrphsjhz.jrphsj_qh/tjfx_shjrphsj_qh/exportXls",
          importExcelUrl: "tjbb.shjrphsjhz.jrphsj_qh/tjfx_shjrphsj_qh/importExcel",
       },
    }
  },
  computed: {
