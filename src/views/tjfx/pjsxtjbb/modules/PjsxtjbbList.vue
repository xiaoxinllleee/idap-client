...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('评级授信统计报表')" v-has="'Pjsxtjbb:exp'">导出</a-button>
     <!-- <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button icon="import">导入</a-button>
      </a-upload>-->
      <a-button @click="init" icon="area-chart" v-has="'Pjsxtjbb:init'">提取</a-button>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/pjsxtjbb/pjsxtjbb/list",
          delete: "/pjsxtjbb/pjsxtjbb/delete",
          deleteBatch: "/pjsxtjbb/pjsxtjbb/deleteBatch",
          exportXlsUrl: "pjsxtjbb/pjsxtjbb/exportXls",
          init: "pjsxtjbb/pjsxtjbb/init",
          importExcelUrl: "pjsxtjbb/pjsxtjbb/importExcel",
       },
    }
  },
  computed: {
    ...
    methods: {
      ...
      pjsxtjmx(record){
        console.log("pjsxtjbbModal")
        console.log(record)
        this.$refs.pjsxtjbbModal.init(record);
      },
      ...
      init () {
        ...
        this.loading = true
        putAction(this.url.init,{'sjrq':tjyfMoment}).then((res) => {
          if (res.success) {
