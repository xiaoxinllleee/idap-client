<template>
  <a-modal
    ...
    <div style="margin-bottom: 10px;">
      <a-button icon="download" type="primary" :loading="exportLoading" @click="handleExportXls('支行评级授信统计明细')">导出</a-button>
    </div>
    <a-table ref="table"
             size="middle"
             bordered
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/zhPjsxtjbb/zhPjsxtjbb/queryPageListMx",
          exportXlsUrl: "/zhPjsxtjbb/zhPjsxtjbb/exportZfsjmxXls",
        },
      }
    },
    created () {
