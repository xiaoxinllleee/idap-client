...
<!--      <a-button type="primary" icon="area-chart" @click="initData">提取</a-button>-->
  ...
  <span slot="xzc" slot-scope="xzc ,record" >
          <a @click="handlesszhEdit(record,'/tjfx/xdgtzyb1/xzcxdgt/XzcxdgtList')">{{xzc}}</a>
        </span>
    ...
    <!-- 表单区域 -->
    <zhxdgt-modal ref="modalForm" @ok="modalFormOk"></zhxdgt-modal>
  </a-card>
</template>

<script>
  import ZhxdgtModal from './modules/ZhxdgtModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/zhxdgt/zhxdgt/list",
          delete: "/zhxdgt/zhxdgt/delete",
          deleteBatch: "/zhxdgt/zhxdgt/deleteBatch",
          exportXlsUrl: "zhxdgt/zhxdgt/exportXls",
          importExcelUrl: "zhxdgt/zhxdgt/importExcel",
        },
      }
    },
    computed: {
