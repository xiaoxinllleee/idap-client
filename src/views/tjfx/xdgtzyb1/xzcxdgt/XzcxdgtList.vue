...
<!--      <a-button type="primary" icon="area-chart" @click="initData">提取</a-button>-->
      <a-button type="primary" icon="download" @click="handleExportXls('行政村挂图作业表1')">导出</a-button>
  ...
  <span slot="xzc" slot-scope="xzc ,record" >
          <a @click="handlesszhEdit(record,'/tjfx/xdgtzyb1/zgt/ZgtList')">{{xzc}}</a>
        </span>
    ...
    <!-- 表单区域 -->
    <xzcxdgt-modal ref="modalForm" @ok="modalFormOk"></xzcxdgt-modal>
  </a-card>
</template>

<script>
  import XzcxdgtModal from './modules/XzcxdgtModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/xzcxdgt/xzcxdgt/list",
          delete: "/xzcxdgt/xzcxdgt/delete",
          deleteBatch: "/xzcxdgt/xzcxdgt/deleteBatch",
          exportXlsUrl: "xzcxdgt/xzcxdgt/exportXls",
          importExcelUrl: "xzcxdgt/xzcxdgt/importExcel",
        },
      }
    },
    computed: {
