<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('客户授信用信_客户经理明细')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <tjfxKhsxyxtjKhjl-modal ref="modalForm" @ok="modalFormOk"></tjfxKhsxyxtjKhjl-modal>
  </a-card>
</template>
...
<script>
  ...
  import TjfxKhbkbpyZkhjlModal from '../../bkbpysjtj/khbkbpyzkhjl/modules/TjfxKhbkbpyZkhjlModal'
  export default {
    name: "TjfxKhsxyxtjKhjlList",
    ...
    data () {
      return {
		...
		url: {
          list: "/TjfxKhsxyxtjKhjl/tjfxKhsxyxtjKhjl/list",
          delete: "/TjfxKhsxyxtjKhjl/tjfxKhsxyxtjKhjl/delete",
          deleteBatch: "/TjfxKhsxyxtjKhjl/tjfxKhsxyxtjKhjl/deleteBatch",
          exportXlsUrl: "TjfxKhsxyxtjKhjl/tjfxKhsxyxtjKhjl/exportXls",
          importExcelUrl: "TjfxKhsxyxtjKhjl/tjfxKhsxyxtjKhjl/importExcel",
       },
    }
  },
  computed: {
