<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="统计月份">
              <a-month-picker v-model="queryParam.tjyf" :format="monthFormat"
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('组用信授信数据统计')">导出</a-button>
...
<span slot="sszh" slot-scope="sszh ,record">
          <a @click="handlesszhEdit(record,'/tjfx/sxsjmx/tjfx_khsxyxtj_dh/Tjfx_khsxyxtj_dhList')">{{sszh}}</a>
        </span>
    ...
    <!-- 表单区域 -->
    <tjfx_khsxyxtj_zmx-modal ref="modalForm" @ok="modalFormOk"></tjfx_khsxyxtj_zmx-modal>
  </a-card>
</template>

<script>
  import Tjfx_khsxyxtj_zmxModal from './modules/Tjfx_khsxyxtj_zmxModal'
  ...
  export default {
    name: 'Tjfx_khsxyxtj_zmxList',
    mixins: [JeecgListMixin],
    components: {
      Tjfx_khsxyxtj_zmxModal, JInput, JTreeSelect
    },
    data() {
      return {
        isAll: false,
        ...
        url: {
          list: '/tjfx_khsxyxtj_zmx/tjfx_khsxyxtj_zmx/list',
          delete: '/tjfx_khsxyxtj_zmx/tjfx_khsxyxtj_zmx/delete',
          deleteBatch: '/tjfx_khsxyxtj_zmx/tjfx_khsxyxtj_zmx/deleteBatch',
          exportXlsUrl: 'tjfx_khsxyxtj_zmx/tjfx_khsxyxtj_zmx/exportXls',
          importExcelUrl: 'tjfx_khsxyxtj_zmx/tjfx_khsxyxtj_zmx/importExcel'
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      handlesszhEdit: function(record, path) {
        ...
        this.$router.push({
          path: path,
          query: { sszh: record.sszh, tjyf: record.tjyf, xzc: record.xzc, xzz: record.xzz }
        })
      },
      moment,
      getCurrentMonth() {
