<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('行政村用信授信统计')">导出</a-button>
 ...
 <span slot="sszh" slot-scope="sszh ,record">
          <a @click="handlesszhEdit(record,'/tjfx/sxsjmx/tjfx_khsxyxtj_zmx/Tjfx_khsxyxtj_zmxList')">{{sszh}}</a>
        </span>
    ...
    <!-- 表单区域 -->
    <tjfx_khsxyxtj_xzc-modal ref="modalForm" @ok="modalFormOk"></tjfx_khsxyxtj_xzc-modal>
  </a-card>
</template>

<script>
  import Tjfx_khsxyxtj_xzcModal from './modules/Tjfx_khsxyxtj_xzcModal'
  ...
  export default {
    name: 'Tjfx_khsxyxtj_xzcList',
    mixins: [JeecgListMixin],
    components: {
      Tjfx_khsxyxtj_xzcModal, JInput, JTreeSelect
    },
    data() {
      return {
        isAll: false,
        ...
        url: {
          list: '/tjfx_khsxyxtj_xzc/tjfx_khsxyxtj_xzc/list',
          delete: '/tjfx_khsxyxtj_xzc/tjfx_khsxyxtj_xzc/delete',
          deleteBatch: '/tjfx_khsxyxtj_xzc/tjfx_khsxyxtj_xzc/deleteBatch',
          exportXlsUrl: 'tjfx_khsxyxtj_xzc/tjfx_khsxyxtj_xzc/exportXls',
          importExcelUrl: 'tjfx_khsxyxtj_xzc/tjfx_khsxyxtj_xzc/importExcel'
        }
      }
    },
    computed: {
