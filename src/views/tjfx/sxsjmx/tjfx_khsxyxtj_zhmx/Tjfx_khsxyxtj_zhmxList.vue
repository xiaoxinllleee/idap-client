<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('支行用信授信统计')">导出</a-button>
 ...
 <span slot="sszh" slot-scope="sszh ,record">
          <a @click="handlesszhEdit(record,'/tjfx/sxsjmx/tjfx_khsxyxtj_xzc/Tjfx_khsxyxtj_xzcList')">{{sszh}}</a>
        </span>
    ...
    <!-- 表单区域 -->
    <tjfx_khsxyxtj_zhmx-modal ref="modalForm" @ok="modalFormOk"></tjfx_khsxyxtj_zhmx-modal>
  </a-card>
</template>

<script>
  import Tjfx_khsxyxtj_zhmxModal from './modules/Tjfx_khsxyxtj_zhmxModal'
  ...
  export default {
    name: 'Tjfx_khsxyxtj_zhmxList',
    mixins: [JeecgListMixin],
    components: {
      Tjfx_khsxyxtj_zhmxModal, JInput, JTreeSelect
    },
    data() {
      return {
        isAll: false,
        ...
        url: {
          list: '/tjfx_khsxyxtj_zhmx/tjfx_khsxyxtj_zhmx/list',
          delete: '/tjfx_khsxyxtj_zhmx/tjfx_khsxyxtj_zhmx/delete',
          deleteBatch: '/tjfx_khsxyxtj_zhmx/tjfx_khsxyxtj_zhmx/deleteBatch',
          exportXlsUrl: 'tjfx_khsxyxtj_zhmx/tjfx_khsxyxtj_zhmx/exportXls',
          importExcelUrl: 'tjfx_khsxyxtj_zhmx/tjfx_khsxyxtj_zhmx/importExcel'
        }
      }
    },
    computed: {
