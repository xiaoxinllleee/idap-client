  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/TJFX_SHZFSJMX_KHJL/tjfx_shzfsjmx_khjl/list",
          delete: "/TJFX_SHZFSJMX_KHJL/tjfx_shzfsjmx_khjl/delete",
          deleteBatch: "/TJFX_SHZFSJMX_KHJL/tjfx_shzfsjmx_khjl/deleteBatch",
          exportXlsUrl: "TJFX_SHZFSJMX_KHJL/tjfx_shzfsjmx_khjl/exportXls",
          importExcelUrl: "TJFX_SHZFSJMX_KHJL/tjfx_shzfsjmx_khjl/importExcel",
       },
    }
  },
    computed: {
