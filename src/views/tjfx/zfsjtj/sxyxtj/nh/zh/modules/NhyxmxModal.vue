<template>
  <a-modal
    ...
    <div style="margin-bottom: 10px;">
      <a-button icon="download" type="primary" :loading="exportLoading" @click="handleExportXls('农户用信明细')">导出</a-button>
    </div>
    <a-table ref="table"
             size="middle"
             bordered
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/sxyxtj/nhyxmx/list",
          exportXlsUrl: "/sxyxtj/nhyxmx/exportNhyxmxXls"
        },
      }
    },
    methods: {
