<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" @click="handleExportXls('商户支行授信用信(累计)列表')" v-has="'shZhsxyxLj:exp'">导出</a-button>
  ...
  export default {
    ...
    methods: {
      ...
      getQueryParams() {
        ...
        var param = Object.assign({}, this.queryParam,this.filters,para);
      ...
      handleExportXls(fileName){
        ...
        if (this.queryParam.tjrq === undefined || this.queryParam.tjrq === "" || this.queryParam.tjrq == null) {
