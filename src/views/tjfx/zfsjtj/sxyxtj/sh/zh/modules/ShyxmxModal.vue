<template>
  <a-modal
    ...
    <div style="margin-bottom: 10px;">
      <a-button icon="download" type="primary" :loading="exportLoading" @click="handleExportXls('商户用信明细')">导出</a-button>
    </div>
    <a-table ref="table"
             size="middle"
             bordered
    ...
    data () {
      return {
        ...
        colunms: [
          ...
          { title: '合同号', dataIndex: 'hth' },
          { title: '发放日期', dataIndex: 'ffrq' },
          { title: '到期日期', dataIndex: 'dqrq' },
          { title: '贷款金额', dataIndex: 'dkje' },

        ],

        url: {
          list: "/sxyxtj/shyxmx/list",
          exportXlsUrl: "/sxyxtj/shyxmx/exportShyxmxXls"
        },
      }
    },
    methods: {
