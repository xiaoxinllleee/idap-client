<template>
  <a-modal
    ...
    <div style="margin-bottom: 10px;">
      <a-button icon="download" type="primary" :loading="exportLoading" @click="handleExportXls('商户授信明细')">导出</a-button>
    </div>
    <a-table ref="table"
             size="middle"
             bordered
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/sxyxtj/shsxmx/list",
          exportXlsUrl: "/sxyxtj/shsxmx/exportShsxmxXls"
        },
      }
    },
    methods: {
