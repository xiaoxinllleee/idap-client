<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" @click="handleExportXls('客户经理走访数据统计')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <khjlZfsjtj-modal ref="modalForm" @ok="modalFormOk"></khjlZfsjtj-modal>
  </a-card>
</template>

<script>
  import KhjlZfsjtjModal from './modules/KhjlZfsjtjModal'
    ...
    data () {
      return {
		...
		url: {
          ...
          exportXlsUrl: "/zfsjtj/khjlzfsjtj/exportXls",
