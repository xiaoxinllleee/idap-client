<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" @click="handleExportXls('支行汇总统计')" v-has="'Zhhztj:exp'">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/zfhztj/zhhztj/list",
          exportXlsUrl: "/zfhztj/zhhztj/exportXls",
        },
      }
    },
    watch: {
      radioValue(val) {
        ...
        if(val == '1') {
          ...
          this.url = {
            list: "/zfhztj/zhkhjlhztj/list",
            exportXlsUrl: "/zfhztj/zhkhjlhztj/exportXls",
          }
        }
        this.searchReset()
      }
    ...
    methods: {
      ...
      zfs(record,lx){
        ...
        console.log(record)
        console.log(lx+"lx")
        this.$refs.nhzfmxModal.init(record,lx,'ZH',null, this.hzfs,'1');
      },
      searchReset() {
      ...
      handleExportXls(fileName){
        ...
        let tjyf = ''
        let param = {...this.queryParam,khlx:this.khlx};
