        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8"><a-form-item label="统计年份">
            <a-select placeholder="请选择统计年份" v-model="queryParam.tjrq" :defaultValue="dateValue">
              <a-select-option v-for="(item, index) in years" :key="index" :value="item.value">{{ item.label }}</a-select-option>
            </a-select>
          </a-form-item></a-col>
...
<!--            </a-col>-->
    ...
    <div class="table-operator">
      <a-button icon="download" @click="handleExportXls('个人走访（年报）')" v-has="'GrzfNb:exp'">导出</a-button>
      <a-button icon="download" @click="handleExportMxXls('个人走访（年报明细）')" v-has="'GrzfNb:expMx'">导出明细</a-button>
    ...
    data () {
      return {
        ...
        url: {
          ...
          exportXlsUrl: "khjlzfyxtj/khjlZfyxtj/exportXlsnhnb",
