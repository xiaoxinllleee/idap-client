...
<!--          </a-col>-->
    ...
    <div class="table-operator">
      <a-button icon="download" @click="handleExportXls('网格走访（汇总）')" v-has="'WgzfHz:exp'">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/zfsjtj/wgzfsjtj/list",
          delete: "/zfsjtj/wgzfsjtj/delete",
          deleteBatch: "/zfsjtj/wgzfsjtj/deleteBatch",
          exportXlsUrl: "/zfsjtj/wgzfsjtj/exportXlsnhhz",
          importExcelUrl: "/zfsjtj/wgzfsjtj/importExcel",
          init: "khjlzfyxtj/wgzfsjtj/init",
    },
    }
  },
  computed: {
    ...
    methods: {
      ...
      zfs(record,lx){
        ...
        console.log(record)
        console.log(lx+"lx")
        this.$refs.nhzfmxModal.init(record,lx,'WG', null,null,'1');
      },
      getQueryParams() {
        let tjyfMoment = "";
