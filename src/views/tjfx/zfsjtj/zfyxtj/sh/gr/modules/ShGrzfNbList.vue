...
<!--            </a-col>-->
    ...
    <div class="table-operator">
      <a-button icon="download" @click="handleExportXls('个人走访（年报）')" v-has="'ShGrzfNb:exp'">导出</a-button>
      <a-button icon="download" @click="handleExportMxXls('个人走访（年报明细）')" v-has="'ShGrzf:expMx'">导出明细</a-button>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          ...
          exportXlsUrl: "khjlzfyxtj/khjlZfyxtj/exportXlsshnb",
    ...
    methods: {
      ...
      initMxParams() {
        ...
        let  tjyfMoment = this.queryParam.tjrq + '-01-01'
