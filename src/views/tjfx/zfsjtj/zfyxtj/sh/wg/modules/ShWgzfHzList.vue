<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" @click="handleExportXls('网格走访（汇总）')" v-has="'ShWgzfHz:exp'">导出</a-button>
    ...
    data () {
      return {
		...
		url: {
          ...
          exportXlsUrl: "/zfsjtj/wgzfsjtj/exportXlsshhz",
  ...
  computed: {
    ...
    methods: {
      ...
      zfs(record,lx){
        ...
        console.log(record)
        console.log(lx+"lx")
        this.$refs.shzfmxModal.init(record,lx,'WG', null, '1');
      },
