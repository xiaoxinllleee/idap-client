    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="会计日期">
          <a-input placeholder="请输入会计日期" v-decorator="['fiscalDate', validatorRules.fiscalDate]"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="发放金额（元）">
          <a-input placeholder="请输入发放金额（元）" v-decorator="['ffje', {}]"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        add: "/sgtzgl/dkffdjbW/add",
        edit: "/sgtzgl/dkffdjbW/edit",
      },
    }
  },
  created() {
  ...
  methods: {
    ...
    edit(record) {
      ...
      this.visible = true;
      this.$nextTick(() => {
        this.form.setFieldsValue(pick(this.model, 'fiscalDate', 'khjg', 'dkhm', 'zjhm', 'bmkkh', 'dkzh', 'cpmc', 'dbfs', 'jkrq', 'dqrq', 'll', 'fkzh', 'ffje', 'dyzrr', 'zkhjl', 'fkqd', 'dktx', 'dktx1', 'dktx2', 'qygm', 'dkqx'))
        //时间格式化
    ...
    handleOk() {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          let httpurl = '';
          let method = '';
          if (!this.model.fiscalDate && !this.model.dkzh) {
          ...
          //时间格式化
          //formData.fiscalDate = formData.fiscalDate ? formData.fiscalDate.format('YYYYMMDD') : null;
