    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="是否法人股东">
          <a-input placeholder="请输入是否法人股东" v-decorator="['sffrgd', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="合计数">
          <a-input placeholder="请输入合计数" v-decorator="['hjs', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="用信合计数">
          <a-input placeholder="请输入用信合计数" v-decorator="['yxhjs', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/jtkhtz/sgtzglJtkhtz/add",
          edit: "/jtkhtz/sgtzglJtkhtz/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'fiscalDate','zh','sffrgd','qymc','hjs','zjhm','yxhjs'))
		  //时间格式化
