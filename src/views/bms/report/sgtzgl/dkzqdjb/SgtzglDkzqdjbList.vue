<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('贷款展期登记簿')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <sgtzglDkzqdjb-modal ref="modalForm" @ok="modalFormOk"></sgtzglDkzqdjb-modal>
  </a-card>
</template>

<script>
  import SgtzglDkzqdjbModal from './modules/SgtzglDkzqdjbModal'
  ...
  export default {
    name: "SgtzglDkzqdjbList",
    mixins:[JeecgListMixin],
    components: {
      SgtzglDkzqdjbModal,ExcelImport,JTreeSelect
    },
    data () {
      return {
        description: '贷款展期登记簿管理页面',
        // 表头
		...
		url: {
          list: "/dkzqdjb/sgtzglDkzqdjb/list",
          delete: "/dkzqdjb/sgtzglDkzqdjb/delete",
          deleteBatch: "/dkzqdjb/sgtzglDkzqdjb/deleteBatch",
          deleteByBatch: "/dkzqdjb/sgtzglDkzqdjb/deleteByBatch",
          exportXlsUrl: "dkzqdjb/sgtzglDkzqdjb/exportXls",
          importExcelUrl: "dkzqdjb/sgtzglDkzqdjb/importExcel",
      exportTemplateUrl:"/dkzqdjb/sgtzglDkzqdjb/exportTemplateXls",
       },
        exportTemplateName: '贷款展期登记簿管理导入模板'
    }
  },
  computed: {
