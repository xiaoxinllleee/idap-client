    ...
    <a-tabs default-active-key="1" @change="chagwTabs">
      <a-tab-pane tab="人民币" key="1" :forceRender="true">
          ...
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              ...
              <template v-if="toggleSearchStatus">
                <a-col :xl="6" :lg="7" :md="8" :sm="24">
                  <a-form-item label="上年同期数">
                    <a-input placeholder="请输入上年同期数" v-model="queryParam.sntqs"></a-input>
                  </a-form-item>
                </a-col>
                <a-col :xl="6" :lg="7" :md="8" :sm="24">
                  <a-form-item label="本年累计数">
                    <a-input placeholder="请输入本年累计数" v-model="queryParam.bnljs"></a-input>
                  </a-form-item>
                </a-col>
              </template>
              <a-col :xl="6" :lg="7" :md="8" :sm="24">
        ...
        <div class="table-operator">
          ...
          <a-button icon="download" :loading="exportLoading" @click="handleExportXls('财务报表损益报表-人民币',1)">导出</a-button>
        ...
        <!-- 表单区域 -->
        <sgtzCwbbsybb-modal ref="modalForm" @ok="modalFormOk"></sgtzCwbbsybb-modal>
      </a-tab-pane>
      ...
      <a-tab-pane tab="外折人" key="2" :forceRender="true">
        ...
        <div class="table-operator">
          ...
          <a-button icon="download" :loading="exportLoading" @click="handleExportXls('财务报表损益报表-外折人',2)">导出</a-button>
      ...
      <a-tab-pane tab="本外币" key="3" :forceRender="true">
        ...
        <div class="table-operator">
          ...
          <a-button icon="download" :loading="exportLoading" @click="handleExportXls('财务报表损益报表-本外币',3)">导出</a-button>
...
<script>
import SgtzCwbbsybbModal from './modules/SgtzCwbbsybbModal'
...
export default {
  name: 'SgtzCwbbsybbList',
  mixins: [JeecgListMixin],
  components: {
    SgtzCwbbsybbModal,ExcelImport
  },
  data () {
    return {
      description: '财务报表损益报表管理页面',
      ...
      url: {
        list1: '/cwbbsybbRmb/sgtzCwxyssybRmb/list',
        delete1: '/cwbbsybbRmb/sgtzCwxyssybRmb/delete',
        deleteBatch1: '/cwbbsybbRmb/sgtzCwxyssybRmb/deleteBatch',
        deleteByBatch1: '/cwbbsybbRmb/sgtzCwxyssybRmb/deleteByBatch',
        exportXlsUrl1: '/cwbbsybbRmb/sgtzCwxyssybRmb/exportXls',
        importExcelUrl1: '/cwbbsybbRmb/sgtzCwxyssybRmb/importExcel',
        exportTemplateUrl1:"/cwbbsybbRmb/sgtzCwxyssybRmb/exportTemplateXls",

        list2: '/cwbbsybbWzrmb/sgtzCwxyssybWzrmb/list',
        delete2: '/cwbbsybbWzrmb/sgtzCwxyssybWzrmb/delete',
        deleteBatch2: '/cwbbsybbWzrmb/sgtzCwxyssybWzrmb/deleteBatch',
        deleteByBatch2: '/cwbbsybbWzrmb/sgtzCwxyssybWzrmb/deleteByBatch',
        exportXlsUrl2: '/cwbbsybbWzrmb/sgtzCwxyssybWzrmb/exportXls',
        importExcelUrl2: '/cwbbsybbWzrmb/sgtzCwxyssybWzrmb/importExcel',
        exportTemplateUrl2:"/cwbbsybbWzrmb/sgtzCwxyssybWzrmb/exportTemplateXls",

        list3: '/cwbbsybb/sgtzCwbbsybb/list',
        delete3: '/cwbbsybb/sgtzCwbbsybb/delete',
        deleteBatch3: '/cwbbsybb/sgtzCwbbsybb/deleteBatch',
        deleteByBatch3: '/cwbbsybb/sgtzCwbbsybb/deleteByBatch',
        exportXlsUrl3: 'cwbbsybb/sgtzCwbbsybb/exportXls',
        importExcelUrl3: 'cwbbsybb/sgtzCwbbsybb/importExcel',
        exportTemplateUrl3:"/cwbbsybb/sgtzCwbbsybb/exportTemplateXls",
