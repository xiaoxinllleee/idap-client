<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('贷款回收登记簿')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <sgtzglDkhsdjb-modal ref="modalForm" @ok="modalFormOk"></sgtzglDkhsdjb-modal>
  </a-card>
</template>

<script>
  import SgtzglDkhsdjbModal from './modules/SgtzglDkhsdjbModal'
  ...
  export default {
    name: "SgtzglDkhsdjbList",
    mixins:[JeecgListMixin],
    components: {
      SgtzglDkhsdjbModal,JTreeSelect,ExcelImport
    },
    data () {
      return {
		...
		url: {
          list: "/dkhsdjb/sgtzglDkhsdjb/list",
          delete: "/dkhsdjb/sgtzglDkhsdjb/delete",
          deleteBatch: "/dkhsdjb/sgtzglDkhsdjb/deleteBatch",
          deleteByBatch: "/dkhsdjb/sgtzglDkhsdjb/deleteByBatch",
          exportXlsUrl: "dkhsdjb/sgtzglDkhsdjb/exportXls",
          importExcelUrl: "dkhsdjb/sgtzglDkhsdjb/importExcel",
          exportTemplateUrl:"/dkhsdjb/sgtzglDkhsdjb/exportTemplateXls",
       },
        exportTemplateName: '贷款回收登记簿管理导入模板'
    }
  },
  computed: {
