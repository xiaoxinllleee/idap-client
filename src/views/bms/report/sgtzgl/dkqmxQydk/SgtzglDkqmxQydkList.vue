<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="会计日期">
                <a-date-picker placeholder="请选择会计日期" v-model="queryParam.fiscalDate"  :defaultValue="defaultMonthOpera"
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('贷款全明细_企业贷款')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <sgtzglDkqmxQydk-modal ref="modalForm" @ok="modalFormOk"></sgtzglDkqmxQydk-modal>
  </a-card>
</template>

<script>
  import SgtzglDkqmxQydkModal from './modules/SgtzglDkqmxQydkModal'
  ...
  export default {
    name: "SgtzglDkqmxQydkList",
    mixins:[JeecgListMixin],
    components: {
      SgtzglDkqmxQydkModal,JTreeSelect,ExcelImport
    },
    data () {
      return {
        description: '贷款全明细_企业贷款管理页面',
        // 表头
		...
		url: {
          list: "/dkqmxQydk/sgtzglDkqmxQydk/list",
          delete: "/dkqmxQydk/sgtzglDkqmxQydk/delete",
          deleteBatch: "/dkqmxQydk/sgtzglDkqmxQydk/deleteBatch",
          deleteByBatch: "/dkqmxQydk/sgtzglDkqmxQydk/deleteByBatch",
          exportXlsUrl: "dkqmxQydk/sgtzglDkqmxQydk/exportXls",
          importExcelUrl: "dkqmxQydk/sgtzglDkqmxQydk/importExcel",
          exportTemplateUrl:"/dkqmxQydk/sgtzglDkqmxQydk/exportTemplateXls",
        },
        exportTemplateName: '贷款全明细_企业贷款导入模板'
      }
    },
    computed: {
