    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
       ...
       <!-- <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="项目代号">
          <a-input placeholder="请输入项目代号" v-decorator="['xmdh1', {}]" />
        </a-form-item>-->
      </a-form>
    </a-spin>
  </a-modal>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add1: "/cwbbqkmbRmb/sgtzCwqkmbRmb/add",
          edit1: "/cwbbqkmbRmb/sgtzCwqkmbRmb/edit",
          add2: "/cwbbqkmbWzrmb/sgtzCwqkmbWzrmb/add",
          edit2: "/cwbbqkmbWzrmb/sgtzCwqkmbWzrmb/edit",
          add3: "/cwbbqkmb/sgtzCwbbqkmb/add",
          edit3: "/cwbbqkmb/sgtzCwbbqkmb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record,num) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sjrq','xmdh','xmmc','qcjfye','qcdfye','bqjffse','bqdffse','qmjfye','qmdfye','xmdh1'))
		  //时间格式化
