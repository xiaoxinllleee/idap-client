    ...
    <a-tabs default-active-key="1" @change="chagwTabs">
      <a-tab-pane tab="人民币" key="1" :forceRender="true">
          ...
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              ...
              <template v-if="toggleSearchStatus">
                ...
                <a-col :xl="6" :lg="7" :md="8" :sm="24">
                  <a-form-item label="项目代号">
                    <a-input placeholder="请输入项目代号" v-model="queryParam.xmdh1"></a-input>
                  </a-form-item>
                </a-col>
              </template>
              <a-col :xl="6" :lg="7" :md="8" :sm="24">
        ...
        <div class="table-operator">
          ...
          <a-button icon="download" :loading="exportLoading" @click="handleExportXls('财务报表全科目表-人民币',1)">导出</a-button>
...
<!--          </a-dropdown>-->
        ...
        <!-- 表单区域 -->
        <sgtzCwbbqkmb-modal ref="modalForm" @ok="modalFormOk"></sgtzCwbbqkmb-modal>
      </a-tab-pane>
      ...
      <a-tab-pane tab="外折人" key="2" :forceRender="true">
        ...
        <div class="table-operator">
          ...
          <a-button icon="download" :loading="exportLoading" @click="handleExportXls('财务报表全科目表-外折人',2)">导出</a-button>
...
<!--          </a-dropdown>-->
      ...
      <a-tab-pane tab="本外币" key="3" :forceRender="true">
        ...
        <div class="table-operator">
          ...
          <a-button icon="download" :loading="exportLoading" @click="handleExportXls('财务报表全科目表-本外币',3)">导出</a-button>
...
<script>
import SgtzCwbbqkmbModal from './modules/SgtzCwbbqkmbModal'
...
export default {
  name: 'SgtzCwbbqkmbList',
  mixins: [JeecgListMixin],
  components: {
    SgtzCwbbqkmbModal, ExcelImport
  },
  data () {
    return {
      description: '财务报表全科目表管理页面',
      ...
      url: {
        list1: '/cwbbqkmbRmb/sgtzCwqkmbRmb/list',
        delete1: '/cwbbqkmbRmb/sgtzCwqkmbRmb/delete',
        deleteBatch1: '/cwbbqkmbRmb/sgtzCwqkmbRmb/deleteBatch',
        deleteByBatch1: '/cwbbqkmbRmb/sgtzCwqkmbRmb/deleteByBatch',
        exportXlsUrl1: 'cwbbqkmbRmb/sgtzCwqkmbRmb/exportXls',
        importExcelUrl1: 'cwbbqkmbRmb/sgtzCwqkmbRmb/importExcel',
        exportTemplateUrl1:"/cwbbqkmbRmb/sgtzCwqkmbRmb/exportTemplateXls",

        list2: '/cwbbqkmbWzrmb/sgtzCwqkmbWzrmb/list',
        delete2: '/cwbbqkmbWzrmb/sgtzCwqkmbWzrmb/delete',
        deleteBatch2: '/cwbbqkmbWzrmb/sgtzCwqkmbWzrmb/deleteBatch',
        deleteByBatch2: '/cwbbqkmbWzrmb/sgtzCwqkmbWzrmb/deleteByBatch',
        exportXlsUrl2: 'cwbbqkmbWzrmb/sgtzCwqkmbWzrmb/exportXls',
        importExcelUrl2: 'cwbbqkmbWzrmb/sgtzCwqkmbWzrmb/importExcel',
        exportTemplateUrl2:"/cwbbqkmbWzrmb/sgtzCwqkmbWzrmb/exportTemplateXls",

        list3: '/cwbbqkmb/sgtzCwbbqkmb/list',
        delete3: '/cwbbqkmb/sgtzCwbbqkmb/delete',
        deleteBatch3: '/cwbbqkmb/sgtzCwbbqkmb/deleteBatch',
        deleteByBatch3: '/cwbbqkmb/sgtzCwbbqkmb/deleteByBatch',
        exportXlsUrl3: 'cwbbqkmb/sgtzCwbbqkmb/exportXls',
        importExcelUrl3: 'cwbbqkmb/sgtzCwbbqkmb/importExcel',
        exportTemplateUrl3:"/cwbbqkmb/sgtzCwbbqkmb/exportTemplateXls",
      }
    }
  },
  computed: {
 ...
 /*     params.exportTemplateUrl = this.url.exportTemplateUrl
      ...
      if (num==1){
        if (this.queryParam.sjrq == undefined || this.queryParam.sjrq == '') {
          ...
          this.exportTemplateName = '财务报表全科目表-人民币导入模板'
        }
      }else if (num==2){
        if (this.queryParam.sjrq == undefined || this.queryParam.sjrq == '') {
          this.$message.error("请选择数据日期!")
          ...
          this.exportTemplateName = '财务报表全科目表-外折人导入模板'
        }
      }else{
        if (this.queryParam.sjrq == undefined || this.queryParam.sjrq == '') {
          this.$message.error("请选择数据日期!")
          ...
          this.exportTemplateName = '财务报表全科目表-本外币导入模板'
        }
      }
