    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="技术领域一级">
          <a-input placeholder="请输入技术领域一级" v-decorator="['jslyyj', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="行政区域">
          <a-input placeholder="请输入行政区域" v-decorator="['xzqy', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="证书编号">
          <a-input placeholder="请输入证书编号" v-decorator="['zsbh', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="异动情况">
          <a-input placeholder="请输入异动情况" v-decorator="['ydqk', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/hngxjsqymd/sgztHngxjsqymd/add",
          edit: "/hngxjsqymd/sgztHngxjsqymd/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'xh','fiscalDate','qymc','jslyyj','xzqy','tyshxydm','zsbh','nd','ydqk'))
		  //时间格式化
