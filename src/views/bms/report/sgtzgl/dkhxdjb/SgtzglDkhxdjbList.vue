<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('贷款核销登记簿')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <sgtzglDkhxdjb-modal ref="modalForm" @ok="modalFormOk"></sgtzglDkhxdjb-modal>
  </a-card>
</template>

<script>
  import SgtzglDkhxdjbModal from './modules/SgtzglDkhxdjbModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import SgtzglDkxttzdjbModal from '@views/bms/report/sgtzgl/dkxttzdjb/modules/SgtzglDkxttzdjbModal'
  ...
  export default {
    name: "SgtzglDkhxdjbList",
    mixins:[JeecgListMixin],
    components: {
      SgtzglDkhxdjbModal,ExcelImport,JTreeSelect
    },
    data () {
      return {
        description: '贷款核销登记簿管理页面',
        // 表头
        // 表头
		...
		url: {
          list: "/dkhxdjb/sgtzglDkhxdjb/list",
          delete: "/dkhxdjb/sgtzglDkhxdjb/delete",
          deleteBatch: "/dkhxdjb/sgtzglDkhxdjb/deleteBatch",
          deleteByBatch: "/dkhxdjb/sgtzglDkhxdjb/deleteByBatch",
          exportXlsUrl: "dkhxdjb/sgtzglDkhxdjb/exportXls",
          importExcelUrl: "dkhxdjb/sgtzglDkhxdjb/importExcel",
          exportTemplateUrl:"/dkhxdjb/sgtzglDkhxdjb/exportTemplateXls",
       },
          exportTemplateName: '贷款核销登记簿管理导入模板'
    }
  },
  computed: {
