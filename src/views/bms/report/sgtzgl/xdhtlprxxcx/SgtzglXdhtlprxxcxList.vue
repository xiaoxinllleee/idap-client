<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('信贷合同LPR信息查询')">导出</a-button>
    ...
    <sgtzglXdhtlprxxcx-modal ref="modalForm" @ok="modalFormOk"></sgtzglXdhtlprxxcx-modal>
  </a-card>
</template>

<script>
import SgtzglXdhtlprxxcxModal from './modules/SgtzglXdhtlprxxcxModal'
...
export default {
  name: 'SgtzglXdhtlprxxcxList',
  mixins: [JeecgListMixin],
  components: {
    SgtzglXdhtlprxxcxModal, ExcelImport,JTreeSelect
  },
  data () {
    return {
      description: '信贷合同LPR信息查询管理页面',
      // 表头
      ...
      url: {
        list: '/xdhtlprxxcx/sgtzglXdhtlprxxcx/list',
        delete: '/xdhtlprxxcx/sgtzglXdhtlprxxcx/delete',
        deleteBatch: '/xdhtlprxxcx/sgtzglXdhtlprxxcx/deleteBatch',
        deleteByBatch: '/xdhtlprxxcx/sgtzglXdhtlprxxcx/deleteByBatch',
        exportXlsUrl: 'xdhtlprxxcx/sgtzglXdhtlprxxcx/exportXls',
        importExcelUrl: 'xdhtlprxxcx/sgtzglXdhtlprxxcx/importExcel',
        exportTemplateUrl: '/xdhtlprxxcx/sgtzglXdhtlprxxcx/exportTemplateXls'
      },
      exportTemplateName: '信贷合同LPR信息查询导入模板'
    }
  },
  computed: {
