<template>
  <a-card :bordered='false'>
    ...
    <!-- 表单区域 -->
    <sgtzgl-dkqmx-gtgsh-modal ref='modalForm' @ok='modalFormOk'></sgtzgl-dkqmx-gtgsh-modal>
  </a-card>
</template>

<script>
import SgtzglDkqmxGtgshModal from '@views/bms/report/sgtzgl/dkqmxGtgsh/modules/SgtzglDkqmxGtgshModal'
...
export default {
  name: 'SgtzglDkqmxGtgshList',
  mixins: [JeecgListMixin],
  components: {
    SgtzglDkqmxGtgshModal, ExcelImport, JTreeSelect, moment
  },
  data() {
    return {
      description: '贷款全明细-个体工商户管理页面',
      // 表头
      ...
      url: {
        list: '/dkqmx/sgtzglDkqmxGtgsh/list',
        delete: '/dkqmx/sgtzglDkqmxGtgsh/delete',
        deleteBatch: '/dkqmx/sgtzglDkqmxGtgsh/deleteBatch',
        deleteByBatch: '/dkqmx/sgtzglDkqmxGtgsh/deleteByBatch',
        exportXlsUrl: 'dkqmx/sgtzglDkqmxGtgsh/exportXls',
        importExcelUrl: 'dkqmx/sgtzglDkqmxGtgsh/importExcel',
        exportTemplateUrl: '/dkqmx/sgtzglDkqmxGtgsh/exportTemplateXls'
      },
      exportTemplateName: '贷款全明细-个体工商户导入模板'
    }
  },
  computed: {
