<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="发生额">
              <a-input placeholder="请输入发生额" v-model="queryParam.fse"></a-input>
            </a-form-item>
          </a-col>
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('回购业务明细')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <sgtzglHgywmxb-modal ref="modalForm" @ok="modalFormOk"></sgtzglHgywmxb-modal>
  </a-card>
</template>

<script>
  import SgtzglHgywmxbModal from './SgtzglHgywmxbModal'
  ...
  export default {
    name: "SgtzglHgywmxbList",
    mixins:[JeecgListMixin],
    components: {
      SgtzglHgywmxbModal,ExcelImport
    },
    data () {
      return {
        description: '手工台账-回购业务明细表管理页面',
        // 表头
		...
		url: {
          list: "/Hgywmxb/sgtzglHgywmxb/list",
          delete: "/Hgywmxb/sgtzglHgywmxb/delete",
          deleteBatch: "/Hgywmxb/sgtzglHgywmxb/deleteBatch",
          deleteByBatch: "/Hgywmxb/sgtzglHgywmxb/deleteByBatch",
          exportXlsUrl: "Hgywmxb/sgtzglHgywmxb/exportXls",
          importExcelUrl: "Hgywmxb/sgtzglHgywmxb/importExcel",
          exportTemplateUrl: "Hgywmxb/sgtzglHgywmxb/exportTemplateXls",
    },
        exportTemplateName: '回购业务明细导入模板'
    }
  },
  computed: {
