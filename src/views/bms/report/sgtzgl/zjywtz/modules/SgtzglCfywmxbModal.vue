    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="账面余额">
          <a-input placeholder="请输入账面余额" v-decorator="['zmye', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/Cfywmxb/sgtzglCfywmxb/add",
          edit: "/Cfywmxb/sgtzglCfywmxb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'fiscalDate','km','xh','zmye','jyds','jydsjgpj','qx','dqr','wjfl','jzzb','zzspr','bhfxpgjg'))
		  //时间格式化
        });
