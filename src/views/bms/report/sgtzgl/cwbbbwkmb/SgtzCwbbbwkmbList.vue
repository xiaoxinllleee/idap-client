<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('财务报表表外科目表-人民币',1)">导出</a-button>
      <a-button icon="import" @click="excelImport(1)">导入</a-button>
      <a-button @click="handleDelete1(1)" icon="delete">删除</a-button>
      <a-dropdown v-if="selectedRowKeys.length > 0">
        <a-menu slot="overlay">
          <a-menu-item key="1" @click="batchDel(1)"><a-icon type="delete"/>删除</a-menu-item>
        </a-menu>
    ...
    <!-- 表单区域 -->
        <sgtzCwbbbwkmb-modal ref="modalForm" @ok="modalFormOk"></sgtzCwbbbwkmb-modal>
      </a-tab-pane>
      ...
      <a-tab-pane tab="外折人" key="2" :forceRender="true">
        ...
        <div class="table-operator">
          ...
          <a-button icon="download" :loading="exportLoading" @click="handleExportXls('财务报表表外科目表-外折人',2)">导出</a-button>
          <a-button icon="import" @click="excelImport(2)">导入</a-button>
          <a-button @click="handleDelete1(2)" icon="delete">删除</a-button>
          <a-dropdown v-if="selectedRowKeys.length > 0">
            <a-menu slot="overlay">
              <a-menu-item key="1" @click="batchDel(2)"><a-icon type="delete"/>删除</a-menu-item>
            </a-menu>
            <a-button style="margin-left: 8px"> 批量操作 <a-icon type="down" /></a-button>
          </a-dropdown>
        </div>
      ...
      <a-tab-pane tab="本外币" key="3" :forceRender="true">
        ...
        <div class="table-operator">
          ...
          <a-button icon="download" :loading="exportLoading" @click="handleExportXls('财务报表表外科目表-本外币',3)">导出</a-button>
          <a-button icon="import" @click="excelImport(3)">导入</a-button>
          <a-button @click="handleDelete1(3)" icon="delete">删除</a-button>
          <a-dropdown v-if="selectedRowKeys.length > 0">
            <a-menu slot="overlay">
              <a-menu-item key="1" @click="batchDel(3)"><a-icon type="delete"/>删除</a-menu-item>
            </a-menu>
            <a-button style="margin-left: 8px"> 批量操作 <a-icon type="down" /></a-button>
          </a-dropdown>
        </div>
...
<script>
  import SgtzCwbbbwkmbModal from './modules/SgtzCwbbbwkmbModal'
  ...
  export default {
    name: "SgtzCwbbbwkmbList",
    mixins:[JeecgListMixin],
    components: {
      SgtzCwbbbwkmbModal,ExcelImport
    },
    data () {
      return {
        description: '财务报表表外科目表管理页面',
		...
		url: {
          list1: "/cwbbbwkmbRmb/sgtzcwbwkmbRmb/list",
          delete1: "/cwbbbwkmbRmb/sgtzcwbwkmbRmb/delete",
          deleteBatch1: "/cwbbbwkmbRmb/sgtzcwbwkmbRmb/deleteBatch",
          deleteByBatch1: "/cwbbbwkmbRmb/sgtzcwbwkmbRmb/deleteByBatch",
          exportXlsUrl1: "cwbbbwkmbRmb/sgtzcwbwkmbRmb/exportXls",
          importExcelUrl1: "cwbbbwkmbRmb/sgtzcwbwkmbRmb/importExcel",
          exportTemplateUrl1:"/cwbbbwkmbRmb/sgtzcwbwkmbRmb/exportTemplateXls",

          list2: "/cwbbbwkmbWzrmb/sgtzcwbwkmbWzrmb/list",
          delete2: "/cwbbbwkmbWzrmb/sgtzcwbwkmbWzrmb/delete",
          deleteBatch2: "/cwbbbwkmbWzrmb/sgtzcwbwkmbWzrmb/deleteBatch",
          deleteByBatch2: "/cwbbbwkmbWzrmb/sgtzcwbwkmbWzrmb/deleteByBatch",
          exportXlsUrl2: "cwbbbwkmbWzrmb/sgtzcwbwkmbWzrmb/exportXls",
          importExcelUrl2: "cwbbbwkmbWzrmb/sgtzcwbwkmbWzrmb/importExcel",
          exportTemplateUrl2:"/cwbbbwkmbWzrmb/sgtzcwbwkmbWzrmb/exportTemplateXls",

          list3: "/cwbbbwkmb/sgtzCwbbbwkmb/list",
          delete3: "/cwbbbwkmb/sgtzCwbbbwkmb/delete",
          deleteBatch3: "/cwbbbwkmb/sgtzCwbbbwkmb/deleteBatch",
          deleteByBatch3: "/cwbbbwkmb/sgtzCwbbbwkmb/deleteByBatch",
          exportXlsUrl3: "cwbbbwkmb/sgtzCwbbbwkmb/exportXls",
          importExcelUrl3: "cwbbbwkmb/sgtzCwbbbwkmb/importExcel",
          exportTemplateUrl3:"/cwbbbwkmb/sgtzCwbbbwkmb/exportTemplateXls",
       },
    }
  },
  computed: {
    ...
    methods: {
      ...
      excelImport(num) {
        ...
        /*     params.exportTemplateUrl = this.url.exportTemplateUrl
             params.importExcelUrl = `${window._CONFIG['domianURL']}/${this.url.importExcelUrl}?bzlx=${num}`*/
        if (num==1){
          if (this.queryParam.sjrq == undefined || this.queryParam.sjrq == '') {
            ...
            this.exportTemplateName = '财务报表表外科目表-人民币导入模板'
          }
        }else if (num==2){
          if (this.queryParam.sjrq == undefined || this.queryParam.sjrq == '') {
            this.$message.error("请选择数据日期!")
            ...
            this.exportTemplateName = '财务报表表外科目表-外折人导入模板'
          }
        }else{
          if (this.queryParam.sjrq == undefined || this.queryParam.sjrq == '') {
            this.$message.error("请选择数据日期!")
            ...
            this.exportTemplateName = '财务报表表外科目表-本外币导入模板'
          }
        }
