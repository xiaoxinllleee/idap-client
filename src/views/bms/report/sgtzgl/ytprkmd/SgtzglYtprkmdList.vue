<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('已脱贫人口名单')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <sgtzglYtprkmd-modal ref="modalForm" @ok="modalFormOk"></sgtzglYtprkmd-modal>
  </a-card>
</template>

<script>
  import SgtzglYtprkmdModal from './modules/SgtzglYtprkmdModal'
  ...
  export default {
    name: "SgtzglYtprkmdList",
    mixins:[JeecgListMixin],
    components: {
      SgtzglYtprkmdModal,ExcelImport
    },
    data () {
      return {
        description: '已脱贫人口名单管理页面',
        // 表头
		...
		url: {
          list: "/ytprkmd/sgtzglYtprkmd/list",
          delete: "/ytprkmd/sgtzglYtprkmd/delete",
          deleteBatch: "/ytprkmd/sgtzglYtprkmd/deleteBatch",
          deleteByBatch: "/ytprkmd/sgtzglYtprkmd/deleteByBatch",
          exportXlsUrl: "ytprkmd/sgtzglYtprkmd/exportXls",
          importExcelUrl: "ytprkmd/sgtzglYtprkmd/importExcel",
          exportTemplateUrl:"/ytprkmd/sgtzglYtprkmd/exportTemplateXls",
       },
          exportTemplateName: '已脱贫人口名单导入模板'
    }
  },
  computed: {
