    ...
    <a-tabs default-active-key="1" @change="chagwTabs">
      <a-tab-pane tab="人民币" key="1" :forceRender="true">
        ...
        <div class="table-page-search-wrapper">
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              ...
              <a-col :xl="6" :lg="7" :md="8" :sm="24">
                <a-form-item label="资产期末余额">
                  <a-input placeholder="请输入资产期末余额" v-model="queryParam.zcqmye"></a-input>
                </a-form-item>
              </a-col>
              <template v-if="toggleSearchStatus">
                <a-col :xl="6" :lg="7" :md="8" :sm="24">
                  <a-form-item label="资产年初余额">
                    <a-input placeholder="请输入资产年初余额" v-model="queryParam.zcncye"></a-input>
                  </a-form-item>
                </a-col>
              </template>
              <a-col :xl="6" :lg="7" :md="8" :sm="24">
        ...
        <div class="table-operator">
          ...
          <a-button icon="download" :loading="exportLoading" @click="handleExportXls('财务报表资产负债表-人民币',1)">导出</a-button>
        ...
        <!-- 表单区域 -->
        <sgtzglCwbbzcfzb-modal ref="modalForm" @ok="modalFormOk"></sgtzglCwbbzcfzb-modal>
      ...
      <a-tab-pane tab="外折人" key="2" :forceRender="true">
            ...
            <a-row :gutter="24">
              ...
              <a-col :xl="6" :lg="7" :md="8" :sm="24">
                <a-form-item label="期末余额">
                  <a-input placeholder="请输入期末余额" v-model="queryParam.qmye"></a-input>
                </a-form-item>
              </a-col>
              <template v-if="toggleSearchStatus">
                <a-col :xl="6" :lg="7" :md="8" :sm="24">
                  <a-form-item label="年初余额">
                    <a-input placeholder="请输入年初余额" v-model="queryParam.ncye"></a-input>
                  </a-form-item>
                </a-col>
              </template>
              <a-col :xl="6" :lg="7" :md="8" :sm="24">
        ...
        <div class="table-operator">
          ...
          <a-button icon="download" :loading="exportLoading" @click="handleExportXls('财务报表资产负债表-外折人',2)">导出</a-button>
      ...
      <a-tab-pane tab="本外币" key="3" :forceRender="true">
        ...
        <div class="table-operator">
          ...
          <a-button icon="download" :loading="exportLoading" @click="handleExportXls('财务报表资产负债表-本外币',3)">导出</a-button>
...
<script>
import SgtzglCwbbzcfzbModal from './modules/SgtzglCwbbzcfzbModal'
...
export default {
  name: 'SgtzglCwbbzcfzbList',
  mixins: [JeecgListMixin],
  components: {
    SgtzglCwbbzcfzbModal, ExcelImport
  },
  data () {
    return {
      ...
      url: {
        list1: '/cwbbzcfzbRmb/sgtzCwxyszcfzbRmb/list',
        delete1: '/cwbbzcfzbRmb/sgtzCwxyszcfzbRmb/delete',
        deleteBatch1: '/cwbbzcfzbRmb/sgtzCwxyszcfzbRmb/deleteBatch',
        deleteByBatch1: '/cwbbzcfzbRmb/sgtzCwxyszcfzbRmb/deleteByBatch',
        exportXlsUrl1: '/cwbbzcfzbRmb/sgtzCwxyszcfzbRmb/exportXls',
        importExcelUrl1: '/cwbbzcfzbRmb/sgtzCwxyszcfzbRmb/importExcel',
        exportTemplateUrl1: '/cwbbzcfzbRmb/sgtzCwxyszcfzbRmb/exportTemplateXls',

        list2: '/cwbbzcfzbWzrmb/sgtzCwxyszcfzbWzrmb/list',
        delete2: '/cwbbzcfzbWzrmb/sgtzCwxyszcfzbWzrmb/delete',
        deleteBatch2: '/cwbbzcfzbWzrmb/sgtzCwxyszcfzbWzrmb/deleteBatch',
        deleteByBatch2: '/cwbbzcfzbWzrmb/sgtzCwxyszcfzbWzrmb/deleteByBatch',
        exportXlsUrl2: '/cwbbzcfzbWzrmb/sgtzCwxyszcfzbWzrmb/exportXls',
        importExcelUrl2: '/cwbbzcfzbWzrmb/sgtzCwxyszcfzbWzrmb/importExcel',
        exportTemplateUrl2: '/cwbbzcfzbWzrmb/sgtzCwxyszcfzbWzrmb/exportTemplateXls',

        list3: '/cwbbzcfzb/sgtzglCwbbzcfzb/list',
        delete3: '/cwbbzcfzb/sgtzglCwbbzcfzb/delete',
        deleteBatch3: '/cwbbzcfzb/sgtzglCwbbzcfzb/deleteBatch',
        deleteByBatch3: '/cwbbzcfzb/sgtzglCwbbzcfzb/deleteByBatch',
        exportXlsUrl3: 'cwbbzcfzb/sgtzglCwbbzcfzb/exportXls',
        importExcelUrl3: 'cwbbzcfzb/sgtzglCwbbzcfzb/importExcel',
        exportTemplateUrl3: '/cwbbzcfzb/sgtzglCwbbzcfzb/exportTemplateXls',
      }
    }
  },
  computed: {
    ...
    excelImport(num) {
      ...
      if (num==1){
        if (this.queryParam.sjrq == undefined || this.queryParam.sjrq == '') {
          ...
          this.exportTemplateName = '财务报表损益报表-人民币导入模板'
        }
      }else if (num==2){
        if (this.queryParam.sjrq == undefined || this.queryParam.sjrq == '') {
          this.$message.error("请选择数据日期!")
          ...
          this.exportTemplateName = '财务报表损益报表-外折人导入模板'
        }
      }else{
        if (this.queryParam.sjrq == undefined || this.queryParam.sjrq == '') {
          this.$message.error("请选择数据日期!")
          ...
          this.exportTemplateName = '财务报表损益报表-本外币导入模板'
        }
      }
