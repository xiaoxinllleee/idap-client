...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('个人商业用房按揭')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <sgtzGrsyyfaj-modal ref="modalForm" @ok="modalFormOk"></sgtzGrsyyfaj-modal>
  </a-card>
</template>

<script>
  import SgtzGrsyyfajModal from './modules/SgtzGrsyyfajModal'
  ...
  export default {
    name: "SgtzGrsyyfajList",
    mixins:[JeecgListMixin],
    components: {
      SgtzGrsyyfajModal,ExcelImport,JTreeSelect,moment
    },
    data () {
      return {
        description: '个人商业用房按揭管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        defaultMonthOpera: '',
        rq:'',
		...
		url: {
          list: "/sgtzgrsyyfaj/sgtzGrsyyfaj/list",
          delete: "/sgtzgrsyyfaj/sgtzGrsyyfaj/delete",
          deleteBatch: "/sgtzgrsyyfaj/sgtzGrsyyfaj/deleteBatch",
          deleteByBatch: "/sgtzgrsyyfaj/sgtzGrsyyfaj/deleteByBatch",
          exportXlsUrl: "sgtzgrsyyfaj/sgtzGrsyyfaj/exportXls",
          importExcelUrl: "sgtzgrsyyfaj/sgtzGrsyyfaj/importExcel",
          exportTemplateUrl:"/sgtzgrsyyfaj/sgtzGrsyyfaj/exportTemplateXls",
       },
          exportTemplateName: '个人商业用房按揭导入模板'
    }
  },
  computed: {
