    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="票据类别">
          <a-input placeholder="请输入票据类别" v-decorator="['pjlb', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="基准日期">
          <a-date-picker v-decorator="[ 'jzrq', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="承兑人证件代码">
          <a-input placeholder="请输入承兑人证件代码" v-decorator="['cdrzjdm', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="贴现申请人">
          <a-input placeholder="请输入贴现申请人" v-decorator="['txsqr', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="成交日">
          <a-input placeholder="请输入成交日" v-decorator="['cjr', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="结算日">
          <a-input placeholder="请输入结算日" v-decorator="['jsr', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="基础数据票据编号">
          <a-input placeholder="请输入基础数据票据编号" v-decorator="['jcsjpjbh', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/ztxdjb/ztxdjb/add",
          edit: "/ztxdjb/ztxdjb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'pjjz','pjlb','pjjemz','syts','cpr','cprzjhm','cdr','cdrzjdm','txsqr','yflx','jsje','cjr','jsr','jcsjpjbh'))
		  //时间格式化
