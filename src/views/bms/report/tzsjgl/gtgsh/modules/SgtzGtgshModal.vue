    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item
          ...
          label="数据日期">
          <a-date-picker v-decorator="[ 'sjrq', {}]" :disabled="disabled"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
...
export default {
  ...
  data () {
    return {
      ...
      url: {
        add: '/gtgsh/sgtzGtgsh/add',
        edit: '/gtgsh/sgtzGtgsh/edit'
      }
    }
  },
  created () {
    ...
    handleOk () {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          //时间格式化
          //formData.fiscalDate = formData.sjrq ? formData.sjrq.format() : null
