<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="业务类别">
              <a-input placeholder="请输入业务类别" v-model="queryParam.ywlx"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="交易日">
              <a-input placeholder="请输入交易日" v-model="queryParam.jyrq"></a-input>
            </a-form-item>
          </a-col>
        <template v-if="toggleSearchStatus">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="质押券账面价值（元）">
              <a-input placeholder="请输入质押券账面价值" v-model="queryParam.zmjz"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="到期日">
              <a-date-picker placeholder="请输入到期日" v-model="queryParam.dqr" style="width: 100%;"/>
            </a-form-item>
          </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('湘潭同业融入融出')">导出</a-button>
      <!--<a-upload v-show="isCanExP" name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
    ...
    <!-- 表单区域 -->
    <xttyrrrc-modal ref="modalForm" @ok="modalFormOk"></xttyrrrc-modal>
  </a-card>
</template>

<script>
  import XttyrrrcModal from './modules/XttyrrrcModal'
  ...
  export default {
    ...
    components: {
      XttyrrrcModal,ExcelImport
    },
    data () {
      return {
        description: '湘潭同业融入融出管理页面',
        // 表头
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        defaultMonthOpera: '',
		...
		url: {
          list: "/xttyrrrc/xttyrrrc/list",
          delete: "/xttyrrrc/xttyrrrc/delete",
          deleteBatch: "/xttyrrrc/xttyrrrc/deleteBatch",
          exportXlsUrl: "xttyrrrc/xttyrrrc/exportXls",
          importExcelUrl: "xttyrrrc/xttyrrrc/importExcel",
          exportTemplateUrl: "xttyrrrc/xttyrrrc/exportTemplateXls",
       },
        exportTemplateName: '同业融入融出导入模板'
    }
  },
  computed: {
    ...
    methods: {
      ...
      getQueryParams() {
        ...
        if (this.queryParam.dqr) {
          dqr = this.queryParam.dqr.format("YYYY-MM-DD");
        }
