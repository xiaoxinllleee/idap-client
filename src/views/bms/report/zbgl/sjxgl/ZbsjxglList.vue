<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('指标数据项管理')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <zbsjxgl-modal ref="modalForm" @ok="modalFormOk"></zbsjxgl-modal>
    <excel-import ref="excelImportModal" @ok="importComplete"/>
  </a-card>
</template>

<script>
import ZbsjxglModal from './modules/ZbsjxglModal'
...
export default {
  ...
  components: {
    ZbsjxglModal,ExcelImport
  },
  data() {
    return {
      description: '指标数据项管理管理页面',
      // 表头
      columns: [
        {
          title: '#',
      ...
      url: {
        list: "/zbgl/zbsjxgl/list",
        delete: "/zbgl/zbsjxgl/delete",
        deleteBatch: "/zbgl/zbsjxgl/deleteBatch",
        exportXlsUrl: "zbgl/zbsjxgl/exportXls",
        importExcelUrl: "zbgl/zbsjxgl/importExcel",
        exportTemplateUrl: "/zbgl/zbsjxgl/exportTemplateXls",
      },
