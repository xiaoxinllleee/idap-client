<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('财务报表-业务状况表')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <ywzkb-modal ref="modalForm" @ok="modalFormOk"></ywzkb-modal>
  </a-card>
</template>

<script>
  import YwzkbModal from './modules/YwzkbModal'
  ...
  export default {
    ...
    components: {
      YwzkbModal,ExcelImport
    },
    data () {
      return {
        description: '财务报表-业务状况表管理页面',
        // 表头
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        defaultMonthOpera: '',
		...
		url: {
          list: "/cwbb/ywzkb/list",
          delete: "/cwbb/ywzkb/delete",
          deleteBatch: "/cwbb/ywzkb/deleteBatch",
          exportXlsUrl: "cwbb/ywzkb/exportXls",
          importExcelUrl: "cwbb/ywzkb/importExcel",
          exportTemplateUrl: "/cwbb/ywzkb/exportTemplateXls",
       },
        exportTemplateName: '业务状况表导入模板'
    }
  },
  computed: {
