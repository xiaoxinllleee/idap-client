<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('表外科目表')">导出</a-button><!--
    ...
    <!-- 表单区域 -->
    <bwkmb-modal ref="modalForm" @ok="modalFormOk"></bwkmb-modal>
  </a-card>
</template>

<script>
  import BwkmbModal from './modules/BwkmbModal'
  ...
  export default {
    ...
    components: {
      BwkmbModal,ExcelImport
    },
    data () {
      return {
        description: '表外科目表管理页面',
        // 表头
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        defaultMonthOpera: '',
		...
		url: {
          list: "/bwkmb/bwkmb/list",
          delete: "/bwkmb/bwkmb/delete",
          deleteBatch: "/bwkmb/bwkmb/deleteBatch",
          exportXlsUrl: "bwkmb/bwkmb/exportXls",
          importExcelUrl: "bwkmb/bwkmb/importExcel",
          exportTemplateUrl: "bwkmb/bwkmb/exportTemplateXls",
       },
        exportTemplateName: '表外科目表导入模板'
    }
  },
  computed: {
