<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('信用社损益表')">导出</a-button>
    <!--  <a-upload name="file" v-show="isCanExP" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
    ...
    <!-- 表单区域 -->
    <xyssyb-modal ref="modalForm" @ok="modalFormOk"></xyssyb-modal>
  </a-card>
</template>

<script>
  import XyssybModal from './modules/XyssybModal'
  ...
  export default {
    ...
    components: {
      XyssybModal,ExcelImport
    },
    data () {
      return {
        description: '信用社损益表管理页面',
        // 表头
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        defaultMonthOpera: '',
		...
		url: {
          list: "/xyssyb/xyssyb/list",
          delete: "/xyssyb/xyssyb/delete",
          deleteBatch: "/xyssyb/xyssyb/deleteBatch",
          exportXlsUrl: "xyssyb/xyssyb/exportXls",
          importExcelUrl: "xyssyb/xyssyb/importExcel",
          exportTemplateUrl: "/xyssyb/xyssyb/exportTemplateXls",
       },
        exportTemplateName: '信用社损益表导入模板'
    }
  },
  computed: {
