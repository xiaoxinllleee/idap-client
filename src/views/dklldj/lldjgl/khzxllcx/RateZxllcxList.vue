<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" @click="handleExportXls('客户执行利率查询')" v-has="'khzxllcx:exportXls'">导出</a-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/rateZxllcx/rateZxllcx/list",
          delete: "/rateZxllcx/rateZxllcx/delete",
          deleteBatch: "/rateZxllcx/rateZxllcx/deleteBatch",
          exportXlsUrl: "rateZxllcx/rateZxllcx/exportXls",
          importExcelUrl: "rateZxllcx/rateZxllcx/importExcel",
        },
      }
    },
    computed: {
