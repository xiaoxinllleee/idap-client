<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" type="primary" icon="plus" v-has="'ErpAssessSjxDataTzJg:add'">新增</a-button>
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('机构指标数据调整')" v-has="'ErpAssessSjxDataTzJg:exp'">导出</a-button>
      <a-button icon="import" @click="excelImport" v-has="'ErpAssessSjxDataTzJg:imp'">导入</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'ErpAssessSjxDataTzJg:edit'">编辑</a>
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)">
                  <a v-has="'ErpAssessSjxDataTzJg:del'">删除</a>
                </a-popconfirm>
              </a-menu-item>
            </a-menu>
          </a-dropdown>
    ...
    <erpAssessSjxDataTzJg-modal ref="modalForm" @ok="modalFormOk"></erpAssessSjxDataTzJg-modal>
  </a-card>
</template>

<script>
  import ErpAssessSjxDataTzJgModal from './ErpAssessSjxDataTzJgModal'
  ...
  export default {
    name: "ErpAssessSjxDataTzJgList",
    mixins:[JeecgListMixin],
    components: {
      ErpAssessSjxDataTzJgModal,ExcelImport,JTreeSelect
    },
    data () {
      return {
       ...
       //     },
		...
		url: {
          list: "/zbjgbl/erpAssessSjxDataTz/listJG",
          delete: "/zbjgbl/erpAssessSjxDataTz/delete",
          deleteBatch: "/zbjgbl/erpAssessSjxDataTz/deleteBatch",
          exportXlsUrl: "zbjgbl/erpAssessSjxDataTz/exportXlsJG",
          importExcelUrl: "zbjgbl/erpAssessSjxDataTz/importExcelJG",
          exportTemplateUrl: "zbjgbl/erpAssessSjxDataTz/exportTemplateXlsJG",
       },
        exportTemplateName: '机构指标数据调整导入模板'
    }
  },
  computed: {
