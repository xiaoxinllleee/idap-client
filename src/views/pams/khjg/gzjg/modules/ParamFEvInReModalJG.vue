    ...
    <a-modal centered
      ...
      <div>
       ...
       <span slot="action" type="primary" slot-scope="text, record">
          <Button type="primary" size="small" @click="handleEdit(record)">查看员工明细</Button>
        </span>
        </a-table>
      ...
      <param-f-ev-in-re-modal-y-g ref="modalForm" @ok="modalFormOk"> </param-f-ev-in-re-modal-y-g>
    </a-modal>
  </div>
</template>
...
import { getAction, httpAction } from '@/api/manage'
  ...
  import ParamFEvInReModalYG from './ParamFEvInReModalYG'
