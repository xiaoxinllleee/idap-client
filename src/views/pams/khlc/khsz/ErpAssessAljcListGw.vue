<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" icon="setting" v-has="'ErpAssessAljcListGw:set'" style="background-color: #009966;color: #fff">设置</a-button>
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('岗位按量计酬考核设置')" v-has="'ErpAssessAljcListGw:exp'">导出</a-button>
      <a-button icon="import" @click="excelImport" v-has="'ErpAssessAljcListGw:imp'">导入</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'ErpAssessAljcListGw:edit'">编辑</a>
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)">
                  <a v-has="'ErpAssessAljcListGw:del'">删除</a>
                </a-popconfirm>
              </a-menu-item>
            </a-menu>
          </a-dropdown>
    ...
    <erp-assess-aljc-set-modal ref="modalForm2" @ok="modalFormOk"></erp-assess-aljc-set-modal>
  </a-card>
</template>
...
<script>
  ...
  import ErpAssessAljcSetModal from '@views/pams/khlc/khsz/modules/ErpAssessAljcSetModal'

  export default {
    name: "ErpAssessAljcListGw",
    mixins:[JeecgListMixin],
    components: {
      ErpAssessAljcModal,JTreeSelect,ExcelImport,ErpAssessAljcSetModal
    },
    data () {
      return {
       ...
       //     },
		...
		url: {
          ...
          exportXlsUrl: "khfagl/erpAssessAljc/exportXls",
          importExcelUrl: "khfagl/erpAssessAljc/importExcel",
          exportTemplateUrl:"/khfagl/erpAssessAljc/exportTemplateXls",
       },
          exportTemplateName: '岗位按量计酬考核设置导入模板'
    }
  },
  computed: {
