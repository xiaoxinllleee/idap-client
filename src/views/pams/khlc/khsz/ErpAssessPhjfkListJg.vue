<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd()" icon="setting" v-has="'ErpAssessPhjfkListJg:set'" style="background-color: #009966;color: #fff">设置</a-button>
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('机构平衡计分卡考核设置')" v-has="'ErpAssessPhjfkListJg:exp'">导出</a-button>
      <a-button icon="import" @click="excelImport" v-has="'ErpAssessPhjfkListJg:imp'">导入</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'ErpAssessPhjfkListJg:edit'">编辑</a>
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)">
                  <a v-has="'ErpAssessPhjfkListJg:del'">删除</a>
                </a-popconfirm>
              </a-menu-item>
            </a-menu>
          </a-dropdown>
    ...
    <erp-assess-phjfk-jg-modal ref="modalForm2" @ok="modalFormOk"></erp-assess-phjfk-jg-modal>
  </a-card>
</template>
...
<script>
  ...
  import ErpAssessPhjfkJgModal from './modules/ErpAssessPhjfkJgModal'

  export default {
    name: "ErpAssessPhjfkListJg",
    mixins:[JeecgListMixin],
    components: {
      ErpAssessPhjfkModal,JTreeSelect,ExcelImport,ErpAssessPhjfkJgModal
    },
    data () {
      return {
       ...
       //     },
		...
		url: {
          list: "/khfagl/erpAssessPhjfk/listJG",
          delete: "/khfagl/erpAssessPhjfk/delete",
          deleteBatch: "/khfagl/erpAssessPhjfk/deleteBatch",
          exportXlsUrl: "khfagl/erpAssessPhjfk/exportXlsJG",
          importExcelUrl: "khfagl/erpAssessPhjfk/importExcelJG",
          exportTemplateUrl:"/khfagl/erpAssessPhjfk/exportTemplateXlsJG",
       },
        exportTemplateName: '机构平衡计分卡考核设置导入模板'
