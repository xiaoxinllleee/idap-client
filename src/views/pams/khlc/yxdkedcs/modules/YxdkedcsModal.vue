  ...
  <a-modal :title="title" :width="800" :visible="visible" :confirmLoading="confirmLoading"
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="参数编号">
          <a-input placeholder="请输入参数编号" v-decorator="['csbh', validatorRules.csbh ]" :disabled="editdisabled"/>
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="参数值起">
          <a-input placeholder="请输入" v-decorator="['cszq', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="参数值止">
          <a-input placeholder="请输入" v-decorator="['cszz', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit(record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model, 'csbh', 'cszq', 'cszz', 'tzxs', 'fxjtxs', 'bz'))
          //时间格式化
