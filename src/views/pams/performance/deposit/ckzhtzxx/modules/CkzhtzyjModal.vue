      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline">
          <a-row :gutter="24">
            <a-col :span="8">
              <a-form-item label="接收人">
                <j-select-ygxx placeholder="请选择接收人" button-name="选择接收人" ref="ygxx" @change="getYggh" type="radio"/>
              </a-form-item>
            </a-col>
          ...
          <a-row :gutter="24" v-show="yjfs == '1'" style="padding-top: 20px">
            <a-col :span="8">
              <a-form-item label="营销类型">
                <a-checkbox-group v-model="queryParam1.yxlx" :default-value="['1','2']">
          ...
          <a-row :gutter="24" v-show="yjfs == '2'" style="padding-top: 20px">
            ...
            <a-col :span="8"><a-form-item label="营销类型">
              <j-dict-select-tag placeholder="请选择营销类型" v-model="queryParam2.yxlx" dict-code="yxlx"/>
            </a-form-item></a-col>
            ...
            <a-col :span="8">
              <a-form-item label="存款账户">
                <a-input placeholder="请输入证件号码" v-model="queryParam2.ckzh"/>
              </a-form-item>
            </a-col>
            <a-col :span="8">
              <a-form-item label="账户类型">
                <j-dict-select-tag placeholder="请选择账户类型" v-model="queryParam2.zhlx" dict-code="ckzhlx"/>
              </a-form-item>
            </a-col>
            <a-col :span="8" >
              <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/ckzhtzyj/ckzhtzyjxx/transferList",
          transfer: "/ckzhtzyj/ckzhtzyjxx/transfer",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      getQueryParams: function () {
        ...
        if (this.yjfs == '1') {
          ...
          if (param.yxlx && param.yxlx.length > 0) {
            param.yxlx = param.yxlx.join(',')
          }
        } else {
