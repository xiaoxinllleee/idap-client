<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button  icon="download" :loading="exportLoading" @click="handleExportXls('员工拓展存款明细')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <ygtzckmx-modal ref="modalForm" @ok="modalFormOk"></ygtzckmx-modal>
  </a-card>
</template>

<script>
  import YgtzckmxModal from './modules/YgtzckmxModal'
  ...
  export default {
    ...
    components: {
      YgtzckmxModal,JTreeSelect
    },
    data () {
      return {
        description: '员工拓展存款明细管理页面',
        // 表头
        DateFormat: 'YYYYMMDD',
       ...
       /*   {
		...
		url: {
          list: "/ygtzckmx/ygtzckmx/list",
          delete: "/ygtzckmx/ygtzckmx/delete",
          deleteBatch: "/ygtzckmx/ygtzckmx/deleteBatch",
          exportXlsUrl: "ygtzckmx/ygtzckmx/exportXls",
          importExcelUrl: "ygtzckmx/ygtzckmx/importExcel",
          init: "ygtzckmx/ygtzckmx/init",
       },
    }
  },
  computed: {
