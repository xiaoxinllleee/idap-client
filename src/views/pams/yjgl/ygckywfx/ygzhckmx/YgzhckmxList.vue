<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button  icon="download" :loading="exportLoading" @click="handleExportXls('员工综合存款明细')">导出</a-button>
          ...
          <a-spin :spinning="confirmLoading">
            ...
            <a-form-item
              ...
              <a-range-picker :placeholder="['开始日期', '结束日期']" v-model="model.tqrq" format="YYYY-MM-DD"
                              ...
                              :default-value="[moment(new Date(), 'YYYY-MM-DD'), moment(new Date(), 'YYYY-MM-DD')]"/>
            </a-form-item>
            <a-form-item
              :labelCol="labelCol"
              :wrapperCol="wrapperCol"
    ...
    <!-- 表单区域 -->
    <ygzhckmx-modal ref="modalForm" @ok="modalFormOk"></ygzhckmx-modal>
  </a-card>
</template>

<script>
  import YgzhckmxModal from './modules/YgzhckmxModal'
  ...
  export default {
    ...
    components: {
      YgzhckmxModal,JTreeSelect
    },
    data () {
      return {
        description: '员工综合存款明细管理页面',
        // 表头
        DateFormat: 'YYYYMMDD',
       ...
       //     },
		...
		url: {
          list: "/ygzhckmx/ygzhckmx/list",
          delete: "/ygzhckmx/ygzhckmx/delete",
          deleteBatch: "/ygzhckmx/ygzhckmx/deleteBatch",
          exportXlsUrl: "ygzhckmx/ygzhckmx/exportXls",
          importExcelUrl: "ygzhckmx/ygzhckmx/importExcel",
          init: "ygzhckmx/ygzhckmx/init",
       },
    }
  },
  computed: {
    ...
    methods: {
      ...
      handleExportXls (fileName) {
        ...
        if (param.tjrq === undefined || param.tjrq === ''){
