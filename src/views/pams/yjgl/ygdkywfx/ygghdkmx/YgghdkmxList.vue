<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('员工管户贷款明细')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <ygghdkmx-modal ref="modalForm" @ok="modalFormOk"></ygghdkmx-modal>
  </a-card>
</template>

<script>
  import YgghdkmxModal from './modules/YgghdkmxModal'
  ...
  export default {
    ...
    components: {
      YgghdkmxModal,JTreeSelect
    },
    data () {
      return {
        description: '员工管户贷款明细管理页面',
        // 表头
        DateFormat: 'YYYYMMDD',
		...
		url: {
          list: "/ygghdkmx/ygghdkmx/list",
          delete: "/ygghdkmx/ygghdkmx/delete",
          deleteBatch: "/ygghdkmx/ygghdkmx/deleteBatch",
          exportXlsUrl: "ygghdkmx/ygghdkmx/exportXls",
          importExcelUrl: "ygghdkmx/ygghdkmx/importExcel",
          init: "ygghdkmx/ygghdkmx/init",
       },
    }
  },
  computed: {
