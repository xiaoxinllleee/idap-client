<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('员工审批贷款明细')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <ygspdkmx-modal ref="modalForm" @ok="modalFormOk"></ygspdkmx-modal>
  </a-card>
</template>

<script>
  import YgspdkmxModal from './modules/YgspdkmxModal'
  ...
  export default {
    ...
    components: {
      YgspdkmxModal,JTreeSelect
    },
    data () {
      return {
        description: '员工审批贷款明细管理页面',
        // 表头
        DateFormat: 'YYYYMMDD',
		...
		url: {
          list: "/ygspdkmx/ygspdkmx/list",
          delete: "/ygspdkmx/ygspdkmx/delete",
          deleteBatch: "/ygspdkmx/ygspdkmx/deleteBatch",
          exportXlsUrl: "ygspdkmx/ygspdkmx/exportXls",
          importExcelUrl: "ygspdkmx/ygspdkmx/importExcel",
       },
    }
  },
  computed: {
