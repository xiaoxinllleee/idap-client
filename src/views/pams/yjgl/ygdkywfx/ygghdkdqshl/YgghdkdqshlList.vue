<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('员工管户贷款到期收回率')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <ygghdkdqshl-modal ref="modalForm" @ok="modalFormOk"></ygghdkdqshl-modal>
  </a-card>
</template>

<script>
  import YgghdkdqshlModal from './modules/YgghdkdqshlModal'
  ...
  export default {
    name: "YgghdkdqshlList",
    mixins:[JeecgListMixin],
    components: {
      YgghdkdqshlModal,JTreeSelect
    },
    data () {
      return {
        description: '员工管户贷款到期收回率管理页面',
        // 表头
        monthFormat: 'YYYY-MM',
        defaultMonthOpera: '',
        columns: [
		...
		url: {
          list: "/ygghdkdqshl/ygghdkdqshl/list",
          delete: "/ygghdkdqshl/ygghdkdqshl/delete",
          deleteBatch: "/ygghdkdqshl/ygghdkdqshl/deleteBatch",
          exportXlsUrl: "ygghdkdqshl/ygghdkdqshl/exportXls",
          importExcelUrl: "ygghdkdqshl/ygghdkdqshl/importExcel",
          init: "/ygghdkdqshl/ygghdkdqshl/init",
       },
    }
  },
  computed: {
