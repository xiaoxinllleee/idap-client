<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button  icon="download" :loading="exportLoading" @click="handleExportXls('员工管户贷款不良率')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <ygghdkbll-modal ref="modalForm" @ok="modalFormOk"></ygghdkbll-modal>
  </a-card>
</template>

<script>
  import YgghdkbllModal from './modules/YgghdkbllModal'
  ...
  export default {
    ...
    components: {
      YgghdkbllModal,JTreeSelect
    },
    data () {
      return {
        description: '员工管户贷款不良率管理页面',
        // 表头
        monthFormat: 'YYYY-MM',
        defaultMonthOpera: '',
        columns: [
		...
		url: {
          list: "/ygghdkbll/ygghdkbll/list",
          delete: "/ygghdkbll/ygghdkbll/delete",
          deleteBatch: "/ygghdkbll/ygghdkbll/deleteBatch",
          exportXlsUrl: "ygghdkbll/ygghdkbll/exportXls",
          importExcelUrl: "ygghdkbll/ygghdkbll/importExcel",
          init: "ygghdkbll/ygghdkbll/init",
       },
    }
  },
  computed: {
