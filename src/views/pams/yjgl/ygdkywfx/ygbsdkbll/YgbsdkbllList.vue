<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button  icon="download" :loading="exportLoading" @click="handleExportXls('员工包收贷款不良率')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <ygbsdkbll-modal ref="modalForm" @ok="modalFormOk"></ygbsdkbll-modal>
  </a-card>
</template>

<script>
  import YgbsdkbllModal from './modules/YgbsdkbllModal'
  ...
  export default {
    ...
    components: {
      YgbsdkbllModal,JTreeSelect
    },
    data () {
      return {
        description: '员工包收贷款不良率管理页面',
        // 表头
        monthFormat: 'YYYY-MM',
        defaultMonthOpera: '',
        columns: [
		...
		url: {
          list: "/ygbsdkbll/ygbsdkbll/list",
          delete: "/ygbsdkbll/ygbsdkbll/delete",
          deleteBatch: "/ygbsdkbll/ygbsdkbll/deleteBatch",
          exportXlsUrl: "ygbsdkbll/ygbsdkbll/exportXls",
          importExcelUrl: "ygbsdkbll/ygbsdkbll/importExcel",
          init: "ygbsdkbll/ygbsdkbll/init",
       },
    }
  },
  computed: {
    ...
    methods: {
      ...
      /*  if (params.ygssjgdm === undefined || params.ygssjgdm === null) {
          this.$message.warning("请选择员工所属机构代码！")
          return false
        }
        if (params.yggh === undefined || params.yggh === null) {
