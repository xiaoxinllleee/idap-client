<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button  icon="download" :loading="exportLoading" @click="handleExportXls('员工贷款综合明细')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <ygdkzhmx-modal ref="modalForm" @ok="modalFormOk"></ygdkzhmx-modal>
  </a-card>
</template>

<script>
  import YgdkzhmxModal from './modules/YgdkzhmxModal'
  ...
  export default {
    ...
    components: {
      YgdkzhmxModal,JTreeSelect
    },
    data () {
      return {
        description: '员工贷款综合明细管理页面',
        // 表头
        DateFormat: 'YYYYMMDD',
		...
		url: {
          list: "/ygdkzhmx/ygdkzhmx/list",
          delete: "/ygdkzhmx/ygdkzhmx/delete",
          deleteBatch: "/ygdkzhmx/ygdkzhmx/deleteBatch",
          exportXlsUrl: "ygdkzhmx/ygdkzhmx/exportXls",
          importExcelUrl: "ygdkzhmx/ygdkzhmx/importExcel",
          init: "/ygdkzhmx/ygdkzhmx/init",
       },
    }
  },
  computed: {
