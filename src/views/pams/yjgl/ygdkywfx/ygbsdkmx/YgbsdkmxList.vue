<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button  icon="download" :loading="exportLoading" @click="handleExportXls('员工包收贷款明细')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <ygbsdkmx-modal ref="modalForm" @ok="modalFormOk"></ygbsdkmx-modal>
  </a-card>
</template>

<script>
  import YgbsdkmxModal from './modules/YgbsdkmxModal'
  ...
  export default {
    ...
    components: {
      YgbsdkmxModal,JTreeSelect
    },
    data () {
      return {
        description: '员工包收贷款明细管理页面',
        // 表头
        DateFormat: 'YYYYMMDD',
		...
		url: {
          list: "/ygbsdkmx/ygbsdkmx/list",
          delete: "/ygbsdkmx/ygbsdkmx/delete",
          deleteBatch: "/ygbsdkmx/ygbsdkmx/deleteBatch",
          exportXlsUrl: "ygbsdkmx/ygbsdkmx/exportXls",
          importExcelUrl: "ygbsdkmx/ygbsdkmx/importExcel",
          init: "ygbsdkmx/ygbsdkmx/init",
       },
    }
  },
  computed: {
