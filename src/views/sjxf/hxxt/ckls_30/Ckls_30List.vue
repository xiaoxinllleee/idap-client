...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('存款流水_30')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <ckls_30-modal ref="modalForm" @ok="modalFormOk"></ckls_30-modal>
  </a-card>
</template>

<script>
  import Ckls_30Modal from './modules/Ckls_30Modal'
  ...
  export default {
    ...
    components: {
      Ckls_30Modal,JEllipsis
    },
    data () {
      return {
        description: '存款流水_30管理页面',
        // 表头
        columns: [
          {
            title: '',
		...
		url: {
          list: "/ckls_30/ckls_30/list",
          delete: "/ckls_30/ckls_30/delete",
          deleteBatch: "/ckls_30/ckls_30/deleteBatch",
          exportXlsUrl: "ckls_30/ckls_30/exportXls",
          importExcelUrl: "ckls_30/ckls_30/importExcel",
       },
    }
  },
  computed: {
