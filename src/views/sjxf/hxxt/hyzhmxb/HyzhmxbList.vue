...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('或有账户明细表')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <hyzhmxb-modal ref="modalForm" @ok="modalFormOk"></hyzhmxb-modal>
  </a-card>
</template>

<script>
  import HyzhmxbModal from './modules/HyzhmxbModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/hyzhmxb/hyzhmxb/list",
          delete: "/hyzhmxb/hyzhmxb/delete",
          deleteBatch: "/hyzhmxb/hyzhmxb/deleteBatch",
          exportXlsUrl: "hyzhmxb/hyzhmxb/exportXls",
          importExcelUrl: "hyzhmxb/hyzhmxb/importExcel",
       },
    }
  },
  computed: {
