...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('贷款流水_51')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <dkls_51-modal ref="modalForm" @ok="modalFormOk"></dkls_51-modal>
  </a-card>
</template>

<script>
  import Dkls_51Modal from './modules/Dkls_51Modal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        columns: [
          {
           ...
           },
		   {
            title: '上次转坏帐金额',
            align:"center",
            dataIndex: 'prevBadDebtAmt'
           },
		   {
            title: '转坏帐利息金额',
            align:"center",
            dataIndex: 'prevGlIntAmt'
           },
		   {
            title: '转坏帐本金金额',
            align:"center",
            dataIndex: 'prevGlPrinAmt'
           },
		   {
            title: '上次转坏帐总金额',
            align:"center",
            dataIndex: 'prevTotBadAmt'
           },
		   {
            title: 'FILLER',
            align:"center",
		...
		url: {
          list: "/dkls_51/dkls_51/list",
          delete: "/dkls_51/dkls_51/delete",
          deleteBatch: "/dkls_51/dkls_51/deleteBatch",
          exportXlsUrl: "dkls_51/dkls_51/exportXls",
          importExcelUrl: "dkls_51/dkls_51/importExcel",
       },
    }
  },
  computed: {
