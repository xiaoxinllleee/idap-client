...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('存款流水_39')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <ckls_39-modal ref="modalForm" @ok="modalFormOk"></ckls_39-modal>
  </a-card>
</template>

<script>
  import Ckls_39Modal from './modules/Ckls_39Modal'
  ...
  export default {
    ...
    components: {
      Ckls_39Modal,JEllipsis
    },
    data () {
      return {
        description: '存款流水_39管理页面',
        // 表头
        columns: [
          {
            title: '',
		...
		url: {
          list: "/ckls_39/ckls_39/list",
          delete: "/ckls_39/ckls_39/delete",
          deleteBatch: "/ckls_39/ckls_39/deleteBatch",
          exportXlsUrl: "ckls_39/ckls_39/exportXls",
          importExcelUrl: "ckls_39/ckls_39/importExcel",
       },
    }
  },
  computed: {
