    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        ...
        <template v-if="toggleSearchStatus">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="修改柜员号">
              <a-input placeholder="请输入修改柜员号" v-model="queryParam.chTlrNo"></a-input>
            </a-form-item>
          </a-col>
          <!--<a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('存款流水_68')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <ckls_68-modal ref="modalForm" @ok="modalFormOk"></ckls_68-modal>
  </a-card>
</template>

<script>
  import Ckls_68Modal from './modules/Ckls_68Modal'
  ...
  export default {
    ...
    components: {
      Ckls_68Modal,JEllipsis
    },
    data () {
      return {
        description: '存款流水_68管理页面',
        // 表头
        columns: [
          {
            title: '',
           ...
           },
		   {
            title: '原圈存到期日',
            align:"center",
            dataIndex: 'crMatDate0'
           },
		   {
            title: '原自动圈提标识',
            align:"center",
            dataIndex: 'autoDrFlag0'
           },
		   {
            title: '原圈提转入账号',
            align:"center",
           ...
           },
		   {
            title: '原圈提转入账户子账户类别',
            align:"center",
            dataIndex: 'drAcctCat0'
           },
		   {
            title: '原圈提账户所属模块',
            align:"center",
            dataIndex: 'moduleCode0'
           },
		   {
            title: '转出主账户',
            align:"center",
            dataIndex: 'fromMastAcct'
           },
		   {
            title: '转出子账户类型',
            align:"center",
            dataIndex: 'fromSubType'
           },
		   {
            title: '产品大类1',
            align:"center",
		...
		url: {
          list: "/ckls_68/ckls_68/list",
          delete: "/ckls_68/ckls_68/delete",
          deleteBatch: "/ckls_68/ckls_68/deleteBatch",
          exportXlsUrl: "ckls_68/ckls_68/exportXls",
          importExcelUrl: "ckls_68/ckls_68/importExcel",
       },
    }
  },
  computed: {
