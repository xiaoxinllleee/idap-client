...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('内部帐交易明细_20')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <nbzjymx_20-modal ref="modalForm" @ok="modalFormOk"></nbzjymx_20-modal>
  </a-card>
</template>

<script>
  import Nbzjymx_20Modal from './modules/Nbzjymx_20Modal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/nbzjymx_20/nbzjymx_20/list",
          delete: "/nbzjymx_20/nbzjymx_20/delete",
          deleteBatch: "/nbzjymx_20/nbzjymx_20/deleteBatch",
          exportXlsUrl: "nbzjymx_20/nbzjymx_20/exportXls",
          importExcelUrl: "nbzjymx_20/nbzjymx_20/importExcel",
       },
    }
  },
  computed: {
