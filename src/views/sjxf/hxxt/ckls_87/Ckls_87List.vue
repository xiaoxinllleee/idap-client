        ...
        <template v-if="toggleSearchStatus">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="授权柜员号">
              <a-input placeholder="请输入授权柜员号" v-model="queryParam.supId"></a-input>
            </a-form-item>
          </a-col>
          <!--<a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('存款流水_87')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <ckls_87-modal ref="modalForm" @ok="modalFormOk"></ckls_87-modal>
  </a-card>
</template>

<script>
  import Ckls_87Modal from './modules/Ckls_87Modal'
  ...
  export default {
    ...
    components: {
      Ckls_87Modal,JEllipsis
    },
    data () {
      return {
        description: '存款流水_87管理页面',
        // 表头
        columns: [
          {
            title: '',
		...
		url: {
          list: "/ckls_87/ckls_87/list",
          delete: "/ckls_87/ckls_87/delete",
          deleteBatch: "/ckls_87/ckls_87/deleteBatch",
          exportXlsUrl: "ckls_87/ckls_87/exportXls",
          importExcelUrl: "ckls_87/ckls_87/importExcel",
       },
    }
  },
  computed: {
