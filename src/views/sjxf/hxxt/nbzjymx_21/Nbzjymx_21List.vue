...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('内部帐交易明细_21')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <nbzjymx_21-modal ref="modalForm" @ok="modalFormOk"></nbzjymx_21-modal>
  </a-card>
</template>

<script>
  import Nbzjymx_21Modal from './modules/Nbzjymx_21Modal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/nbzjymx_21/nbzjymx_21/list",
          delete: "/nbzjymx_21/nbzjymx_21/delete",
          deleteBatch: "/nbzjymx_21/nbzjymx_21/deleteBatch",
          exportXlsUrl: "nbzjymx_21/nbzjymx_21/exportXls",
          importExcelUrl: "nbzjymx_21/nbzjymx_21/importExcel",
       },
    }
  },
  computed: {
