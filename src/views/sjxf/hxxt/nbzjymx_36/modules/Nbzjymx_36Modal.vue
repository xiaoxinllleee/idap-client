    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="交易系统">
          <a-input placeholder="请输入交易系统" v-decorator="['system', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="定期扣款类型">
          <a-input placeholder="请输入定期扣款类型" v-decorator="['desc1', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="对方交易帐号">
          <a-input placeholder="请输入对方交易帐号" v-decorator="['accountno', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="交易终端号">
          <a-input placeholder="请输入交易终端号" v-decorator="['brterm1', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="desc">
          <a-input placeholder="请输入desc" v-decorator="['desc', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/nbzjymx_36/nbzjymx_36/add",
          edit: "/nbzjymx_36/nbzjymx_36/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'instNo','acctNo','recNo','tranType','stat','postDate','trnDate','systemDate','systemTime','tellAndBr','jrnlNo','trnCode','brterm','channel','deli','code','status','system','desc1','accountno','amount','brterm1','dataDate','loadDate','legalNo','dtnum','desc'))
		  //时间格式化
