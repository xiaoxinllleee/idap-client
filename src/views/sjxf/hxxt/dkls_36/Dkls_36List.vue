...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('贷款流水_36')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <dkls_36-modal ref="modalForm" @ok="modalFormOk"></dkls_36-modal>
  </a-card>
</template>

<script>
  import Dkls_36Modal from './modules/Dkls_36Modal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/dkls_36/dkls_36/list",
          delete: "/dkls_36/dkls_36/delete",
          deleteBatch: "/dkls_36/dkls_36/deleteBatch",
          exportXlsUrl: "dkls_36/dkls_36/exportXls",
          importExcelUrl: "dkls_36/dkls_36/importExcel",
       },
    }
  },
  computed: {
