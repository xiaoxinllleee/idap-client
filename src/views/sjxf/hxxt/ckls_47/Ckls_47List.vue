    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        ...
        <template v-if="toggleSearchStatus">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="交易发起机构">
              <a-input placeholder="请输入交易发起机构" v-model="queryParam.branch"></a-input>
            </a-form-item>
          </a-col>
          <!--<a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('存款流水_47')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <ckls_47-modal ref="modalForm" @ok="modalFormOk"></ckls_47-modal>
  </a-card>
</template>

<script>
  import Ckls_47Modal from './modules/Ckls_47Modal'
  ...
  export default {
    ...
    components: {
      Ckls_47Modal,JEllipsis
    },
    data () {
      return {
        description: '存款流水_47管理页面',
        // 表头
        columns: [
          {
            title: '',
		...
		url: {
          list: "/ckls_47/ckls_47/list",
          delete: "/ckls_47/ckls_47/delete",
          deleteBatch: "/ckls_47/ckls_47/deleteBatch",
          exportXlsUrl: "ckls_47/ckls_47/exportXls",
          importExcelUrl: "ckls_47/ckls_47/importExcel",
       },
    }
  },
  computed: {
