...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('贷款流水_47')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <dkls_47-modal ref="modalForm" @ok="modalFormOk"></dkls_47-modal>
  </a-card>
</template>

<script>
  import Dkls_47Modal from './modules/Dkls_47Modal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        columns: [
          {
           ...
           },
		   {
            title: '旧账户子类',
            align:"center",
            dataIndex: 'oldAcctCat'
           },
		   {
            title: '新账户子类',
            align:"center",
            dataIndex: 'newAcctCat'
           },
		   {
            title: '上次金融交易日',
            align:"center",
            dataIndex: 'lastFinDate'
           },
		   {
            title: 'FILLER',
            align:"center",
		...
		url: {
          list: "/dkls_47/dkls_47/list",
          delete: "/dkls_47/dkls_47/delete",
          deleteBatch: "/dkls_47/dkls_47/deleteBatch",
          exportXlsUrl: "dkls_47/dkls_47/exportXls",
          importExcelUrl: "dkls_47/dkls_47/importExcel",
       },
    }
  },
  computed: {
