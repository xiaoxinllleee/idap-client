...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('贷款流水_25')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <dkls_25-modal ref="modalForm" @ok="modalFormOk"></dkls_25-modal>
  </a-card>
</template>

<script>
  import Dkls_25Modal from './modules/Dkls_25Modal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/dkls_25/dkls_25/list",
          delete: "/dkls_25/dkls_25/delete",
          deleteBatch: "/dkls_25/dkls_25/deleteBatch",
          exportXlsUrl: "dkls_25/dkls_25/exportXls",
          importExcelUrl: "dkls_25/dkls_25/importExcel",
       },
    }
  },
  computed: {
