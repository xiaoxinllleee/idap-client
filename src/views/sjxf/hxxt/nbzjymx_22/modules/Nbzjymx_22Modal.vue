    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="交易类型:01-金融交易 20-对账单摘要 21-交易备注36-转账信息">
          <a-input placeholder="请输入交易类型:01-金融交易 20-对账单摘要 21-交易备注36-转账信息" v-decorator="['tranType', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="渠道类型      0-柜面交易      1-ATM      5-支付渠道      6-信贷系统      8-国际结算      B-批处理      C-贷记卡      H-农信银全国通存通兑      N-网上银行      I-电话银行      P-财付通      W-中间业务      Y-短信银行">
          <a-input placeholder="请输入渠道类型      0-柜面交易      1-ATM      5-支付渠道      6-信贷系统      8-国际结算      B-批处理      C-贷记卡      H-农信银全国通存通兑      N-网上银行      I-电话银行      P-财付通      W-中间业务      Y-短信银行" v-decorator="['channel', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="删除标志 1-Yes；0-No">
          <a-input placeholder="请输入删除标志 1-Yes；0-No" v-decorator="['deli', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="交易类型">
          <a-input placeholder="请输入交易类型" v-decorator="['code', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="交易状态">
          <a-input placeholder="请输入交易状态" v-decorator="['status', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="销帐码信息">
          <a-input placeholder="请输入销帐码信息" v-decorator="['srnInfo', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="冲正标识，目前未用">
          <a-input placeholder="请输入冲正标识，目前未用" v-decorator="['corrInd', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="冲正状态，目前未用">
          <a-input placeholder="请输入冲正状态，目前未用" v-decorator="['corrStat', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="填充3">
          <a-input placeholder="请输入填充3" v-decorator="['filler3', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/nbzjymx_22/nbzjymx_22/add",
          edit: "/nbzjymx_22/nbzjymx_22/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'instNo','acctNo','recNo','tranType','stat','postDate','trnDate','systemDate','systemTime','tellAndBr','jrnlNo','trnCode','brterm','channel','deli','code','status','srnInfo','corrInd','corrStat','filler1','filler2','filler3','dataDate','loadDate','legalNo','dtnum'))
		  //时间格式化
