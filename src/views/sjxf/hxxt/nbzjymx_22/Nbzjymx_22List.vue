...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('内部帐交易明细_22')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <nbzjymx_22-modal ref="modalForm" @ok="modalFormOk"></nbzjymx_22-modal>
  </a-card>
</template>

<script>
  import Nbzjymx_22Modal from './modules/Nbzjymx_22Modal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/nbzjymx_22/nbzjymx_22/list",
          delete: "/nbzjymx_22/nbzjymx_22/delete",
          deleteBatch: "/nbzjymx_22/nbzjymx_22/deleteBatch",
          exportXlsUrl: "nbzjymx_22/nbzjymx_22/exportXls",
          importExcelUrl: "nbzjymx_22/nbzjymx_22/importExcel",
       },
    }
  },
  computed: {
