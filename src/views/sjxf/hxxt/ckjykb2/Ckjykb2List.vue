          ...
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="交易码名称">
                <a-input placeholder="请输入交易码名称" v-model="queryParam.trxName"></a-input>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="交易金额">
                <!--              <a-range-picker  @change="onChangezrjyje"  v-model="queryParam.amount"/>-->
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="账号余额">
                <!--              <a-range-picker @change="onChangejyye" v-model="queryParam.balance"/>-->
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="柜员名称">
                <a-input placeholder="请输入柜员名称" v-model="queryParam.tellName"></a-input>
              </a-form-item>
            </a-col>
          </template>
...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('存款交易宽表2')">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/ckjykb2/ckjykb2/list",
          delete: "/ckjykb2/ckjykb2/delete",
          deleteBatch: "/ckjykb2/ckjykb2/deleteBatch",
          exportXlsUrl: "ckjykb2/ckjykb2/exportXls",
          importExcelUrl: "ckjykb2/ckjykb2/importExcel",
       },
    }
  },
  computed: {
