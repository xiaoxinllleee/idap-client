...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('贷款流水_34')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <dkls_34-modal ref="modalForm" @ok="modalFormOk"></dkls_34-modal>
  </a-card>
</template>

<script>
  import Dkls_34Modal from './modules/Dkls_34Modal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/dkls_34/dkls_34/list",
          delete: "/dkls_34/dkls_34/delete",
          deleteBatch: "/dkls_34/dkls_34/deleteBatch",
          exportXlsUrl: "dkls_34/dkls_34/exportXls",
          importExcelUrl: "dkls_34/dkls_34/importExcel",
       },
    }
  },
  computed: {
