    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        ...
        <template v-if="toggleSearchStatus">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="支票起始号">
              <a-input placeholder="请输入支票起始号" v-model="queryParam.chqNo"></a-input>
            </a-form-item>
          </a-col>
          <!--<a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('存款流水_66')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <ckls_66-modal ref="modalForm" @ok="modalFormOk"></ckls_66-modal>
  </a-card>
</template>

<script>
  import Ckls_66Modal from './modules/Ckls_66Modal'
  ...
  export default {
    ...
    components: {
      Ckls_66Modal,JEllipsis
    },
    data () {
      return {
        description: '存款流水_66管理页面',
        // 表头
        columns: [
          {
            title: '',
		...
		url: {
          list: "/ckls_66/ckls_66/list",
          delete: "/ckls_66/ckls_66/delete",
          deleteBatch: "/ckls_66/ckls_66/deleteBatch",
          exportXlsUrl: "ckls_66/ckls_66/exportXls",
          importExcelUrl: "ckls_66/ckls_66/importExcel",
       },
    }
  },
  computed: {
