...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('存款流水_49')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <ckls_49-modal ref="modalForm" @ok="modalFormOk"></ckls_49-modal>
  </a-card>
</template>

<script>
  import Ckls_49Modal from './modules/Ckls_49Modal'
  ...
  export default {
    ...
    components: {
      Ckls_49Modal,JEllipsis
    },
    data () {
      return {
        description: '存款流水_49管理页面',
        // 表头
        columns: [
          {
            title: '',
		...
		url: {
          list: "/ckls_49/ckls_49/list",
          delete: "/ckls_49/ckls_49/delete",
          deleteBatch: "/ckls_49/ckls_49/deleteBatch",
          exportXlsUrl: "ckls_49/ckls_49/exportXls",
          importExcelUrl: "ckls_49/ckls_49/importExcel",
       },
    }
  },
  computed: {
