...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('内部帐交易明细_01')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <nbzjymx_01-modal ref="modalForm" @ok="modalFormOk"></nbzjymx_01-modal>
  </a-card>
</template>

<script>
  import Nbzjymx_01Modal from './modules/Nbzjymx_01Modal'
  ...
  export default {
    ...
    components: {
      Nbzjymx_01Modal,JEllipsis,JTreeSelect
    },
    data () {
      return {
        description: '内部帐交易明细_01管理页面',
        // 表头
        columns: [
          {
            title: '',
		...
		url: {
          list: "/nbzjymx_01/nbzjymx_01/list",
          delete: "/nbzjymx_01/nbzjymx_01/delete",
          deleteBatch: "/nbzjymx_01/nbzjymx_01/deleteBatch",
          exportXlsUrl: "nbzjymx_01/nbzjymx_01/exportXls",
          importExcelUrl: "nbzjymx_01/nbzjymx_01/importExcel",
       },
    }
  },
  computed: {
