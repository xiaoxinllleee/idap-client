...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('存款流水_31')">导出</a-button>
    </div>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <ckls_31-modal ref="modalForm" @ok="modalFormOk"></ckls_31-modal>
  </a-card>
</template>

<script>
  import Ckls_31Modal from './modules/Ckls_31Modal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        columns: [
          {
           ...
           },
		   {
            title: '解冻金额',
            align:"center",
            dataIndex: 'removedHoldAmt'
           },
		   {
            title: '原冻结记录的流水号',
            align:"center",
            dataIndex: 'originalHoldJrnlNo'
           },
		   {
            title: '定期冻结的旧原因代码',
            align:"center",
		...
		url: {
          list: "/ckls_31/ckls_31/list",
          delete: "/ckls_31/ckls_31/delete",
          deleteBatch: "/ckls_31/ckls_31/deleteBatch",
          exportXlsUrl: "ckls_31/ckls_31/exportXls",
          importExcelUrl: "ckls_31/ckls_31/importExcel",
       },
    }
  },
  computed: {
