<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('投资性房地产登记簿')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <tzxfdcdjb-modal ref="modalForm" @ok="modalFormOk"></tzxfdcdjb-modal>
  </a-card>
</template>

<script>
  import TzxfdcdjbModal from './modules/TzxfdcdjbModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/tzxfdcdjb/tzxfdcdjb/list",
          delete: "/tzxfdcdjb/tzxfdcdjb/delete",
          deleteBatch: "/tzxfdcdjb/tzxfdcdjb/deleteBatch",
          exportXlsUrl: "tzxfdcdjb/tzxfdcdjb/exportXls",
          importExcelUrl: "tzxfdcdjb/tzxfdcdjb/importExcel",
       },
    }
  },
  computed: {
