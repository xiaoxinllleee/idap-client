    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="部门号">
          <a-input placeholder="请输入部门号" v-decorator="['depNo', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="昨日现金余额">
          <a-input placeholder="请输入昨日现金余额" v-decorator="['cashBal', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="现金限额">
          <a-input placeholder="请输入现金限额" v-decorator="['limitAmt', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/bmxjyeb/bmxjyeb/add",
          edit: "/bmxjyeb/bmxjyeb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'depNo','cashBal','limitAmt','curNo','remark','sDate','eDate','loadDate','legalNo','dtnum'))
		  //时间格式化
