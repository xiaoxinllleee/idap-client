    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="银联数据机构号">
          <a-input placeholder="请输入银联数据机构号" v-decorator="['djkbrno', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="行内机构号">
          <a-input placeholder="请输入行内机构号" v-decorator="['bankbrno', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="brnoname">
          <a-input placeholder="请输入brnoname" v-decorator="['brnoname', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/ylsjyhnjgysb/ylsjyhnjgysb/add",
          edit: "/ylsjyhnjgysb/ylsjyhnjgysb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'djkbrno','bankbrno','flag','status','brnoname','sDate','eDate','loadDate','dtnum'))
		  //时间格式化
