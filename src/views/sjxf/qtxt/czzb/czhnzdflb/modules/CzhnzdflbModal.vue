    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="县级行政区划编码">
          <a-input placeholder="请输入县级行政区划编码" v-decorator="['xzqbm', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="分录账号">
          <a-input placeholder="请输入分录账号" v-decorator="['flzh', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="分录账号标识">
          <a-input placeholder="请输入分录账号标识" v-decorator="['flzhbz', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="备注">
          <a-input placeholder="请输入备注" v-decorator="['remark1', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="旧分录账号">
          <a-input placeholder="请输入旧分录账号" v-decorator="['jflzh', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="旧备注">
          <a-input placeholder="请输入旧备注" v-decorator="['jremark1', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/czhnzdflb/czhnzdflb/add",
          edit: "/czhnzdflb/czhnzdflb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'xzqbm','status','flzh','zbhjgm','czgy','djrq','jgmc','zhmc','zhxz','flzhbz','remark1','jflzh','jremark1','dataDate','loadDate','legalNo','dtnum'))
		  //时间格式化
