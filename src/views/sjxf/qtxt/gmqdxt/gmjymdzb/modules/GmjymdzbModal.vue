    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="交易码">
          <a-input placeholder="请输入交易码" v-decorator="['trancode', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/gmjymdzb/gmjymdzb/add",
          edit: "/gmjymdzb/gmjymdzb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'trancode','tranname','dataDate','loadDate','dtnum'))
		  //时间格式化
