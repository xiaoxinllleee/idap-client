<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('总帐科目数据文件')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <zzkmsjwj-modal ref="modalForm" @ok="modalFormOk"></zzkmsjwj-modal>
  </a-card>
</template>

<script>
  import ZzkmsjwjModal from './modules/ZzkmsjwjModal'
  ...
  export default {
    ...
    components: {
      ZzkmsjwjModal,JTreeSelect
    },
    data () {
      return {
        description: '总帐科目数据文件管理页面',
        // 表头
        columns: [
          {
            title: '',
		...
		url: {
          list: "/zzkmsjwj/zzkmsjwj/list",
          delete: "/zzkmsjwj/zzkmsjwj/delete",
          deleteBatch: "/zzkmsjwj/zzkmsjwj/deleteBatch",
          exportXlsUrl: "zzkmsjwj/zzkmsjwj/exportXls",
          importExcelUrl: "zzkmsjwj/zzkmsjwj/importExcel",
       },
    }
  },
  computed: {
