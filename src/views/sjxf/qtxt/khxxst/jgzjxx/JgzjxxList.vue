<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('机构证件信息')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <jgzjxx-modal ref="modalForm" @ok="modalFormOk"></jgzjxx-modal>
  </a-card>
</template>

<script>
  import JgzjxxModal from './modules/JgzjxxModal'
    ...
    data () {
      return {
        ...
        columns: [
          {
           ...
           },
		   {
            title: '证件修改标志',
            align:"center",
            dataIndex: 'openAccIdentModifiedFlag'
           },
		   {
            title: '证件修改时间',
            align:"center",
       ...
       //    }
		...
		url: {
          list: "/jgzjxx/jgzjxx/list",
          delete: "/jgzjxx/jgzjxx/delete",
          deleteBatch: "/jgzjxx/jgzjxx/deleteBatch",
          exportXlsUrl: "jgzjxx/jgzjxx/exportXls",
          importExcelUrl: "jgzjxx/jgzjxx/importExcel",
       },
    }
  },
  computed: {
