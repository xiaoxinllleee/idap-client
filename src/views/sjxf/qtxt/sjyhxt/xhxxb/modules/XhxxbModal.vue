    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="客户号用户唯一标识">
          <a-input placeholder="请输入客户号用户唯一标识" v-decorator="['cstno', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="证件类型">
          <a-input placeholder="请输入证件类型" v-decorator="['ctftype', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="注销日期">
          <a-input placeholder="请输入注销日期" v-decorator="['clsdate', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="注销网点">
          <a-input placeholder="请输入注销网点" v-decorator="['clsbrchid', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="注销柜员">
          <a-input placeholder="请输入注销柜员" v-decorator="['clsteller', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="注销原因">
          <a-input placeholder="请输入注销原因" v-decorator="['clsrsn', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'cstno','name','ctftype','ctfno','mobile','stt','opennode','openteller','opentime','clsdate','clsbrchid','clsteller','clsrsn','sdate','edate','loadDate','legalNo','dtnum'))
		  //时间格式化
