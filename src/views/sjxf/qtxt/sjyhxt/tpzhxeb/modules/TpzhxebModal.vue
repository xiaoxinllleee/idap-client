    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="账号/卡号">
          <a-input placeholder="请输入账号/卡号" v-decorator="['accno', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="客户号,用户的唯一标识">
          <a-input placeholder="请输入客户号,用户的唯一标识" v-decorator="['cstno', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="个人设置的单日交易限额">
          <a-input placeholder="请输入个人设置的单日交易限额" v-decorator="['daymaxP', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="个人设置的单笔交易限额">
          <a-input placeholder="请输入个人设置的单笔交易限额" v-decorator="['singlemaxP', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tpzhxeb/tpzhxeb/add",
          edit: "/tpzhxeb/tpzhxeb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'accno','cstno','daymaxP','singlemaxP','opentime','sDate','eDate','loadDate','legalNo','dtnum'))
		  //时间格式化
