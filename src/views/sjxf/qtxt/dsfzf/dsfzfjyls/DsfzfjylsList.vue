<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('第三方支付交易流水')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <dsfzfjyls-modal ref="modalForm" @ok="modalFormOk"></dsfzfjyls-modal>
  </a-card>
</template>

<script>
  import DsfzfjylsModal from './modules/DsfzfjylsModal'
  ...
  export default {
    ...
    components: {
      DsfzfjylsModal,JTreeSelect
    },
    data () {
      return {
        description: '第三方支付交易流水管理页面',
        // 表头
        columns: [
          {
            title: '',
		...
		url: {
          list: "/dsfzfjyls/dsfzfjyls/list",
          delete: "/dsfzfjyls/dsfzfjyls/delete",
          deleteBatch: "/dsfzfjyls/dsfzfjyls/deleteBatch",
          exportXlsUrl: "dsfzfjyls/dsfzfjyls/exportXls",
          importExcelUrl: "dsfzfjyls/dsfzfjyls/importExcel",
       },
    }
  },
  computed: {
