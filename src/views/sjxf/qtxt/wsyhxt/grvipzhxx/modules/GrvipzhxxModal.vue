    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="流水号(自动生成)">
          <a-input placeholder="请输入流水号(自动生成)" v-decorator="['plvFlowno', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          <a-input placeholder="请输入操作标志(0:增加;1:修改;2:删除)默认:0" v-decorator="['aifOptflag', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="启用标志(0:未启用;1:启用)">
          <a-input placeholder="请输入启用标志(0:未启用;1:启用)" v-decorator="['aifFlag', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="网银状态(0:正常;1:冻结3:销户)">
          <a-input placeholder="请输入网银状态(0:正常;1:冻结3:销户)" v-decorator="['aifStt', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="单笔限额">
          <a-input placeholder="请输入单笔限额" v-decorator="['plvSinglemax', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="日累计限额">
          <a-input placeholder="请输入日累计限额" v-decorator="['plvDaymax', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/grvipzhxx/grvipzhxx/add",
          edit: "/grvipzhxx/grvipzhxx/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'plvFlowno','aifCstno','aifAccno','aifOptflag','aifFlag','aifStt','aifOpennode','aifBranchname','plvSinglemax','plvDaymax','cifHostno','sDate','eDate','loadDate','legalNo','dtnum'))
		  //时间格式化
