<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('企业客户交易流水信息(当天未经查证)')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <qykhjylsxx1-modal ref="modalForm" @ok="modalFormOk"></qykhjylsxx1-modal>
  </a-card>
</template>

<script>
  import Qykhjylsxx1Modal from './modules/Qykhjylsxx1Modal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'

  export default {
    name: "Qykhjylsxx1List",
    ...
    data () {
      return {
        description: '企业客户交易流水信息(当天未经查证)管理页面',
        // 表头
        columns: [
          {
            title: '',
		...
		url: {
          list: "/qykhjylsxx1/qykhjylsxx1/list",
          delete: "/qykhjylsxx1/qykhjylsxx1/delete",
          deleteBatch: "/qykhjylsxx1/qykhjylsxx1/deleteBatch",
          exportXlsUrl: "qykhjylsxx1/qykhjylsxx1/exportXls",
          importExcelUrl: "qykhjylsxx1/qykhjylsxx1/importExcel",
       },
    }
  },
  computed: {
