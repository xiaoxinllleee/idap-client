        ...
        <template v-if="toggleSearchStatus">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="渠道流水">
              <a-input placeholder="请输渠道流水" v-model="queryParam.chnlseqno"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('网银业务交易流水表')">导出</a-button>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <wyywjylsb-modal ref="modalForm" @ok="modalFormOk"></wyywjylsb-modal>
  </a-card>
</template>

<script>
  import WyywjylsbModal from './modules/WyywjylsbModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/wyywjylsb/wyywjylsb/list",
          delete: "/wyywjylsb/wyywjylsb/delete",
          deleteBatch: "/wyywjylsb/wyywjylsb/deleteBatch",
          exportXlsUrl: "wyywjylsb/wyywjylsb/exportXls",
          importExcelUrl: "wyywjylsb/wyywjylsb/importExcel",
       },
    }
  },
  computed: {
