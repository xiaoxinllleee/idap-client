        ...
        <template v-if="toggleSearchStatus">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="签约机构">
              <a-input placeholder="请输入签约机构" v-model="queryParam.signbankno"></a-input>
            </a-form-item>
          </a-col>
          <!--<a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>-->
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('微信签约信息表')">导出</a-button>
...
<!--        <span slot="action" slot-scope="text, record">
    ...
    <!-- 表单区域 -->
    <wxqyxxb-modal ref="modalForm" @ok="modalFormOk"></wxqyxxb-modal>
  </a-card>
</template>

<script>
  import WxqyxxbModal from './modules/WxqyxxbModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/wxqyxxb/wxqyxxb/list",
          delete: "/wxqyxxb/wxqyxxb/delete",
          deleteBatch: "/wxqyxxb/wxqyxxb/deleteBatch",
          exportXlsUrl: "wxqyxxb/wxqyxxb/exportXls",
          importExcelUrl: "wxqyxxb/wxqyxxb/importExcel",
       },
    }
  },
  computed: {
