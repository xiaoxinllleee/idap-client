      ...
      <a-form :form="form">
        ...
        <a-form-item
          ...
          <j-tree-select
            ...
            v-decorator="['zzbz', validatorRules.zjhm ]"
          >
          </j-tree-select>
        </a-form-item>
        <a-form-item
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/khglgx/khgl_khglgx/add",
          edit: "/khglgx/khgl_khglgx/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'zzbz','zjhm','sskhjl','ssyxdy','khxm','khlx'))
		  //时间格式化
        });
