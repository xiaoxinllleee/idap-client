<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('客户转化网格汇总')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <wghz-modal ref="modalForm" @ok="modalFormOk"></wghz-modal>
  </a-card>
</template>

<script>
  import WghzModal from './modules/WghzModal'
  ...
  export default {
    ...
    components: {
      WghzModal,JTreeSelect,JTreeSelectNotJg
    },
    data () {
      return {
        description: '客户转化网格汇总管理页面',
		...
		url: {
          list: "/khzhhz/wghz/list",
          init: "/khzhhz/khjlhz/extract",
          delete: "/khzhhz/wghz/delete",
          deleteBatch: "/khzhhz/wghz/deleteBatch",
          exportXlsUrl: "khzhhz/wghz/exportXls",
          importExcelUrl: "khzhhz/wghz/importExcel",
       },
    }
  },
  computed: {
