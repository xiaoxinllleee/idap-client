<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('客户转化支行汇总')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <zhhz-modal ref="modalForm" @ok="modalFormOk"></zhhz-modal>
  </a-card>
</template>

<script>
  import ZhhzModal from './modules/ZhhzModal'
  ...
  export default {
    ...
    components: {
      ZhhzModal,JTreeSelect
    },
    data () {
      return {
        description: '客户转化支行汇总管理页面',
		...
		url: {
          list: "/khzhhz/zhhz/list",
          init: "/khzhhz/khjlhz/extract",
          delete: "/khzhhz/zhhz/delete",
          deleteBatch: "/khzhhz/zhhz/deleteBatch",
          exportXlsUrl: "khzhhz/zhhz/exportXls",
          importExcelUrl: "khzhhz/zhhz/importExcel",
       },
    }
  },
  computed: {
