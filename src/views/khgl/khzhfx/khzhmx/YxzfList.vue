<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('有效走访明细')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <yxzf-modal ref="modalForm" @ok="modalFormOk"></yxzf-modal>
  </a-card>
</template>

<script>
  import YxzfModal from './modules/YxzfModal'
  ...
  export default {
    ...
    components: {
      YxzfModal,JTreeSelect,JTreeSelectNotJg
    },
    data () {
      return {
        description: '有效走访明细管理页面',
        // 表头
        columns: [
          {
            title: '#',
		...
		url: {
          list: "/khzhmx/yxzf/list",
          delete: "/khzhmx/yxzf/delete",
          deleteBatch: "/khzhmx/yxzf/deleteBatch",
          exportXlsUrl: "khzhmx/yxzf/exportXls",
          importExcelUrl: "khzhmx/yxzf/importExcel",
       },
    }
  },
  computed: {
