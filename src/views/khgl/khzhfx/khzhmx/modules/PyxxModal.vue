    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="评议证件号码">
          <a-input placeholder="请输入评议证件号码" v-decorator="['pyyzjhm', validatorRules.pyyzjhm ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules:{
        pyyzjhm:{rules: [{ required: true, message: '请输入评议证件号码!' }]},
        },
        url: {
          add: "/khzhmx/pyxx/add",
          edit: "/khzhmx/pyxx/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sszh','wgbh','sskhjl','hhbm','khmc','zjhm','pyyxm','pyyzjhm','pyls','jysxed'))
		  //时间格式化
