    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="是否评级授信">
          <a-input placeholder="请输入是否评级授信" v-decorator="['sfpjsx', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="最终授信额度">
          <a-input placeholder="请输入最终授信额度" v-decorator="['nhzzsxed', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sszh','wgbh','sskhjl','hhbm','khmc','zjhm','sfpjsx','nhzzsxed'))
		  //时间格式化
