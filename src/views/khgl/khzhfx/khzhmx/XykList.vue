<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('信用卡信息明细')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <xyk-modal ref="modalForm" @ok="modalFormOk"></xyk-modal>
  </a-card>
</template>

<script>
  import XykModal from './modules/XykModal'
  ...
  export default {
    ...
    components: {
      XykModal,JTreeSelect,JTreeSelectNotJg
    },
    data () {
      return {
        description: '信用卡信息明细管理页面',
        // 表头
        columns: [
          {
            title: '#',
		...
		url: {
          list: "/khzhmx/xyk/list",
          delete: "/khzhmx/xyk/delete",
          deleteBatch: "/khzhmx/xyk/deleteBatch",
          exportXlsUrl: "khzhmx/xyk/exportXls",
          importExcelUrl: "khzhmx/xyk/importExcel",
       },
    }
  },
  computed: {
