<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('ETC信息明细')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <etc-modal ref="modalForm" @ok="modalFormOk"></etc-modal>
  </a-card>
</template>

<script>
  import EtcModal from './modules/EtcModal'
  ...
  export default {
    ...
    components: {
      EtcModal,JTreeSelect,JTreeSelectNotJg
    },
    data () {
      return {
        description: 'ETC信息明细管理页面',
        // 表头
        columns: [
          {
            title: '#',
		...
		url: {
          list: "/khzhmx/etc/list",
          delete: "/khzhmx/etc/delete",
          deleteBatch: "/khzhmx/etc/deleteBatch",
          exportXlsUrl: "khzhmx/etc/exportXls",
          importExcelUrl: "khzhmx/etc/importExcel",
       },
    }
  },
  computed: {
