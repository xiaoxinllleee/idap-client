<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('手机银行信息明细')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <sjyh-modal ref="modalForm" @ok="modalFormOk"></sjyh-modal>
  </a-card>
</template>

<script>
  import SjyhModal from './modules/SjyhModal'
  ...
  export default {
    ...
    components: {
      SjyhModal,JTreeSelect,JTreeSelectNotJg
    },
    data () {
      return {
        description: '手机银行信息明细管理页面',
        // 表头
        columns: [
          {
            title: '#',
		...
		url: {
          list: "/khzhmx/sjyh/list",
          delete: "/khzhmx/sjyh/delete",
          deleteBatch: "/khzhmx/sjyh/deleteBatch",
          exportXlsUrl: "khzhmx/sjyh/exportXls",
          importExcelUrl: "khzhmx/sjyh/importExcel",
       },
    }
  },
  computed: {
