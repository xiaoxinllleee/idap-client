<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('存款信息明细')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <ckxx-modal ref="modalForm" @ok="modalFormOk"></ckxx-modal>
  </a-card>
</template>
...
<script>
  ...
  export default {
    ...
    components: {
      CkxxModal,JTreeSelect,JTreeSelectNotJg
    },
    data () {
      return {
        description: '存款信息明细管理页面',
		...
		url: {
          list: "/khzhmx/ckxx/list",
          delete: "/khzhmx/ckxx/delete",
          deleteBatch: "/khzhmx/ckxx/deleteBatch",
          exportXlsUrl: "khzhmx/ckxx/exportXls",
          importExcelUrl: "khzhmx/ckxx/importExcel",
       },
    }
  },
  computed: {
