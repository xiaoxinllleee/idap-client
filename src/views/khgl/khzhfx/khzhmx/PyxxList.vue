<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('评议信息明细')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <pyxx-modal ref="modalForm" @ok="modalFormOk"></pyxx-modal>
  </a-card>
</template>

<script>
  import PyxxModal from './modules/PyxxModal'
  ...
  export default {
    ...
    components: {
      PyxxModal,JTreeSelect,JTreeSelectNotJg
    },
    data () {
      return {
        description: '评议信息明细管理页面',
        // 表头
        columns: [
          {
            title: '#',
		...
		url: {
          list: "/khzhmx/pyxx/list",
          delete: "/khzhmx/pyxx/delete",
          deleteBatch: "/khzhmx/pyxx/deleteBatch",
          exportXlsUrl: "khzhmx/pyxx/exportXls",
          importExcelUrl: "khzhmx/pyxx/importExcel",
       },
    }
  },
  computed: {
