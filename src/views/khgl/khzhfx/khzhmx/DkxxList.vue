<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('贷款信息明细')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <dkxx-modal ref="modalForm" @ok="modalFormOk"></dkxx-modal>
  </a-card>
</template>

<script>
  import DkxxModal from './modules/DkxxModal'
  ...
  export default {
    ...
    components: {
      DkxxModal,JTreeSelect,JTreeSelectNotJg
    },
    data () {
      return {
        description: '贷款信息明细管理页面',
        // 表头
        columns: [
          {
            title: '#',
		...
		url: {
          list: "/khzhmx/dkxx/list",
          delete: "/khzhmx/dkxx/delete",
          deleteBatch: "/khzhmx/dkxx/deleteBatch",
          exportXlsUrl: "khzhmx/dkxx/exportXls",
          importExcelUrl: "khzhmx/dkxx/importExcel",
       },
    }
  },
  computed: {
