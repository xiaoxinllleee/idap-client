<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('网上银行信息明细')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <wsyh-modal ref="modalForm" @ok="modalFormOk"></wsyh-modal>
  </a-card>
</template>

<script>
  import WsyhModal from './modules/WsyhModal'
  ...
  export default {
    ...
    components: {
      WsyhModal,JTreeSelect,JTreeSelectNotJg
    },
    data () {
      return {
        description: '网上银行信息明细管理页面',
        // 表头
        columns: [
          {
            title: '#',
		...
		url: {
          list: "/khzhmx/wsyh/list",
          delete: "/khzhmx/wsyh/delete",
          deleteBatch: "/khzhmx/wsyh/deleteBatch",
          exportXlsUrl: "khzhmx/wsyh/exportXls",
          importExcelUrl: "khzhmx/wsyh/importExcel",
       },
    }
  },
  computed: {
