<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" :loading="exportLoading" @click="handleExportXls('评级授信明细')">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <pjsx-modal ref="modalForm" @ok="modalFormOk"></pjsx-modal>
  </a-card>
</template>

<script>
  import PjsxModal from './modules/PjsxModal'
  ...
  export default {
    ...
    components: {
      PjsxModal,JTreeSelect,JTreeSelectNotJg
    },
    data () {
      return {
        description: '评级授信明细管理页面',
        // 表头
        columns: [
          {
            title: '#',
		...
		url: {
          list: "/khzhmx/pjsx/list",
          delete: "/khzhmx/pjsx/delete",
          deleteBatch: "/khzhmx/pjsx/deleteBatch",
          exportXlsUrl: "khzhmx/pjsx/exportXls",
          importExcelUrl: "khzhmx/pjsx/importExcel",
       },
    }
  },
  computed: {
