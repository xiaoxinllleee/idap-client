    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="转移前客户经理">
          <a-input placeholder="请输入转移前客户经理" v-decorator="['zyqkhjl', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="转移后客户经理">
          <a-input placeholder="请输入转移后客户经理" v-decorator="['zyhkhjl', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/KHGL.KHZYRZGL/khzyrzgl/add",
          edit: "/KHGL.KHZYRZGL/khzyrzgl/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'zzbz','zjhm','ssyxdy','khxm','khlx','zyqkhjl','zyhkhjl'))
		  //时间格式化
        });
