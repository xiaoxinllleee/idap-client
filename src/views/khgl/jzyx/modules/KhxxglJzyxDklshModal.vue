  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/dklsh/khxxglJzyxDklsh/add",
          edit: "/dklsh/khxxglJzyxDklsh/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'ysszh','khmc','zjhm','dhhm','hth','htje','ydbfs','jkyy','ykhjl'))
		  //时间格式化
