        ...
        <div class="sign" style="text-align: left;height: inherit">
          ...
          <table align="center" border="1"  width="100%" >
            ...
            <tr  v-for="(item,index) in jtcyxx" v-bind:key='item.zjhm' style="height: 40px">
              ...
              <td rowspan="1" colspan="1" style="text-align:center;">
                <a-input v-model="item.xm" style="height: 40px;width: 90px"/>
              </td>
              <td rowspan="1" colspan="1" style="text-align:center;">
                <a-input v-model="item.xb" style="height: 40px;width: 80px"/>
              </td>
              <td rowspan="1" colspan="2" style="text-align:center;">
                <a-input v-model="item.zjhm" style="width: 150px;height: 40px" />
              </td>
              <td rowspan="1" colspan="1" style="text-align:center;">
                <a-input v-model="item.nl"style="height: 40px;width: 80px" />
              </td>
              <td rowspan="1" colspan="1" style="text-align:center;">
            ...
            <!--<tr style="height: 60px">
              <td rowspan="4" colspan="1" style="text-align:center;width:50px ">
                额度测算
              </td>
              <td  rowspan="1" colspan="10">
                <a style="margin-left:4%;">家庭易变现资产估价 {{this.bybxzc}} 万元</a>
              </td>
            </tr>
            <tr style="height: 50px">
              <td  rowspan="1" colspan="10">
                <a style="margin-left:4%;">家庭不易变现资产估价 {{this.nhpjsxspb.fczchj}} 万元</a>
              </td>
            </tr>
            <tr style="height: 50px">
              <td  rowspan="1" colspan="10">
                <a style="margin-left:4%;">家庭年纯收入 {{this.nhpjsxspb.nhcsr}} 万元</a>
              </td>
            </tr>
            <tr style="height: 60px">
              <td  rowspan="1" colspan="1"style="text-align:center;">
              ...
              <td  rowspan="1" colspan="9" >
                <a style="margin-left:1%;">测算额度 {{this.nhpjsxspb.sszchj}} 万元</a>
              </td>
            </tr>
            <tr style="height: 200px">
              <td  rowspan="1" colspan="10" >
                <a  style="margin-top: 10px">村委会推荐意见:</a>
                <br>
                <br>
                <a>同意该户信用等级评定为 {{this.nhpjsxspb.xtcspddj}} , 授信额度为  {{this.nhpjsxspb.nhzzsxed}}  万元。</a>
                <br>
                <br>
                <a style="margin-left:6%;">评议小组成员签字： {{ }} </a>
                <br>
                <br>
                <br>
                <br>
            ...
            <tr style="height: 200px">
              <td  rowspan="1" colspan="10" >
                <a  style="margin-top: 10px">南岳农商银行审核意见:</a>
                <br>
                <br>
                <a>同意该户信用等级评定为 {{this.sj}} , 授信额度为  {{this.sj}}  万元。</a>
                <br>
                <br>
                <a style="margin-left:6%;">信贷员签字： {{}} </a><a style="margin-left:50%;">支行行长签字： {{}} </a>
                <br>
                <br>
                <p style="margin-left:90%;" >年     月     日</p>
                <br>
              </td>
            </tr>-->
            </thead>
        ...
        if(this.model.hhbm) {
          getAction("/nh/nhjbxx/querynhpssxxx", { hhbm:this.model.hhbm}).then((res) => {
            if (res.success) {
              ...
              that.jtcyxx = res.result.jtcyxx
              this.bybxzc = res.result.bybxzc
              console.log("---农户评级授信审批表-----")
              console.log(that.jtcyxx)
              this.trFlag=true;
            }else {
             this. jtcyxx=[];
              alert(this.trFlag)
