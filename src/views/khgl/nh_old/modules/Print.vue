  ...
  <a-card :bordered="false" :class="{'abcdefg':true}">
    ...
    <section ref="print" id="printContent" class="abcdefg">
      <div style="text-align: center">
        <p style="font-size: 24px;font-weight: 800">{{this.nhxxcj.qydm}}农户信息采集表</p>
      </div>
      <!--签字-->
        ...
        <div class="sign" style="text-align: left;height: inherit">
          ...
          <table align="center" border="1"  width="100%" >
            ...
            <tr>
              ...
              <td  rowspan="1" colspan="1"style="text-align:center;width:80px ">
                户主姓名
              </td>
            ...
            <tr>
              ...
              <td rowspan="1" colspan="1"style="text-align:center;">
                <a-input  style="border: black" v-model="this.nhxxcj.hzxm"/>
              </td>
              <td rowspan="1" colspan="2"style="text-align:center;">

                <!--<textarea  style="border:none" rows="" cols="" v-model="this.nhxxcj.zjhm" ></textarea>-->
                <a-input  style="border: black;width: 170px" v-model="this.nhxxcj.zjhm"/>
              </td>
              <td rowspan="1" colspan="1"style="text-align:center;">
                <a-input  style="border: black" v-model="this.nhxxcj.xb"/>
              </td>

              <td colspan="1" style="text-align:center;width: 60px">
                <a-input  style="border: black;width: 50px" v-model="this.nhxxcj.nl"/>
              </td>
              <td colspan="1" style="text-align:center;">
                <a-input  style="border: black"  v-model="this.nhxxcj.jtrk"/>
              </td>
              <td colspan="1" style="text-align:center;">
                <a-input  style="border: black" v-model="this.nhxxcj.lxdh"/>
              </td>
              <td colspan="2" style="text-align:center;">
                <textarea  style="border:none" rows="" cols="" v-model="this.nhxxcj.jyqk" ></textarea>
                <!--<a-input  style="border: black" v-model="this.nhxxcj.jyqk"/>-->
              </td>
            </tr>
            ...
            <tr>
              <td rowspan="1" colspan="2"style="text-align:left;">
                <textarea  style="border:none;height: 150px;width: 160px" rows="" cols="" v-model="this.nhxxcj.jtzczk" ></textarea>
              </td>
              <td rowspan="1" colspan="2"style="text-align:center;">
                <a-input  style="border: black" v-model="this.nhxxcj.jyxmnsr"/>
              </td>
              <td rowspan="1"  colspan="2" style="text-align:center;">
                <a-input  style="border: black" v-model="this.nhxxcj.jyxmnzc"/>
              </td>
              <td  rowspan="1"  colspan="2" style="text-align:center;">
                <a-input  style="border: black" v-model="this.nhxxcj.jyxmncsr"/>
              </td>
            </tr>
           ...
           <tr>
            ...
            <tr>
              <td rowspan="1" colspan="2"style="text-align:center;">
                <a-input  style="border: black" v-model="this.nhxxcj.mjjd"/>
              </td>
              <td rowspan="1" colspan="2"style="text-align:center;">
                <a-input  style="border: black" v-model="this.nhxxcj.yhdk"/>
              </td>
              <td colspan="2" style="text-align:center;">
                <a-input  style="border: black" v-model="this.nhxxcj.qtjrjgjk"/>
              </td>
              <td colspan="2" style="text-align:center;">
                <a-input  style="border: black" v-model="this.nhxxcj.hj"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td rowspan="1" colspan="5" align="right" valign="bottom">
                <a-input  style="border: black" v-model="this.nhxxcj.bdcrqm"/>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        //加载家庭相关情况字表数据
        if(record.zjhm) {
          getAction("/nh/nhjbxx/nhxxcjb", { hhbm: record.hhbm,zjhm: record.zjhm, sszh:record.sszh}).then((res) => {
            if (res.success) {
              this.nhxxcj = res.result.jcxx;
             /* this.jtnsr = this.nhxxcj.zzxmsr+this.nhxxcj.yzxmsr+this.nhxxcj.syxmsr+this.nhxxcj.nwxwsr;
              this.jtnzc = this.nhxxcj.zzxmzc+this.nhxxcj.yzxmzc+this.nhxxcj.syxmzc+this.nhxxcj.nwxwzc;
              this.jtcsr = this.nhxxcj.zzxmcsr+this.nhxxcj.yzxmcsr+this.nhxxcj.syxmcsr+this.nhxxcj.nwxwcsr;*/
              //获取家庭成员数量
              this.Jtcylist = res.result.jsonArray;
              this.sj=this.Jtcylist.length+3;
              console.log("---农户采集信息表-----")
              console.log('nhxxcj', res.result)
