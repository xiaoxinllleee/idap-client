          ...
          <a-tab-pane key="1">
            ...
            <a-card class="card" :bordered="false">
              ...
              <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="居住状态">
                <a-select style="width: 100%" v-decorator="['jzzt', {}]" placeholder="请选择居住状态">
                  <a-select-option value="1">自置</a-select-option>
                  <a-select-option value="2">按揭</a-select-option>
                  <a-select-option value="3">亲属楼宇</a-select-option>
                  <a-select-option value="4">亲属楼宇</a-select-option>
                  <a-select-option value="5">集体宿舍</a-select-option>
                  <a-select-option value="6">租房</a-select-option>
                  <a-select-option value="7">共用住宅</a-select-option>
          ...
          <a-tab-pane key="4">
            ...
            <a-card class="card" :bordered="false">
              <a-table bordered
                       ...
                       :columns="qtzrrFcxxTable.columns"
                       rowKey="id"
                       :loading="loading"
                       :pagination="ipagination"
                       />
          ...
          <a-tab-pane key="5">
            ...
            <a-card class="card" :bordered="false">
              <a-table size="middle"
                       ...
                       :columns="qtzrrZcqkTable.columns"/>
            </a-card>
            ...
            <a-card class="card" :bordered="false">
              <a-table size="middle"
                       ...
                       :columns="qtzrrFzqkTable.columns"/>
            </a-card>
          </a-tab-pane>
          ...
          <a-tab-pane key="8">
            ...
            <a-card><form>
              ...
              <table align="center" border="1"  width="100%" >
                ...
                <tr v-for='(list,index) in dataSource_hzfjgl' v-bind:key='list.zlbh' align="center" >
                  <td>
                    <a-input  style="border: black; text-align: center" v-model="list.zlbh"/>
                  </td>
                  <td>
          ...
          <a-tab-pane key="10">
            ...
            <a-card class="card" :bordered="true">
              <a-row class="form-row" :gutter="8">
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="年龄">
                  <a-input placeholder="年龄" v-model="model.nl" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="文化程度">
                  <j-dict-select-tag placeholder="请选择文化程度" v-model="model.whcd" :triggerChange="true" dict-code="whcd" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="健康状况">
                  <j-dict-select-tag placeholder="请选择健康状况" v-model="model.jkzk" :triggerChange="true" dict-code="jkzk" disabled/>
                </a-form-item></a-col>
              </a-row>
              <a-row class="form-row" :gutter="8">
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="婚姻状况">
                  <j-dict-select-tag placeholder="请选择婚姻状况" v-model="model.hyzk" :triggerChange="true" dict-code="qtzrr_hyzk" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="职业">
                  <j-dict-select-tag placeholder="请选择职业" v-model="model.zy" :triggerChange="true" dict-code="qtzrr_zy" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="职务">
                  <j-dict-select-tag placeholder="请选择职务" v-model="model.zw" :triggerChange="true" dict-code="qtzrr_zw" disabled/>
                </a-form-item></a-col>
              </a-row>
              <a-row class="form-row" :gutter="8">
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="从业年限">
                  <j-dict-select-tag placeholder="请选择从业年限" v-model="model.cynx" :triggerChange="true" dict-code="cynx" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="居住状况">
                  <j-dict-select-tag placeholder="请选择居住状况" v-model="model.jzzk" :triggerChange="true" dict-code="jzzk" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="居住时间">
                  <j-dict-select-tag placeholder="请选择居住时间" v-model="model.jzsj" :triggerChange="true" dict-code="jzsj" disabled/>
                </a-form-item></a-col>
              </a-row>
              <a-row class="form-row" :gutter="8">
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="有无违法记录">
                  <j-dict-select-tag placeholder="请选择有无违法记录" v-model="model.ywwfjl" :triggerChange="true" dict-code="ywbz" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="社会评价">
                  <j-dict-select-tag placeholder="请选择社会评价" v-model="model.shpj" :triggerChange="true" dict-code="qtzrr_shpj" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="信用社贷款本金或利息逾期情况">
                  <j-dict-select-tag placeholder="请选择信用社贷款本金或利息逾期情况" v-model="model.dkyqqk" :triggerChange="true" dict-code="bjlxyqqk" disabled/>
                </a-form-item></a-col>
              </a-row>
              <a-row class="form-row" :gutter="8">
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="他行征信逾期记录">
                  <j-dict-select-tag placeholder="请选择他行征信逾期记录" v-model="model.thzxyqjl" :triggerChange="true" dict-code="thzxyqjl" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="经济能力">
                  <j-dict-select-tag placeholder="请选择经济能力" v-model="model.jjnl" :triggerChange="true" dict-code="jjnl" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="资产负债率">
                  <j-dict-select-tag placeholder="请选择资产负债率" v-model="model.zcfzl" :triggerChange="true" dict-code="qtzrr_zcfzl" disabled/>
                </a-form-item></a-col>
              </a-row>
              <a-row class="form-row" :gutter="8">
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="自有资金占比">
                  <j-dict-select-tag placeholder="请选择自有资金占比" v-model="model.zyzjzb" :triggerChange="true" dict-code="qtzrr_zyzjzb" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="年纯收入">
                  <j-dict-select-tag placeholder="请选择年纯收入" v-model="model.ncsr" :triggerChange="true" dict-code="qtzrr_ncsr" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="与信用社往来时间">
                  <j-dict-select-tag placeholder="请选择与信用社往来时间" v-model="model.yxyswlsj" :triggerChange="true" dict-code="qtzrr_yxyswlsj" disabled/>
                </a-form-item></a-col>
              </a-row>
              <a-row class="form-row" :gutter="8">
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="与信用社合作情况">
                  <j-dict-select-tag placeholder="请选择与信用社合作情况" v-model="model.yxyshzqk" :triggerChange="true" dict-code="qtzrr_yxyshzqk" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="人身保险">
                  <j-dict-select-tag placeholder="请选择人身保险" v-model="model.rsbx" :triggerChange="true" dict-code="ywbz" disabled/>
                </a-form-item></a-col>
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="财产保险">
                  <j-dict-select-tag placeholder="请选择财产保险" v-model="model.ccbx" :triggerChange="true" dict-code="ywbz" disabled/>
                </a-form-item></a-col>
              </a-row>
              <a-row class="form-row" :gutter="8">
            ...
            <a-card class="card" :bordered="false">
              ...
              <a-row class="form-row" :gutter="16">
                <a-col :lg="8"><a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="最终授信额度(元)">
                  <a-input placeholder="最终授信额度" v-model="model.zzsxed"/>
                </a-form-item></a-col>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/qtzrr/qtzrrjbxx/add",
          edit: "/qtzrr/qtzrrjbxx/edit",
          list: "/qtzrr/qtzrrjbxx/list",
          pjxxlist: '/qtzrr/qtzrrjbxx/queryQtzrrPjsxxxByMainId',
          fcqkList: '/qtzrr/qtzrrjbxx/queryQtzrrFcxxByMainId',
          zcxxList: '/qtzrr/qtzrrjbxx/queryQtzrrZcxxByMainId',
          fzqklist: '/qtzrr/qtzrrjbxx/queryQtzrrFzqkByMainId',
        },
      }
    },
    created () {
...
// 解决跨域 Canvas 污染问题
        ...
        image.onload = function() {
          ...
          getAction("/qtzrr/qtzrrjbxx/dpic", { zlbh: zlbh}).then((res) => {
            let j=eval(res);
            console.log("下载路径")
            console.log(j)
      ...
      downloadImg2(imgsrc, name,zlbh){
        ...
        getAction("/qtzrr/qtzrrjbxx/downLoad", { zlbh: zlbh}).then((res) => {
          let j=eval(res);
          console.log("下载路径")
          console.log(j)
          /* this.$refs.photoView.showModal(j.zllj),
      ...
      edit (record,qfbs) {
        if(record.zjhm){
          this.zjhmFlag=false;
          getAction(this.url.pjxxlist, { zjhm: record.zjhm }).then((res) => {
          ...
          if (this.model.zjhm) {
            ...
            getAction("/qtzrr/qtzrrjbxx/queryYwhxgywxx", params,this.form).then(res => {
          ...
          //加载家庭相关情况字表数据
          if(record.zjhm) {
            getAction("/qtzrr/qtzrrjbxx/queryJtcy", { hhbm: record.hhbm, sszh:record.sszh}).then((res) => {
              if (res.success) {
          ...
          getAction("/qtzrr/qtzrrjbxx/queryFj", { zjhm:record.zjhm}).then((res) => {
        ...
        //加载户主附件信息
        if (record.hhbm) {
          getAction("/qtzrr/qtzrrjbxx/queryHzFj", { hhbm:record.hhbm}).then((res) => {
            console.log('户主附件信息数据返回值 -',res)
            this.dataSource_hzfjgl = res;
        ...
        this.visible = true;
        //qfbs 1:其他自然人页面跳转进入，2：统一查询页面进入
        if (qfbs==2){
          let params = { "zjhm": record.zjhm}
          getAction("/qtzrr/qtzrrjbxx/queryQtzrrjbxx", params,this.form).then(res => {
            this.model = Object.assign({}, res.result);
            console.log("---其他自然人基本信息-----")
        ...
        if (this.model.zjhm) {
          let params = { "zjhm": record.zjhm}
          getAction("/qtzrr/qtzrrjbxx/qtzrrcjxx", params).then(res => {
            console.log(res.result)
            this.qtzrrcjxxb = Object.assign({}, res.result.qtzrrcjxxList);
            this.zkhjlacct=res.result.zkhjl_dictText;

            console.log("---其他自然人采集信息-----")
            console.log(this.qtzrrcjxxb)
            this.$nextTick(() => {
              let fieldscjxx = pick(this.qtzrrcjxxb, 'pyxxFlag','khxxFlag','khglFlag','signFlag','sskhjl','gzdw','gzdwdz','khmc','zjhm','whcd','sjhm','hkxz','zz','zz1','zz2','sfbldkh','sfpkh','sfdbh','xtpdjg','xtpdsm','gjrpdjg','gjrpdsm','zzpdjg','zzpdsm','cshygz','sfycdg','wgcs','kfyyqk','kcqzyw','khsxqk','longitude','latitude','sign1','sign2','bz','byhm','qq','pfr','khlx1','khlx2','zdyzbm','ywzn','jkzk','ldnl','jznx','zgxl','zgxw','ddpzzhpj','jzzt','upDt','upTm','ddpzzhpj1','ddpzzhpj2','khblsh','qzywyysj','hjdz','sfsx')
        ...
        if (record.hhbm) {
          ...
          getAction(this.url.fcqkList, params).then((res) => {
            console.info('其他自然人房产情况数据返回值 -',res);
        ...
        if(record.zjhm) {
          let params = {zjhm: record.zjhm}
          getAction(this.url.zcxxList, params).then((res) => {
            console.info(res)
            if(res.success) {
        ...
        if(record.zjhm) {
          let params = {zjhm: record.zjhm}
          getAction(this.url.fzqklist, params).then((res) => {
            console.info(res)
            if(res.success) {
