  ...
  <a-card :bordered="false" :class="{'abcdefg':true}">
    ...
    <section ref="print" id="printContent" class="abcdefg">
      <div style="text-align: center">
        <p style="font-size: 24px;font-weight: 800">其他自然人评级授信审批表</p>
      </div>
      <!--签字-->
        ...
        <div class="sign" style="text-align: left;height: inherit">
          ...
          <table align="center" border="1"  width="100%" >
            ...
            <tr style="height: 50px">
              <td  rowspan="1" colspan="10">
                <a style="margin-left: 2%;">家庭年纯收入 {{this.qtzrrpjsxspb.nhcsr}} 元</a>
              </td>
            </tr>
            <tr style="height: 50px">
              <td  rowspan="1" colspan="1"style="text-align:center;">
              ...
              <td  rowspan="1" colspan="9" >
                <a style="margin-left: 2%;">测算额度 {{this.qtzrrpjsxspb.sszchj}} 元</a>
              </td>
            </tr>
  ...
  export default {
    ...
    data(){
      return {
        ...
        pysj:" ",
        sj:2,
        qtzrrpjsxspb:{fczchj:"",nhcsr:"",sszchj:"",xtcspddj:"",nhzzsxed:""},
        nhbkbpy:{},
        jtcyxx:[],
        model:{},
        visible:false,
    ...
    methods: {
      ...
      edit (record) {
        ...
        //加载家庭相关情况字表数据
        if(this.model.hhbm) {
          getAction("/qtzrr/qtzrrjbxx/queryQtzrrpssxxx", { hhbm:this.model.hhbm}).then((res) => {
            if (res.success) {
              this.qtzrrpjsxspb = res.result.jcxx;
      ...
      getBankName: function() {
        getAction("/qtzrr/qtzrrjbxx/getBankName").then((res) => {
          if (res.success) {
