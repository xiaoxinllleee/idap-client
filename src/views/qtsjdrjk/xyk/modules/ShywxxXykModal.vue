    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="卡品种">
          <a-input placeholder="请输入卡品种" v-decorator="['kpz', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="发卡日期">
          <a-date-picker v-decorator="[ 'fkrq', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/SHYWXX_XYK/shywxxXyk/add",
          edit: "/SHYWXX_XYK/shywxxXyk/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'khmc','zjhm','lxdh','kpz','kh','xyed','tgry'))
		  //时间格式化
