<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="area-chart" @click="initData" v-has="'byjjbl:extract'">统计</a-button>
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('本月将进不良')" style="margin-left: 8px;">导出</a-button>
    </div>
      ...
      return {
        ...
        columns: [
          ...
          },
          {
		    ...
		    url: {
          list: "/dkjkptbyjjbll/dkjkptByjjBll/list",
          delete: "/dkjkptbyjjbll/dkjkptByjjBll/delete",
          deleteBatch: "/dkjkptbyjjbll/dkjkptByjjBll/deleteBatch",
          exportXlsUrl: "/dkjkptbyjjbll/dkjkptByjjBll/exportXls",
          importExcelUrl: "/dkjkptbyjjbll/dkjkptByjjBll/importExcel",
          init:"/dkjkptbyjjbll/dkjkptByjjBll/extract",
        },
      }
    },
    created() {
