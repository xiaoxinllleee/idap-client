<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="area-chart" @click="initData" v-has="'ZhBnbldkJgqkb2:init'">提取</a-button>
      <a-button icon="download" @click="handleExportXls('支行表内不良贷款结构情况表2')" v-has="'ZhBnbldkJgqkb2:exp'">导出</a-button>
    ...
    <!-- 表单区域 -->
    <zhBnbldkJgqkb2-modal ref="modalForm" @ok="modalFormOk"></zhBnbldkJgqkb2-modal>
  </a-card>
</template>

<script>
  import ZhBnbldkJgqkb2Modal from './modules/ZhBnbldkJgqkb2Modal'
  ...
  export default {
    name: "ZhBnbldkJgqkb2List",
    mixins:[JeecgListMixin],
    components: {
      ZhBnbldkJgqkb2Modal,JTreeSelect
    },
    data () {
      return {
        description: '支行表内不良贷款结构情况表2管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        url: {
          list: "/dkjkpt.tjcx.sgqfgtj.zhbnbldkjgqkb2/zhBnbldkJgqkb2/list",
          delete: "/dkjkpt.tjcx.sgqfgtj.zhbnbldkjgqkb2/zhBnbldkJgqkb2/delete",
          deleteBatch: "/dkjkpt.tjcx.sgqfgtj.zhbnbldkjgqkb2/zhBnbldkJgqkb2/deleteBatch",
          exportXlsUrl: "dkjkpt.tjcx.sgqfgtj.zhbnbldkjgqkb2/zhBnbldkJgqkb2/exportTemplateXls",
          importExcelUrl: "dkjkpt.tjcx.sgqfgtj.zhbnbldkjgqkb2/zhBnbldkJgqkb2/importExcel",
          init:"/dkjkpt.tjcx.sgqfgtj.zhbnbldkjgqkb2/zhBnbldkJgqkb2/extract",
