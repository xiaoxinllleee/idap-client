<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="area-chart" @click="initData" v-has="'QhBnbldkJgqkb2:init'">提取</a-button>
      <a-button icon="download" @click="handleExportXls('全行表内不良贷款结构情况表2')" v-has="'QhBnbldkJgqkb2:exp'">导出</a-button>
    </div>
