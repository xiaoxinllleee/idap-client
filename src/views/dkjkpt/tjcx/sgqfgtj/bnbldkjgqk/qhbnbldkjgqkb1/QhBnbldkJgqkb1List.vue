<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button  icon="area-chart" @click="initData" v-has="'QhBnbldkJgqkb1:init'">提取</a-button>
      <a-button  icon="download" @click="handleExportXls('全行表内不良贷款结构情况表1')" v-has="'QhBnbldkJgqkb1:exp'">导出</a-button>
    </div>
    ...
    <!-- 表单区域 -->
    <qhBnbldkJgqkb1-modal ref="modalForm" @ok="modalFormOk"></qhBnbldkJgqkb1-modal>
  </a-card>
</template>

<script>
  import QhBnbldkJgqkb1Modal from './modules/QhBnbldkJgqkb1Modal'
  ...
  export default {
    name: "QhBnbldkJgqkb1List",
    mixins:[JeecgListMixin],
    components: {
      QhBnbldkJgqkb1Modal,JTreeSelect
    },
    data () {
      return {
        description: '全行表内不良贷款结构情况表1管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        url: {
          list: "/dkjkpt.tjcx.sgqfgtj.qhbnbldkjgqkb1/qhBnbldkJgqkb1/list",
          delete: "/dkjkpt.tjcx.sgqfgtj.qhbnbldkjgqkb1/qhBnbldkJgqkb1/delete",
          deleteBatch: "/dkjkpt.tjcx.sgqfgtj.qhbnbldkjgqkb1/qhBnbldkJgqkb1/deleteBatch",
          exportXlsUrl: "dkjkpt.tjcx.sgqfgtj.qhbnbldkjgqkb1/qhBnbldkJgqkb1/exportTemplateXls",
          importExcelUrl: "dkjkpt.tjcx.sgqfgtj.qhbnbldkjgqkb1/qhBnbldkJgqkb1/importExcel",
          init:"/dkjkpt.tjcx.sgqfgtj.qhbnbldkjgqkb1/qhBnbldkJgqkb1/extract",
        },
      }
    },
    computed: {
