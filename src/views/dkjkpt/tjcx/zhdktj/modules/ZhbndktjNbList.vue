<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="area-chart" @click="initData" v-has="'zhdktjnb:extract1'">统计</a-button>
      <a-button icon="download" @click="handleExportXls('支行贷款统计(月报)')" style="margin-left: 8px;" v-has="'zhdktjnb:exportXls'">导出</a-button>
    </div>
    <!-- table区域-begin -->
    <div>
...
<script>
  ...
  export default {
    name: "Zhbndktj_nbList",
    mixins:[ JeecgListMixin ],
    components: { JTreeSelect },
    data () {
      return {
        description: '支行贷款统计(年报)管理页面',
        dateValue: '',
        isorter: {
          columns: 'tjyf',
          order: 'desc',
        ...
        columns: [
          ...
          },
          {
		    ...
		    url: {
          list: "/zhbndktj_nb/zhbndktjNb/list",
          delete: "/zhbndktj_nb/zhbndktjNb/delete",
          deleteBatch: "/zhbndktj_nb/zhbndktjNb/deleteBatch",
          exportXlsUrl: "zhbndktj_nb/zhbndktjNb/exportXls",
          importExcelUrl: "zhbndktj_nb/zhbndktjNb/importExcel",
          init:"zhbndktj_nb/zhbndktjNb/extract",
        },
      }
    },
    computed: {
