<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="area-chart" @click="initData" v-has="'zhajdktjyb:extract1'">统计</a-button>
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('支行按揭贷款统计(月报)')" style="margin-left: 8px;" v-has="'zhajdktjyb:exportXls'">导出</a-button>
    </div>
...
<script>
  ...
  export default {
    name: "Zhajdktj_ybList",
    mixins:[ JeecgListMixin ],
    components: { JTreeSelect },
    data () {
      return {
        description: '支行按揭贷款统计(月报)管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        columns: [
          ...
          },
          {
		    ...
		    url: {
          list: "/zhajdktj/zhajdktjYb/list",
          exportXlsUrl: "zhajdktj/zhajdktjYb/exportXls",
          importExcelUrl: "zhajdktj/zhajdktjYb/importExcel",
          init: "zhajdktj/zhajdktjYb/extract",
        },
      }
    },
    computed: {
