<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('员工管户贷款信息统计月报')">导出</a-button>
...
<script>
  ...
  export default {
    name: "YgghdkxxtjYbList",
    mixins:[JeecgListMixin],
    components: {
    },
    data () {
      return {
        description: '员工管户贷款信息统计月报管理页面',
		...
		url: {
          list: "/ygghdkxxtj/ygghdkxxtjYb/list",
          delete: "/ygghdkxxtj/ygghdkxxtjYb/delete",
          deleteBatch: "/ygghdkxxtj/ygghdkxxtjYb/deleteBatch",
          exportXlsUrl: "ygghdkxxtj/ygghdkxxtjYb/exportXls",
          importExcelUrl: "ygghdkxxtj/ygghdkxxtjYb/importExcel",
          init: "ygghdkxxtj/ygghdkxxtjYb/init",
       },
    }
  },
  computed: {
