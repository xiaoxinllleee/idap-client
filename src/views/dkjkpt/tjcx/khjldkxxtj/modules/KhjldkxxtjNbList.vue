<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('客户经理贷款信息统计年报')">导出</a-button>
...
<script>
  ...
  import store from '@views/tjfx/zfsjtj/sxyxtj/nh/zh/modules/ZhsxyxNbList'

  export default {
    name: "KhjldkxxtjNbList",
    mixins:[JeecgListMixin],
    components: {
    },
    data () {
      return {
        description: '客户经理贷款信息统计年报管理页面',
        dateValue: '',
        // 表头
        columns: [
          {
		...
		url: {
          list: "/khjldkxxtj/khjldkxxtjnb/list",
          delete: "/khjldkxxtj/khjldkxxtjnb/delete",
          deleteBatch: "/khjldkxxtj/khjldkxxtjnb/deleteBatch",
          exportXlsUrl: "khjldkxxtj/khjldkxxtjnb/exportXls",
          importExcelUrl: "khjldkxxtj/khjldkxxtjnb/importExcel",
          init: "/khjldkxxtj/khjldkxxtjnb/init",
       },
    }
  },
    created() {
