<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
           <!-- <a-form-item label="统计季度">
              <a-input placeholder="请输入统计季度" v-model="queryParam.tjrq"></a-input>
            </a-form-item>-->
            <a-form-item label="统计季度">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('客户经理贷款信息统计季报')">导出
      </a-button>
...
export default {
  name: 'KhjldkxxtjJbList',
  mixins: [JeecgListMixin],
  components: {},
  data () {
    return {
      description: '客户经理贷款信息统计季报管理页面',
      defaultYear: '',
      ssnf: '',
      tjjd: '',
      // 表头
      ...
      url: {
        list: '/khjldkxxtj/khjldkxxtjjb/list',
        delete: '/khjldkxxtj/khjldkxxtjjb/delete',
        deleteBatch: '/khjldkxxtj/khjldkxxtjjb/deleteBatch',
        exportXlsUrl: 'khjldkxxtj/khjldkxxtjjb/exportXls',
        importExcelUrl: 'khjldkxxtj/khjldkxxtjjb/importExcel',
        init: '/khjldkxxtj/khjldkxxtjjb/init'
      }
    }
  },
  computed: {
