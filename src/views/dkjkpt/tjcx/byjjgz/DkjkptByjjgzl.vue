<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="area-chart" @click="initData" v-has="'byjjgz:extract'">统计</a-button>
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('本月将近关注')" style="margin-left: 8px;">导出</a-button>
    </div>
      ...
      return {
        ...
        columns: [
          ...
          },
          {
		    ...
		    url: {
          list: "/dkjkptbyjjgzl/dkjkptByjjgzl/list",
          delete: "/dkjkptbyjjgzl/dkjkptByjjgzl/delete",
          deleteBatch: "/dkjkptbyjjgzl/dkjkptByjjgzl/deleteBatch",
          exportXlsUrl: "/dkjkptbyjjgzl/dkjkptByjjgzl/exportXls",
          importExcelUrl: "/dkjkptbyjjgzl/dkjkptByjjgzl/importExcel",
          init:"/dkjkptbyjjgzl/dkjkptByjjgzl/extract",
        },
      }
    },
    created() {
