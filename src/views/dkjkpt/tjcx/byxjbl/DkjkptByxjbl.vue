<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="area-chart" @click="initData" v-has="'byxjbl:extract'">统计</a-button>
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('本月新进不良')" style="margin-left: 8px;">导出</a-button>
    </div>
      ...
      return {
        ...
        columns: [
          ...
          },
          {
		    ...
		    url: {
          list: "/dkjkptbyxjbl/dkjkptByxjbl/list",
          delete: "/dkjkptbyxjbl/dkjkptByxjbl/delete",
          deleteBatch: "/dkjkptbyxjbl/dkjkptByxjbl/deleteBatch",
          exportXlsUrl: "/dkjkptbyxjbl/dkjkptByxjbl/exportXls",
          importExcelUrl: "/dkjkptbyxjbl/dkjkptByxjbl/importExcel",
          init:"/dkjkptbyxjbl/dkjkptByxjbl/extract",
        },
      }
    },
    created() {
