  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download"
                ...
                @click="handleExportXls('支行资金返还率统计')"
                style="margin-left: 8px" v-has="'zhzjfhltj:exportXls'">导出</a-button>
    </div>
...
<!--      </div>-->
    ...
    <!-- 表单区域 -->
    <dkjkptZhzjfhltj-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>

<script>
  import DkjkptZhzjfhltjModal from './modules/DkjkptZhzjfhltjModal'
  ...
  export default {
    name: "DkjkptZhzjfhltjList",
    mixins:[JeecgListMixin],
    components: {
      DkjkptZhzjfhltjModal,
      JSelectDepart,
      JTreeSelect
    },
    data () {
      return {
        ...
        columns: [
          ...
          },
          {
		    ...
		    url: {
          list: "/dkjkpt/dkjkptZhzjfhltj/list",
          exportXlsUrl: "dkjkpt/dkjkptZhzjfhltj/exportXls",
          importExcelUrl: "dkjkpt/dkjkptZhzjfhltj/importExcel"
        },
      }
    },
    computed: {
