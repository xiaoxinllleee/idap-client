  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="area-chart"
                @click="initData" v-has="'zjfhqkjc:init'">提取</a-button>
      <a-button icon="download"
                :loading="exportLoading"
                @click="handleExportXls('资金返还情况监测')"
                style="margin-left: 8px;" v-has="'zjfhqkjc:exportXls'">导出</a-button>
    </div>
...
<!--      </div>-->
    ...
    <!-- 表单区域 -->
    <dkjkptDkglckqsfxb-modal ref="modalForm" @ok="modalFormOk"></dkjkptDkglckqsfxb-modal>
  </a-card>
</template>

<script>
  import DkjkptDkglckqsfxbModal from './modules/DkjkptDkglckqsfxbModal'
  ...
  export default {
    name: "DkjkptDkglckqsfxbList",
    mixins:[JeecgListMixin],
    components: {
      JInput,
      DkjkptDkglckqsfxbModal,
      JSelectDepart,
      JTreeSelect
    },
    data () {
      return {
        description: '资金返还情况监测管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        columns: [
          ...
          },
          {
		    ...
		    url: {
          list: "/dkjkpt.dkglqsckqsfx.zjfhqkjc/dkjkptDkglckqsfxb/list",
          delete: "/dkjkpt.dkglqsckqsfx.zjfhqkjc/dkjkptDkglckqsfxb/delete",
          deleteBatch: "/dkjkpt.dkglqsckqsfx.zjfhqkjc/dkjkptDkglckqsfxb/deleteBatch",
          exportXlsUrl: "dkjkpt.dkglqsckqsfx.zjfhqkjc/dkjkptDkglckqsfxb/exportXls",
          importExcelUrl: "dkjkpt.dkglqsckqsfx.zjfhqkjc/dkjkptDkglckqsfxb/importExcel",
          init:"/dkjkpt.dkglqsckqsfx.zjfhqkjc/dkjkptDkglckqsfxb/extract"
        },
      }
    },
    computed: {
