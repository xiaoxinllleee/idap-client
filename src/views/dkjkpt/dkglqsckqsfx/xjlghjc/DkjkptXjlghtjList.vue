  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="area-chart"
                @click="initData" v-has="'xjlghjc:init'">提取</a-button>
      <a-button icon="download"
                :loading="exportLoading"
                @click="handleExportXls('现金流归行监测')"
                style="margin-left: 8px" v-has="'xjlghjc:exportXls'">导出</a-button>
    </div>
...
<!--      </div>-->
    ...
    <!-- 表单区域 -->
    <dkjkptXjlghtj-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>

<script>
  import DkjkptXjlghtjModal from './modules/DkjkptXjlghtjModal'
      ...
      return {
        ...
        columns: [
          ...
          },
          {
		    ...
		    url: {
          list: "/dkjkpt.dkglqsckqsfx.xjlghjc/dkjkptXjlghtj/list",
          delete: "/dkjkpt.dkglqsckqsfx.xjlghjc/dkjkptXjlghtj/delete",
          deleteBatch: "/dkjkpt.dkglqsckqsfx.xjlghjc/dkjkptXjlghtj/deleteBatch",
          exportXlsUrl: "dkjkpt.dkglqsckqsfx.xjlghjc/dkjkptXjlghtj/exportXls",
          importExcelUrl: "dkjkpt.dkglqsckqsfx.xjlghjc/dkjkptXjlghtj/importExcel",
          init:"/dkjkpt.dkglqsckqsfx.xjlghjc/dkjkptXjlghtj/extract"
        },
      }
    },
    computed: {
