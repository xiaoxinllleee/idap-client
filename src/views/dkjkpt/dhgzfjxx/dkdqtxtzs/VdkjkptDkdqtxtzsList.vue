<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" icon="plus" v-has="'dkdqtxtzs:fjsc'">附件上传</a-button>
      <a-button icon="download" @click="handleExportXls('贷款到期提醒通知书')" v-has="'dkdqtxtzs:exportXls'">导出</a-button>
...
<!--          <a @click="handleEdit(record)">附件编辑</a>-->
          <a @click="handleEdit(record)" v-has="'dkdqtxtzs:xq'">详情</a>
<!--          <a-divider type="vertical" />-->
<!--          <a-dropdown>-->
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/VdkjkptDkdqtxtzs/vdkjkptDkdqtxtzs/list",
          delete: "/VdkjkptDkdqtxtzs/vdkjkptDkdqtxtzs/delete",
          deleteBatch: "/VdkjkptDkdqtxtzs/vdkjkptDkdqtxtzs/deleteBatch",
          exportXlsUrl: "VdkjkptDkdqtxtzs/vdkjkptDkdqtxtzs/exportXls",
          importExcelUrl: "VdkjkptDkdqtxtzs/vdkjkptDkdqtxtzs/importExcel",
        },
      }
    },
    computed: {
