    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="dkje">
          <a-input placeholder="请输入dkje" v-decorator="['dkje', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="dkxt">
          <a-input placeholder="请输入dkxt" v-decorator="['dkxt', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="wjm">
          <a-input placeholder="请输入wjm" v-decorator="['wjm', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/VdkjkptDkdqtxtzs/vdkjkptDkdqtxtzs/add",
          edit: "/VdkjkptDkdqtxtzs/vdkjkptDkdqtxtzs/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'jgdm','khmc','zjhm','dkzh','bmkkh','dkje','dkye','dkxt','wjm'))
		  //时间格式化
