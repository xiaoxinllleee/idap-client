<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" icon="plus" v-has="'qtfj:fjsc'">附件上传</a-button>
      <a-button icon="download" @click="handleExportXls('逾期贷款催收通知')" v-has="'qtfj:exportXls'">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/vDkjkptQtfj/vDkjkptQtfj/list",
          delete: "/vDkjkptQtfj/vDkjkptQtfj/delete",
          deleteBatch: "/vDkjkptQtfj/vDkjkptQtfj/deleteBatch",
