<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" icon="plus" v-has="'yqdkcstzs:fjsc'">附件上传</a-button>
      <a-button icon="download" @click="handleExportXls('逾期贷款催收通知')" v-has="'yqdkcs:exportXls'">导出</a-button>
...
<!--          <a @click="handleEdit(record)">附件编辑</a>-->
          <a @click="handleEdit(record)" v-has="'yqdkcstzs:xq'">详情</a>
...
<script>
  ...
  export default {
    name: "VdkjkptYqdkcstzsList",
    mixins:[JeecgListMixin],
    components: {
      JTreeSelect,JInput,vDkjkptTsfxtzsView,vDkjkptTsfxtzsModal
    },
    data () {
      return {
        jkrq_begin:null,
		...
		url: {
          list: "/VdkjkptYqdkcstzs/vdkjkptYqdkcstzs/list",
          delete: "/VdkjkptYqdkcstzs/vdkjkptYqdkcstzs/delete",
          deleteBatch: "/VdkjkptYqdkcstzs/vdkjkptYqdkcstzs/deleteBatch",
          exportXlsUrl: "VdkjkptYqdkcstzs/vdkjkptYqdkcstzs/exportXls",
          importExcelUrl: "VdkjkptYqdkcstzs/vdkjkptYqdkcstzs/importExcel",
       },
    }
  },
    created () {
