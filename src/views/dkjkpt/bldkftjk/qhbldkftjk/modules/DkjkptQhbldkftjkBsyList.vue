  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download"
                ...
                @click="handleExportXls('全行不良贷款反弹监控比上月')"
...
<script>
  ...
  export default {
    name: "DkjkptqhBldkftjkBsyList",
    mixins:[JeecgListMixin],
    components: {JeecgListMixin},
    data () {
      return {
        description: '全行不良贷款反弹监控比上月管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        url: {
          list: "/dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bsy/list",
          delete: "/dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bsy/delete",
          deleteBatch: "/dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bsy/deleteBatch",
          exportXlsUrl: "dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bsy/exportXls",
          importExcelUrl: "dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bsy/importExcel",
        },
      }
    },
    computed: {
