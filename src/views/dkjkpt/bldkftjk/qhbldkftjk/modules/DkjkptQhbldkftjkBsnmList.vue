  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download"
                ...
                @click="handleExportXls('全行不良贷款反弹监控比上年末')"
                style="margin-left: 8px;" v-has="'qhbldkftjk:exportXls'">导出</a-button>
    </div>
...
<script>
  ...
  export default {
    name: "DkjkptqhBldkftjkBsnm",
    mixins:[JeecgListMixin],
    components: { JeecgListMixin },
    data () {
      return {
        description: '全行不良贷款反弹监控比上年末管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        url: {
          list: "/dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bsnm/list",
          delete: "/dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bsnm/delete",
          deleteBatch: "/dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bsnm/deleteBatch",
          exportXlsUrl: "dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bsnm/exportXls",
          importExcelUrl: "dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bsnm/importExcel",
        },
      }
    },
    computed: {
