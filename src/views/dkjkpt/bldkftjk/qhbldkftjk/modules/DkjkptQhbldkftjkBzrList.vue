  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download"
                ...
                @click="handleExportXls('全行不良贷款反弹监控比昨日')"
...
<script>
  ...
  export default {
    name: "DkjkptqhBldkftjkBsrList",
    mixins:[JeecgListMixin],
    components: {
    },
    data () {
      return {
        description: '全行不良贷款反弹监控比昨日管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        columns: [
          ...
          },
          {
		    ...
		    url: {
          list: "/dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bzr/list",
          delete: "/dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bzr/delete",
          deleteBatch: "/dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bzr/deleteBatch",
          exportXlsUrl: "dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bzr/exportXls",
          importExcelUrl: "dkjkpt.bldkftjk.qhbldkftjk/dkjkpt_qhbldkftjk_bzr/importExcel",
        },
      }
    },
    computed: {
