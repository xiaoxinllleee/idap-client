  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download"
                ...
                @click="handleExportXls('支行不良贷款反弹监控')"
...
<script>
  ...
  export default {
    name: "DkjkptzhBldkftjkBsrList",
    mixins:[JeecgListMixin],
    components: { JTreeSelect },
    data () {
      return {
        description: '支行不良贷款反弹监控管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        columns: [
          ...
          },
          {
		    ...
		    url: {
          list: "/dkjkpt.bldkftjk.zhbldkftjk/dkjkpt_zhbldkftjk_bzr/list",
          exportXlsUrl: "dkjkpt.bldkftjk.zhbldkftjk/dkjkpt_zhbldkftjk_bzr/exportXls",
          init: "/dkjkpt.bldkftjk.zhbldkftjk/dkjkpt_zhbldkftjk_bzr/initData"
        }
      }
    },
    computed: {
