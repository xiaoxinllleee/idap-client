  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button icon="download"
                ...
                @click="handleExportXls('支行不良贷款反弹监控比上年末')"
                style="margin-left: 8px;" v-has="'zhbldkftjk:exportXls'">导出
      </a-button >
    </div>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        description: '支行不良贷款反弹监控(比上年末)管理页面',
        monthFormat: 'YYYY-MM',
        // 默认当前月份
        ...
        url: {
          list: '/dkjkpt.bldkftjk.zhbldkftjk/dkjkpt_zhbldkftjk_bsnm/list',
          exportXlsUrl: 'dkjkpt.bldkftjk.zhbldkftjk/dkjkpt_zhbldkftjk_bsnm/exportXls',
          init: '/dkjkpt.bldkftjk.zhbldkftjk/dkjkpt_zhbldkftjk_bsnm/initData'
        }
      }
    },
    computed: {
