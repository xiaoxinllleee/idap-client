<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="area-chart" @click="initData" v-has="'bldkftjkmx:extract1'">统计</a-button>
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('不良贷款反弹监控比昨日')" style="margin-left: 8px;" v-has="'bldkftjkmx:exportXls'">导出</a-button>
    </div>
  ...
  export default {
      ...
      return {
        ...
        columns: [
          ...
          },
          {
		    ...
		    url: {
          list: "/dkjkpt/bldkftjk/dkjkptBldkftjkBsr/list",
          delete: "/dkjkpt/bldkftjk/dkjkptBldkftjkBsr/delete",
          deleteBatch: "/dkjkpt/bldkftjk/dkjkptBldkftjkBsr/deleteBatch",
          exportXlsUrl: "dkjkpt/bldkftjk/dkjkptBldkftjkBsr/exportXls",
          importExcelUrl: "dkjkpt/bldkftjk/dkjkptBldkftjkBsr/importExcel",
          init:"dkjkpt/bldkftjk/dkjkptBldkftjkBsr/extract",
        },
      }
    },
    computed: {
    ...
    methods: {
      ...
      initDictConfig(){
        ...
        let datestr=new Date().getFullYear()+"-"+month;
        console.log(datestr)
        this.Date=datestr;
      },
      initData() {
