<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button :loading="exportLoading" icon="download" @click="handleExportXls('不良贷款反弹监控比上月')" style="margin-left: 8px;" v-has="'bldkftjkmx:exportXls'">导出</a-button>
    </div>
      ...
      return {
        ...
        columns: [
          ...
          },
          {
		    ...
		    url: {
          list: "/dkjkpt/bldkftjk/dkjkptBldkftjkBsy/list",
          delete: "/dkjkpt/bldkftjk/dkjkptBldkftjkBsy/delete",
          deleteBatch: "/dkjkpt/bldkftjk/dkjkptBldkftjkBsy/deleteBatch",
          exportXlsUrl: "dkjkpt/bldkftjk/dkjkptBldkftjkBsy/exportXls",
          importExcelUrl: "dkjkpt/bldkftjk/dkjkptBldkftjkBsy/importExcel",
          init:"dkjkpt/bldkftjk/dkjkptBldkftjkBsy/extract",
        },
      }
    },
    computed: {
