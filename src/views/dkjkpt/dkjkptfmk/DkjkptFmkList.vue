<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button icon="download" :loading="exportLoading" @click="handleExportXls('福民卡')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <dkjkptFmk-modal ref="modalForm" @ok="modalFormOk"></dkjkptFmk-modal>
  </a-card>
</template>

<script>
  import DkjkptFmkModal from './modules/DkjkptFmkModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import DkjkptDjkJkModal from '@views/dkjkpt/dkjkptjk/modules/DkjkptDjkJkModal'
  ...
  export default {
    ...
    components: {
      DkjkptFmkModal,JTreeSelect,ExcelImport
    },
    data () {
      return {
        description: '福民卡管理页面',
		...
		url: {
          list: "/fmk/dkjkptFmk/list",
          delete: "/fmk/dkjkptFmk/delete",
          deleteBatch: "/fmk/dkjkptFmk/deleteBatch",
          exportXlsUrl: "fmk/dkjkptFmk/exportXls",
          importExcelUrl: "fmk/dkjkptFmk/importExcel",
          deleteBatchAll: "/fmk/dkjkptFmk/deleteBatchAll",
          exportTemplateUrl: '/fmk/dkjkptFmk/exportTemplateXls',
       },
        exportTemplateName:'福民贷记卡管理管理导入模板'
    }
  },
  computed: {
